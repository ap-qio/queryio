...
public class DataTagParser extends AbstractDataTagParser {
	...
	//		list.add(new ColumnMetadata("XMP_CREATORTOOL", String.class, 128));
	...
	//		list.add(new ColumnMetadata("META_LAST_AUTHOR", String.class, 128));
	//		list.add(new ColumnMetadata("DC_SUBJECT", String.class, 128));
	//		list.add(new ColumnMetadata("META_SAVE_DATE", Timestamp.class));
			list.add(new ColumnMetadata("SUBJECT", String.class, 128));
	//		list.add(new ColumnMetadata("APPLICATION_NAME", String.class, 128));
			list.add(new ColumnMetadata("AUTHOR", String.class, 128));
	//		list.add(new ColumnMetadata("DCTERMS_CREATED", Timestamp.class));
			list.add(new ColumnMetadata("DATE", Timestamp.class));
	//		list.add(new ColumnMetadata("EXTENDED_PROPERTIES_TEMPLATE", String.class, 128));
			list.add(new ColumnMetadata("CREATOR", String.class, 128));
	...
	//		list.add(new ColumnMetadata("EXTENDED_PROPERTIES_MANAGER", String.class, 128));
	...
	//		list.add(new ColumnMetadata("META_CHARACTER_COUNT", String.class, 128));
	//		list.add(new ColumnMetadata("DC_CREATOR", String.class, 128));
			list.add(new ColumnMetadata("EXTENDED_PROPERTIES_COMPANY", String.class, 128));
	//		list.add(new ColumnMetadata("META_WORD_COUNT", String.class, 128));
			list.add(new ColumnMetadata("LAST_MODIFIED", Timestamp.class));
			list.add(new ColumnMetadata("MODIFIED", Timestamp.class));
			list.add(new ColumnMetadata("XMPTPG_NPAGES", Integer.class));
			list.add(new ColumnMetadata("CATEGORY", String.class, 128));
			list.add(new ColumnMetadata("CHARACTER_COUNT", Integer.class));
	//		list.add(new ColumnMetadata("META_PAGE_COUNT", String.class, 128));
	...
	//		list.add(new ColumnMetadata("DC_DESCRIPTION", String.class, 128));
			list.add(new ColumnMetadata("CREATION_DATE", Timestamp.class));
	...
	//		list.add(new ColumnMetadata("DCTERMS_CREATED", Timestamp.class));
			...
			list.add(new ColumnMetadata("DATE", Timestamp.class));
	//		list.add(new ColumnMetadata("EXTENDED_PROPERTIES_TEMPLATE", String.class, 128));
	//		list.add(new ColumnMetadata("META_LINE_COUNT", String.class, 128));
			list.add(new ColumnMetadata("CREATOR", String.class, 128));
			list.add(new ColumnMetadata("PUBLISHER", String.class, 128));
			list.add(new ColumnMetadata("WORD_COUNT", Integer.class));
	//		list.add(new ColumnMetadata("META_PARAGRAPH_COUNT", String.class, 128));
	//		list.add(new ColumnMetadata("EXTENDED_PROPERTIES_APPVERSION", String.class, 128));
			list.add(new ColumnMetadata("TITLE", String.class, 128));
	//		list.add(new ColumnMetadata("META_AUTHOR", String.class, 128));
	...
	//		list.add(new ColumnMetadata("DC_CREATOR", String.class, 128));
	//		list.add(new ColumnMetadata("EXTENDED_PROPERTIES_COMPANY", String.class, 128));
	//		list.add(new ColumnMetadata("EXTENDED_PROPERTIES_TOTALTIME", String.class, 128));
			list.add(new ColumnMetadata("CATEGORY", String.class, 128));
			list.add(new ColumnMetadata("CHARACTER_COUNT", Integer.class));
	//		list.add(new ColumnMetadata("META_CHARACTER_COUNT_WITH_SPACES", String.class, 128));
	...
	//		list.add(new ColumnMetadata("EXTENDED_PROPERTIES_MANAGER", String.class, 128));
	//		list.add(new ColumnMetadata("META_PRINT_DATE", String.class, 128));
			list.add(new ColumnMetadata("COMMENTS", String.class, 128));
	//		list.add(new ColumnMetadata("META_CREATION_DATE", Timestamp.class));
	//		list.add(new ColumnMetadata("DCTERMS_MODIFIED", Timestamp.class));
	//		list.add(new ColumnMetadata("TEMPLATE", String.class, 128));
	...
	//		list.add(new ColumnMetadata("DC_IDENTIFIER", String.class, 128));
			...
			// PPT
			list = new ArrayList<ColumnMetadata>();
	//		list.add(new ColumnMetadata("META_SLIDE_COUNT", String.class, 128));
	//		list.add(new ColumnMetadata("CP_REVISION", String.class, 128));
	//		list.add(new ColumnMetadata("META_LAST_AUTHOR", String.class, 128));
	...
	//		list.add(new ColumnMetadata("DC_CREATOR", String.class, 128));
	//		list.add(new ColumnMetadata("EXTENDED_PROPERTIES_COMPANY", String.class, 128));
	//		list.add(new ColumnMetadata("EXTENDED_PROPERTIES_PRESENTATIONFORMAT", String.class, 128));
	//		list.add(new ColumnMetadata("EXTENDED_PROPERTIES_TOTALTIME", String.class, 128));
	//		list.add(new ColumnMetadata("CATEGORY", String.class, 128));
...
//			ODT files
			...
			list.add(new ColumnMetadata("WORD_COUNT", Integer.class));
			list.add(new ColumnMetadata("EDIT_TIME", Timestamp.class));
//			list.add(new ColumnMetadata("META_PARAGRAPH_COUNT", String.class, 64));
			list.add(new ColumnMetadata("CREATION_DATE", Timestamp.class));
			list.add(new ColumnMetadata("OBJECT_COUNT", Integer.class));
//			list.add(new ColumnMetadata("META_AUTHOR", String.class, 64));
			list.add(new ColumnMetadata("NBIMG", String.class, 64));
//			list.add(new ColumnMetadata("META_OBJECT_COUNT", String.class, 64));
...
//			list.add(new ColumnMetadata("META_CREATION_DATE", Timestamp.class));
			list.add(new ColumnMetadata("PAGE_COUNT", Integer.class));
//			list.add(new ColumnMetadata("META_CHARACTER_COUNT", String.class, 64));
//			list.add(new ColumnMetadata("DC_CREATOR", String.class, 64));
			list.add(new ColumnMetadata("NBTAB", Integer.class));
//			list.add(new ColumnMetadata("META_WORD_COUNT", String.class, 64));
			list.add(new ColumnMetadata("LAST_MODIFIED", Timestamp.class));
//			list.add(new ColumnMetadata("META_TABLE_COUNT", String.class, 64));
			list.add(new ColumnMetadata("MODIFIED", Timestamp.class));
//			list.add(new ColumnMetadata("META_IMAGE_COUNT", String.class, 64));
			list.add(new ColumnMetadata("XMPTPG_NPAGES", Integer.class));
			list.add(new ColumnMetadata("TABLE_COUNT", Integer.class));
			list.add(new ColumnMetadata("NBPARA", Integer.class));
			list.add(new ColumnMetadata("CHARACTER_COUNT", Integer.class));
//			list.add(new ColumnMetadata("META_PAGE_COUNT", String.class, 64));
			list.add(new ColumnMetadata("LANGUAGE", String.class, 64));
...
//			list.add(new ColumnMetadata("META_LAST_AUTHOR", String.class, 64));
			list.add(new ColumnMetadata("META_SAVE_DATE", Timestamp.class));
//			list.add(new ColumnMetadata("DC_SUBJECT", String.class, 64));
...
//			flv files 
			...
			list.add(new ColumnMetadata("CONTENT_TYPE", String.class, 64));
//			list.add(new ColumnMetadata("DC_LANGUAGE", String.class, 64));
//			list.add(new ColumnMetadata("kSFWP_HasHeaders_Property", String.class, 64));
...
//		InputStream is = new FileInputStream("/Users/prasoon/QueryIO_v20/demo/Data/pdf/Doc_1352993877980.pdf");
//		InputStream is = new FileInputStream("/Users/prasoon/QueryIO_v20/demo/Data/eml/eml_consolement.eml");
//		InputStream is = new FileInputStream("/Users/prasoon/QueryIO_v20/demo/Data/png/Img_1350469911625.png");
//		InputStream is = new FileInputStream("/Users/indravardhan/Documents/AOS-Baseline/ASPEN_BF_214929141107.jtl");
		InputStream is = new FileInputStream("/Users/indravardhan/Desktop/ASPEN_BF_1438017814.jtl/ASPEN_BF_1438017814_87.jtl");
	
		JSONObject tagsJSON = (JSONObject) new JSONParser().parse(StaticUtilities.getFileContents("/Users/indravardhan/temp.json"));
...
//		parser.parseStream(is, "png");
	...
	public void parseStream(InputStream is, String fileExtension) throws Exception {	
		...
		else
		{
			...
			try {
				reader = new BufferedReader(new ParsingReader(parser,
						is, metadata, parseContext));
...
//			new UserDefinedTag(TableMetadata.DEFAULT_TAG_ACCESSTIME, new Timestamp(status.getAccessTime()))
			ColumnMetadata columnMetadata = tableMetadata.getColumnMetadataByColumnName(key);
			if(columnMetadata != null){
				if(value != null && !value.isEmpty()){
					this.list.add(new UserDefinedTag(key, convertStringValueToClass(columnMetadata, value)));
