...
//		final String fileName = "/work/tika-site/tika-parsers/src/test/resources/test-documents/testWORD_1img.doc";
////		final String fileName = "/work/tika-site/tika-parsers/src/test/resources/test-documents/testEXCEL_1img.xlsx";
//		
...
//			public void run(){
//				try{
//					parser.parseStream(pis, fileName.substring(fileName.lastIndexOf(".") + 1));
//				}catch(Exception e){
//					e.printStackTrace();
//				}
//			}
