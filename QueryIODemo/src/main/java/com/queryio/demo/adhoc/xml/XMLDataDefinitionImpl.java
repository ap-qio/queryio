...
//		String[] colNames = new String[]{"FILEPATH", "DRIVER", "URL", "USERNAME", "PASSWORD", "POOLNAME", "MAXCONNECTIONS", "MAXIDLECONNECTIONS","WAITTIMEINMILLIS","DRIVERJAR"};
//		String[] sqlTypes = new String[]{"VARCHAR(1280)", "VARCHAR(128)", "VARCHAR(128)", "VARCHAR(128)", "VARCHAR(128)", "VARCHAR(128)", "DECIMAL", "DECIMAL" , "DECIMAL" , "VARCHAR(128)"};
