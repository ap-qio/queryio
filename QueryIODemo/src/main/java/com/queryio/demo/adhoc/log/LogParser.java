...
public class LogParser implements IAdHocParser {
	...
	class Parser {
		...
		public void parse(final DBListener dbListener, final String filePath, InputStream is) throws Exception {
		...
		boolean parseLine(String str, IMessageListener listener)
