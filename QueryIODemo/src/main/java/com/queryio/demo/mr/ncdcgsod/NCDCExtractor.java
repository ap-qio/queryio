...
//			writeToStream(bufferedInputStream, outputStream);			
	...
	public void process() throws Exception{
		...
		config.set("fs.ftp.password." + ftpHost, System.getProperty("user.name")+"@"+InetAddress.getLocalHost().getHostName());
...
//				createObject("/", filePath.toUri().getPath(), inputStream, true);	
			}catch(Exception e){
				e.printStackTrace();
			}
		}
