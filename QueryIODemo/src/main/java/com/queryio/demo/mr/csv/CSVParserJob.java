...
//		DBConfiguration.configureDB(confa, "com.mysql.jdbc.Driver", "jdbc:mysql://localhost/mydatabase");
//		String [] fields = { �employee_id�, "name" };
//		DBInputFormat.setInput(conf, MyRecord.class, �employees�, null /* conditions */, �employee_id�, fields); // set Mapper, etc., and call 
