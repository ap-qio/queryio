...
public class JTLMapper extends Mapper<Object, Text, Text, Record> {
	...
	private void writeRecordWithLabel(Mapper<Object, Text, Text, Record>.Context context, Record record)
			throws IOException, InterruptedException {
	...
	private void writeRecordWithOverallAndTick(Mapper<Object, Text, Text, Record>.Context context, Record record)
			throws IOException, InterruptedException {
	...
	private void writeRecordWithLabelAndTick(Mapper<Object, Text, Text, Record>.Context context, Record record)
			throws IOException, InterruptedException {
	...
	@Override
	protected void setup(Mapper<Object, Text, Text, Record>.Context context) throws IOException, InterruptedException {
		super.setup(context);
		try {
