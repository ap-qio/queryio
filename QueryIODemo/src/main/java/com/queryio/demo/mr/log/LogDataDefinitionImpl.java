...
//		String[] colNames = new String[]{"FILEPATH", "CATEGORY", "CLASS_NAME", "DATE", "FILE_NAME", "LINE_NUMBER", "LOCATION", "MDC", "MESSAGE", "METHOD", "ELAPSED", "NDC", "PRIORITY", "SEQUENCE", "THREAD"};
//		String[] sqlTypes = new String[]{"VARCHAR(1280)", "VARCHAR(128)", "VARCHAR(128)", "VARCHAR(128)", "VARCHAR(128)", "VARCHAR(128)", "VARCHAR(128)", "VARCHAR(128)",
//				"VARCHAR(5000)", "VARCHAR(128)", "VARCHAR(128)", "VARCHAR(128)", "VARCHAR(128)", "VARCHAR(128)", "VARCHAR(128)"};
