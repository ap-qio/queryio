...
public class AgentStartupListener implements ServletContextListener
{
	public void contextInitialized(final ServletContextEvent event)
	{
		...
		AppLogger.initLoggerProperties(EnvironmentalConstants.getAppHome(), EnvironmentalConstants.getAppHome() + "logs/");
		...
		if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("INSTALL_DIR: " + ProcManager.INSTALL_DIR);
		if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("STATUS_FILE: " + ProcManager.STATUS_FILE);
		if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("MONITOR_CONFIG_FILE: " + ProcManager.MONITOR_CONFIG_FILE);
		
		try
		{
			if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("Callling ProcManager.addAgentStartUpMonitor()");
			
			ProcManager.addAgentStartUpMonitor();
			
			if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("Completed ProcManager.addAgentStartUpMonitor()");
		...
		EnvironmentalConstants.setDbConfigFilePath(EnvironmentalConstants.getAppHome() + "conf" + File.separator + "dbconfig.xml");
		if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("Initializing Database Connection");
		try 
		{
		...
		if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("Database Connection Initialized");
	}
	
	public void contextDestroyed(final ServletContextEvent event)
	{		
		if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("Stopping Node Status Monitor");
	}
}
