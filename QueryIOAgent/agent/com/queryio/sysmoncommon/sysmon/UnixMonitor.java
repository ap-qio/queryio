...
public class UnixMonitor implements IOSProtocolConstants
{
	...
	public UnixMonitor(final String targetIPAddress, final int os) throws UnknownHostException
	{
		...
		/*
		if (!LOOPBACKADDRESS.equalsIgnoreCase(targetIPAddress) && !LOCALHOST.equalsIgnoreCase(targetIPAddress))
		{
			this.sTargetIPAddress = InetAddress.getByName(targetIPAddress).getHostAddress();
		}
		else
		{
			this.sTargetIPAddress = targetIPAddress;
...
////	 * @throws Exception
////	 */
////	public void initializeProtocol(final int protocol, final boolean bMonitorProcess) throws Exception
////	{
...
//	 * @throws Exception
//	 */
//	public void initializeProtocol(final int protocol, final boolean bMonitorProcess, final String ioDisks) throws Exception
//	{
		this.iProtocol = protocol;
		if (this.iProtocol == RSTAT)
		{
			this.unixMachine = new RstatClient(InetAddress.getByName(this.sTargetIPAddress), 
				RstatConstants.RSTATPROG, RstatConstants.RSTATVERS_TIME, OncRpcProtocols.ONCRPC_UDP);
		}
		else
		{
			switch (this.iTargetOS)
			{
				case LINUX_OLD:
				{
					this.unixMachine = new LinuxNativeAPI(this.sTargetIPAddress, this.userName, this.password, this.privateKeyFile, this.authMethod,
						this.port, this.iProtocol, this.processFilter, this.firewallUserName, this.firewallPassword,
						this.superUserName, this.superUserPassword, this.monitorProcess, this.iostatDisks, this.refreshInterval);
					break;
				}
				case LINUX:
				{
					this.unixMachine = new LinuxProcNativeAPI(this.sTargetIPAddress, this.userName, this.password, this.privateKeyFile, this.authMethod,
						this.port, this.iProtocol, this.processFilter, this.firewallUserName, this.firewallPassword,
						this.superUserName, this.superUserPassword, this.monitorProcess, this.iostatDisks, this.monitorNFS, this.refreshInterval);
					break;
				}
				case MACOSX:
				{
					this.unixMachine = new MacOSXNativeAPI(this.sTargetIPAddress, this.userName, this.password, this.privateKeyFile, this.authMethod,
						this.port, this.iProtocol, this.processFilter, this.firewallUserName, this.firewallPassword,
						this.superUserName, this.superUserPassword, this.monitorProcess, this.refreshInterval);
					break;
				}
				case SOLARIS_OLD:
				{
					this.unixMachine = new SolarisNativeAPI(this.sTargetIPAddress, this.userName, this.password, this.privateKeyFile, this.authMethod,
						this.port, this.iProtocol, this.processFilter, this.firewallUserName, this.firewallPassword,
						this.superUserName, this.superUserPassword, this.monitorProcess, this.refreshInterval);
					break;
				}
				case SOLARIS:
				{
					this.unixMachine = new ZFSNativeAPI(this.sTargetIPAddress, this.userName, this.password, this.privateKeyFile, this.authMethod,
						this.port, this.iProtocol, this.processFilter, this.firewallUserName, this.firewallPassword,
						this.superUserName, this.superUserPassword, this.monitorProcess, this.refreshInterval);
					break;
				}
				case AIX:
				{
					this.unixMachine = new AIXNativeAPI(this.sTargetIPAddress, this.userName, this.password, this.privateKeyFile, this.authMethod,
						this.port, this.iProtocol, this.processFilter, this.firewallUserName, this.firewallPassword,
						this.superUserName, this.superUserPassword, this.monitorProcess, this.refreshInterval);					
					break;
				}
