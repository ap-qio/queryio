 ...
 */
public class DoubleScalarGreaterEqualTimestampColumn extends LongScalarGreaterEqualLongColumn {

  public DoubleScalarGreaterEqualTimestampColumn(double value, int colNum, int outputColumn) {
    super(TimestampUtils.doubleToNanoseconds(value), colNum, outputColumn);
  }
