 ...
 */
public class FilterDoubleScalarLessEqualTimestampColumn extends FilterLongScalarLessEqualLongColumn {

  public FilterDoubleScalarLessEqualTimestampColumn(double value, int colNum) { 
    super(TimestampUtils.doubleToNanoseconds(value), colNum);
  }
