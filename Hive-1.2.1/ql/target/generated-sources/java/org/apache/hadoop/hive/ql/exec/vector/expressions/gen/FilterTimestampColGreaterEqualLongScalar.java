 ...
 */
public class FilterTimestampColGreaterEqualLongScalar extends FilterLongColGreaterEqualLongScalar {

  public FilterTimestampColGreaterEqualLongScalar(int colNum, long value) { 
    super(colNum, TimestampUtils.secondsToNanoseconds(value));
  }
