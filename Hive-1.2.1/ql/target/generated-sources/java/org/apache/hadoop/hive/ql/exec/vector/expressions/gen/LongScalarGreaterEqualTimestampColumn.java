 ...
 */
public class LongScalarGreaterEqualTimestampColumn extends LongScalarGreaterEqualLongColumn {

  public LongScalarGreaterEqualTimestampColumn(long value, int colNum, int outputColumn) {
    super(TimestampUtils.secondsToNanoseconds(value), colNum, outputColumn);
  }
