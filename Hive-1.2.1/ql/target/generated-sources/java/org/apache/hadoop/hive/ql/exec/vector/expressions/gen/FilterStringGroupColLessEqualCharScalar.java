 ...
 */
public class FilterStringGroupColLessEqualCharScalar extends FilterStringGroupColLessEqualStringGroupScalarBase {

  public FilterStringGroupColLessEqualCharScalar(int colNum, HiveChar value) {
    this.colNum = colNum;
    this.value = value.getStrippedValue().getBytes();
  }

  public FilterStringGroupColLessEqualCharScalar() {
  }
