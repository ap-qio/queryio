 ...
 */
public class TimestampColGreaterEqualLongScalar extends LongColGreaterEqualLongScalar {

  public TimestampColGreaterEqualLongScalar(int colNum, long value, int outputColumn) {
    super(colNum, TimestampUtils.secondsToNanoseconds(value), outputColumn);
  }
