...
public class UserInfoManager {
	...
	public static void fetchUserInformation() throws Exception {
		...
		try {
			...
			while (rs.next()) {
				LOGGER.debug("User: " + rs.getString(ColumnConstants.COL_USER_USERNAME) + " : "
						+ rs.getString(ColumnConstants.COL_USER_PASSWORD));
				userMap.put(rs.getString(ColumnConstants.COL_USER_USERNAME),
						rs.getString(ColumnConstants.COL_USER_PASSWORD));
				groupMap.put(rs.getString(ColumnConstants.COL_USER_USERNAME),
						getDefaultGroupForUser(connection, rs.getString(ColumnConstants.COL_USER_USERNAME)));
			}
		} finally {
			try {
