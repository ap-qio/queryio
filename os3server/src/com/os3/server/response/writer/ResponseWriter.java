...
public class ResponseWriter {
	...
	public static void handleResponseStatus(HttpServletResponse response, int status, int apiType, String requestId, String contentType) {
  ...
  <Buckets>
	...
	public static void writeListAllMyBucketsResponse(final int apiType, final HttpServletResponse response, final String ownerID, final String ownerName,
			final ArrayList dirStats, String requestId) throws IOException
	{
	...
	public static void writeListAllMyBucketsResponseData(final int apiType, final HttpServletResponse response, final String ownerID, final String ownerName,
			final ArrayList dirStats) throws IOException{
	...
	/*	GET Bucket (List Objects) sample response
		 <?xml version="1.0" encoding="UTF-8"?>
	 ...
	 */
	public static void writeListObjectsResponse(FileSystem dfs, int apiType, HttpServletResponse response, String bucketName, String prefix, String delimiter, int maxKeys, 
			String marker, FileStatus[] fs, boolean bTruncated, Map<String, String> commonPrefixes, String requestId) throws Exception{
		
		handleResponseStatus(response, HttpServletResponse.SC_OK, apiType, requestId, OS3Constants.APPLICATION_XML);
		writeListObjectsResponseData(dfs, apiType, response, bucketName, prefix, delimiter, maxKeys, marker, fs, bTruncated, commonPrefixes);
	}
	
	private static void writeListObjectsResponseData(FileSystem dfs, int apiType, HttpServletResponse response, String bucketName, String prefix, String delimiter, int maxKeys, 
			String marker, FileStatus[] fs, boolean bTruncated, Map<String, String> commonPrefixes) throws Exception{
	...
	public static void writeGetOrHeadObjectResponse(HttpServletRequest request, HttpServletResponse response, int apiType, String requestId, long contentLength, long modificationTime, String etag, boolean writeMetaData, Map metadata) throws IOException {
	...
	public static void writeHeadObjectResponse(HttpServletRequest request, HttpServletResponse response, int apiType, String requestId, long contentLength, long modificationTime, String etag, boolean writeMetaData, Map metadata) throws IOException {
		writeGetOrHeadObjectResponse(request, response, apiType, requestId, contentLength, modificationTime, etag, writeMetaData, metadata);
		response.setStatus(HttpServletResponse.SC_OK);
	}
	
	public static void writeGetACLResponse(HttpServletRequest request, HttpServletResponse response, int apiType, String requestId, FileStatus status) throws IOException {
		//Write response headers
			String contentType = request.getParameter("response-content-type");
			if(contentType != null){
				response.addHeader("Content-Type", contentType);
	...
	public static void writeGetObjectResponse(HttpServletRequest request, HttpServletResponse response, int apiType, String requestId, InputStream inputStream, long contentLength, long modificationTime, String etag, long lowerBound, long higherBound, String range, boolean writeMetaData, Map metadata) throws IOException {
		//finally set status 
		if(range==null){
	...
	public static void writePutObjectResponse(int apiType, HttpServletResponse response, String etag, String requestId){
		response.setHeader("ETag", etag);
		if(apiType == OS3Constants.API_TYPE_AMAZON){
			response.setHeader(OS3Constants.X_AMZ_REQUEST_ID, requestId);
			response.setHeader(OS3Constants.X_AMZ_ID_2, requestId);
	...
	public static void writeLoginActionResponse(int apiType, HttpServletResponse response, String requestId, String token){
	...
	public static void writeAddBigQueryResponse(Object object, int apiType,
			HttpServletResponse response, String requestId) throws IOException {
		handleResponseStatus(response, HttpServletResponse.SC_OK, apiType, requestId, OS3Constants.APPLICATION_XML);
		writeAddBigQueryResponseData(response, apiType, true);
	}
	
	public static void writeDeleteBigQueryResponse(Object object, int apiType,
			HttpServletResponse response, String requestId) throws IOException {
		handleResponseStatus(response, HttpServletResponse.SC_OK, apiType, requestId, OS3Constants.APPLICATION_XML);
		writeDeleteBigQueryResponseData(response, apiType, true);
	}

	public static void writeAddBigQueryResponseData(HttpServletResponse response, int apiType, boolean success) throws IOException{
		PrintWriter writer = response.getWriter();
		//"<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
	...
	public static void writeDeleteBigQueryResponseData(HttpServletResponse response, int apiType, boolean success) throws IOException{
		PrintWriter writer = response.getWriter();
		//"<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
	...
	public static void writeBigQueryResponse(FileSystem dfs, int apiType,
			HttpServletResponse response, String requestId, String bigQuery,
			TableModel resultTableModel, boolean jobComplete) throws IOException {
	...
	public static void writeGetAllBigQueriesResponse(FileSystem dfs, int apiType,
			HttpServletResponse response, String requestId, JSONObject queries) throws IOException {
		handleResponseStatus(response, HttpServletResponse.SC_OK, apiType, requestId, OS3Constants.APPLICATION_XML);
		writeGetAllBigQueriesResponseData(response, apiType, queries);
	}
	
	public static void writeGetAllBigQueriesResponseData(HttpServletResponse response, int apiType, JSONObject queries) throws IOException{
		PrintWriter writer = response.getWriter();
		//"<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
	...
	public static void writeBigQueryResponseData(HttpServletResponse response, int apiType, TableModel resultTableModel, boolean jobComplete) throws IOException{
		PrintWriter writer = response.getWriter();
		//"<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
