...
public class ErrorResponseWriter {
	...
	public static void invalidArgument(Map<String, Object> helperMap, HttpServletResponse response, String resource, String requestId, int apiType){
		try{
	...
	public static void permissionDenied(Map<String, Object> helperMap, HttpServletResponse response, String resource, String message, String requestId, int apiType){
		try{
	...
	public static void invalidRequestURI(Map<String, Object> helperMap, HttpServletResponse response, String requestId, int apiType){
		try{
			ResponseWriter.handleResponseStatus(response, HttpServletResponse.SC_BAD_REQUEST, apiType, requestId, OS3Constants.APPLICATION_XML);
	...
	public static void serviceUnavailable(Map<String, Object> helperMap, HttpServletResponse response, String requestId, int apiType){
		try{
	...
	public static void requestTimedOut(Map<String, Object> helperMap, HttpServletResponse response, String requestId, int apiType){
		try{
	...
	public static void buketAlreadyExists(Map<String, Object> helperMap, HttpServletResponse response, String resource, String requestId, int apiType){
		try{
	...
	public static void pathDoesNotExist(Map<String, Object> helperMap, HttpServletResponse response, String resource, String requestId, int apiType){
		try{
	...
	public static void invalidBucketName(Map<String, Object> helperMap, HttpServletResponse response, String resource, String requestId, int apiType){
		try{
			ResponseWriter.handleResponseStatus(response, HttpServletResponse.SC_BAD_REQUEST, apiType, requestId, OS3Constants.APPLICATION_XML);
	...
	public static void incompleteBody(Map<String, Object> helperMap, HttpServletResponse response, String resource, String requestId, int apiType){
		try{
			ResponseWriter.handleResponseStatus(response, HttpServletResponse.SC_BAD_REQUEST, apiType, requestId, OS3Constants.APPLICATION_XML);
	...
	public static void missingContentLength(Map<String, Object> helperMap, HttpServletResponse response, String resource, String requestId, int apiType){
		try{
	...
	public static void missingAuthorizationHeader(Map<String, Object> helperMap, HttpServletResponse response, String resource, String requestId, int apiType){
		try{
			ResponseWriter.handleResponseStatus(response, HttpServletResponse.SC_BAD_REQUEST, apiType, requestId, OS3Constants.APPLICATION_XML);
	...
	public static void missingRequiredHeaders(Map<String, Object> helperMap, HttpServletResponse response, String resource, String requestId, int apiType){
		try{
			ResponseWriter.handleResponseStatus(response, HttpServletResponse.SC_BAD_REQUEST, apiType, requestId, OS3Constants.APPLICATION_XML);
	...
	public static void missingSQLQueryHeader(Map<String, Object> helperMap, HttpServletResponse response, String resource, String requestId, int apiType){
		try{
			ResponseWriter.handleResponseStatus(response, HttpServletResponse.SC_BAD_REQUEST, apiType, requestId, OS3Constants.APPLICATION_XML);
	...
	public static void missingQueryIDHeader(Map<String, Object> helperMap, HttpServletResponse response, String resource, String requestId, int apiType){
		try{
			ResponseWriter.handleResponseStatus(response, HttpServletResponse.SC_BAD_REQUEST, apiType, requestId, OS3Constants.APPLICATION_XML);
	...
	public static void invalidToken(Map<String, Object> helperMap, HttpServletResponse response, String resource, String requestId, int apiType){
		try{
			ResponseWriter.handleResponseStatus(response, HttpServletResponse.SC_UNAUTHORIZED, apiType, requestId, OS3Constants.APPLICATION_XML);
	...
	public static void missingLoginCredentials(Map<String, Object> helperMap, HttpServletResponse response, String resource, String requestId, int apiType){
		try{
			ResponseWriter.handleResponseStatus(response, HttpServletResponse.SC_UNAUTHORIZED, apiType, requestId, OS3Constants.APPLICATION_XML);
	...
	public static void loginFailure(Map<String, Object> helperMap, HttpServletResponse response, String resource, String requestId, int apiType){
		try{
			ResponseWriter.handleResponseStatus(response, HttpServletResponse.SC_UNAUTHORIZED, apiType, requestId, OS3Constants.APPLICATION_XML);
	...
	public static void badDigest(Map<String, Object> helperMap, HttpServletResponse response, String resource, String requestId, int apiType){
		try{
			ResponseWriter.handleResponseStatus(response, HttpServletResponse.SC_BAD_REQUEST, apiType, requestId, OS3Constants.APPLICATION_XML);
	...
	public static void buketNotEmpty(Map<String, Object> helperMap, HttpServletResponse response, String resource, String requestId, int apiType){
		try{
			ResponseWriter.handleResponseStatus(response, HttpServletResponse.SC_CONFLICT, apiType, requestId, OS3Constants.APPLICATION_XML);
	...
	public static void buketNotfound(Map<String, Object> helperMap, HttpServletResponse response, String resource, String requestId, int apiType){
		try{
			ResponseWriter.handleResponseStatus(response, HttpServletResponse.SC_NOT_FOUND, apiType, requestId, OS3Constants.APPLICATION_XML);
	...
	public static void objectNotfound(Map<String, Object> helperMap, HttpServletResponse response, String resource, String requestId, int apiType){
		try{
			ResponseWriter.handleResponseStatus(response, HttpServletResponse.SC_NOT_FOUND, apiType, requestId, OS3Constants.APPLICATION_XML);
	...
	public static void internalServerError(Map<String, Object> helperMap, HttpServletResponse response, String requestId, int apiType) {
		try{
	...
	private static String getErrorResponse(Map<String, Object> helperMap, String errorCode, String errorMessage, String resource, String requestId) {
	...
	public static void writeErrorResponse(Map<String, Object> helperMap, PrintWriter pw, String errorCode, String errorMessage, String resource, String requestId){
