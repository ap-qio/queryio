...
public class CustomTagsDAO {
	protected static final Logger LOGGER = Logger.getLogger(CustomTagsDAO.class);

	public static TableModel getBigQueryResults(Connection connection, String query) {
