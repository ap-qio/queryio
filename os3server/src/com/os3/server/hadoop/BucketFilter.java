...
public class BucketFilter implements PathFilter {
	...
	public BucketFilter(FileSystem dfs, String prefix, String delimiter, int maxKeys,
			String marker) {
		super();
		this.prefix = prefix;
	...
	public boolean accept(Path path) {
		...
		if(delimiter != null && (marker == null || bMarkerReached)){
			...
			if(commonPrefix != null){
				...
				count++;
				return false; // this entry will go to common prefix and not to contents so return false.
			}
		}
