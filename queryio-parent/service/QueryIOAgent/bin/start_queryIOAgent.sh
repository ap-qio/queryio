HADOOP_LIB_HOME=../../Hadoop-2.7.3/share/hadoop/common/lib
...
YARN_LIB_HOME=../../Hadoop-2.7.3/share/hadoop/yarn
CLASSPATH=$YARN_LIB_HOME/hadoop-yarn-common-2.7.3.jar:$CLASSPATH
...
CLASSPATH=../../QueryIOServers/webapps/hdfs-over-ftp/WEB-INF/lib/hadoop-common-2.7.3.jar:../../QueryIOServers/lib/tika-app-1.2.jar:../../QueryIOServers/lib/commons-dbcp-1.2.2.jar:../../QueryIOServers/lib/commons-pool-1.4.jar:../../QueryIOServers/lib/FsImageUtils.jar:$QUERYIO_AGENT_LIB_HOME:$CLASSPATH
CLASSPATH=../../Hadoop-2.7.3/share/hadoop/common/QueryIOPlugins.jar:$CLASSPATH
