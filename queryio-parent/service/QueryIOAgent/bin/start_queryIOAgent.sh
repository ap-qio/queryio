...
CLASSPATH=../../QueryIOServers/webapps/hdfs-over-ftp/WEB-INF/lib/hadoop-common-2.7.1.jar:../../QueryIOServers/lib/tika-app-1.2.jar:../../QueryIOServers/lib/commons-dbcp-1.2.2.jar:../../QueryIOServers/lib/commons-pool-1.4.jar:../../QueryIOServers/lib/FsImageUtils.jar:$QUERYIO_AGENT_LIB_HOME:$CLASSPATH
