...
CLASSPATH=../lib/commons-dbcp-1.2.2.jar:../lib/commons-pool-1.4.jar:../lib/hadoop-custom-compiled.jar:../lib/json_simple-1.1.jar:../lib/hsqldb-2.2.8.jar:../lib/servlet-api.jar:../lib/tika-app-1.3-modified.jar:../../UserLibs/Plugins/DataTagParser.jar:../lib/commons-jexl-2.1.1.jar:$CLASSPATH
