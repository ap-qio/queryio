...
CLASSPATH=$ServiceHome/lib/commons-dbcp-1.2.2.jar:$ServiceHome/lib/commons-pool-1.4.jar:$ServiceHome/webapps/hdfs-over-ftp/WEB-INF/lib/hadoop-common-2.7.3.jar:$ServiceHome/lib/json_simple-1.1.jar:$ServiceHome/lib/hsqldb-2.2.8.jar:$ServiceHome/lib/servlet-api.jar:$ServiceHome/lib/tika-app-1.3-modified.jar:../../UserLibs/Plugins/DataTagParser.jar:$ServiceHome/lib/commons-jexl-2.1.1.jar:$CLASSPATH
