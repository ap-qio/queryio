...
pid=$(ps -ef | grep -v grep | grep hdfs.server.namenode.NameNode | awk '{print $2}')
        ...
        then
            ...
            for i in $(find $HOME/Hadoop-3.1.1/etc -name "namenode-conf_*"); do
	        	echo $i
				sh $HOME/Hadoop-3.1.1/sbin/hadoop-daemon.sh --config $i start namenode
			done
...
pid=$(ps -ef | grep -v grep | grep hdfs.server.datanode.DataNode | awk '{print $2}')
        ...
        then
            ...
            for i in $(find $HOME/Hadoop-3.1.1/etc -name "datanode-conf_*"); do
		        echo $i
				sh $HOME/Hadoop-3.1.1/sbin/hadoop-daemon.sh --config $i start datanode
			done
...
pid=$(ps -ef | grep -v grep | grep hdfs.server.namenode.SecondaryNameNode | awk '{print $2}')
        ...
        then
			...
			for i in $(find $HOME/Hadoop-3.1.1/etc -name "secondarynamenode-conf_*"); do
       			echo $i
				sh $HOME/Hadoop-3.1.1/sbin/hadoop-daemon.sh --config $i start secondarynamenode
			done
...
pid=$(ps -ef | grep -v grep | grep hdfs.qjournal.server.JournalNode | awk '{print $2}')
        ...
        then
			...
			for i in $(find $HOME/Hadoop-3.1.1/etc -name "journalnode-conf_*"); do
		        echo $i
				sh $HOME/Hadoop-3.1.1/sbin/hadoop-daemon.sh --config $i start journalnode
			done
...
# Stop ResourceManager
        ...
        then
			...
			for i in $(find $HOME/Hadoop-3.1.1/etc -name "resourcemanager-conf_*"); do
		        echo $i
				sh $HOME/Hadoop-3.1.1/sbin/yarn-daemon.sh --config $i start resourcemanager
			done
...
# Stop historyserver
        ...
        then
			...
			for i in $(find $HOME/Hadoop-3.1.1/etc -name "resourcemanager-conf_*"); do
		        echo $i
				sh $HOME/Hadoop-3.1.1/sbin/mr-jobhistory-daemon.sh --config $i start historyserver
			done
...
pid=$(ps -ef | grep -v grep | grep yarn.server.nodemanager.NodeManager | awk '{print $2}')
        ...
        then
			...
			for i in $(find $HOME/Hadoop-3.1.1/etc -name "nodemanager-conf_*"); do
		        echo $i
				sh $HOME/Hadoop-3.1.1/sbin/yarn-daemon.sh --config $i start nodemanager
			done
