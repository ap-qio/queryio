...
for i in $(find $QIO_SERVICE_HOME/Hadoop-2.8.0/etc -name "namenode-conf_*"); do
        echo $i
...
# ftpPort=$(find /root/QueryIOPackage/Hadoop-2.8.0/etc -name "namenode-conf_*" -exec grep -n queryio.ftpserver.port {}/core-site.xml \;)
# echo "FTP Port"
# echo $ftpPort
