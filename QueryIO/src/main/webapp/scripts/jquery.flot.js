...
//                placeholder.html('<div><span id = "yaxis_unit_lable_'+placeholder[0].id+'" style=" -moz-transform: rotate(180deg); -webkit-transform: rotate(180deg); -o-transform: rotate(90deg); -ms-transform: rotate(90deg); transform: rotate(90deg);position: absolute;float: left;font-size: 10px;  width: 1px;padding-top:30px;margin-right:10px;color:black;font-weight: bold; "></span></div>'); // make sure placeholder is clear
            	placeholder.html('<div><span id = "yaxis_unit_lable_'+placeholder[0].id+'" style=" -moz-transform: rotate(270deg); -webkit-transform: rotate(270deg); -o-transform: rotate(270deg); -ms-transform: rotate(270deg); transform: rotate(270deg);position: absolute;float: left;font-size: 10px;  width: 1px;padding:75px 0px 75px 5px;margin:0px;height:3px;color:black;font-weight: bold; "></span></div>'); // make sure placeholder is clear          
        ...
        function setupGrid() {
            ...
            plotWidth = canvasWidth - plotOffset.left - plotOffset.right-15;
        ...
        function insertLegend() {
            ...
            var table = '<table style="font-size:10;color:' + options.grid.color + '">' + fragments.join("") + '</table>';
