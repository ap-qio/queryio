...
public class DBAcivator {
	...
	public static ArrayList<String> getAllTableNames(String driverClass, String connectionURL, String username,
			String password, String dbDriverJar) {
		...
		try {
			...
			AppLogger.getLogger().debug(EnvironmentalConstants.getAppHome() + File.separator
					+ QueryIOConstants.DATABASE_DRIVER_JAR_FILE_DIR + File.separator + dbDriverJar);
			AppLogger.getLogger().debug("Modifying = " + EnvironmentalConstants.getAppHome()
					+ QueryIOConstants.DATABASE_DRIVER_JAR_FILE_DIR + File.separator + dbDriverJar);
