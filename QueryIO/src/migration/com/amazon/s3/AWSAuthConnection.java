...
public class AWSAuthConnection {
	...
	public Response createBucket(String bucket, String location, Map headers)
		...
		if (location == null) {
			...
			body = "<CreateBucketConstraint><LocationConstraint>" + location
	 ...
	 *            headers to pass (can be null).
	 */
	public ListBucketResponse listBucket(String bucket, String prefix, String marker, Integer maxKeys, String delimiter,
	...
	/**
	 * Creates a copy of an existing S3 Object. In this signature, we will copy
	 * the existing metadata. The default access control policy is private; if
	 * you want to override it, please use x-amz-acl in the headers.
	 * 
	 * @param sourceBucket
	 *            The name of the bucket where the source object lives.
	 * @param sourceKey
	 ...
	 * @param headers
	 *            A Map of String to List of Strings representing the http
	 *            headers to pass (can be null). You may wish to set the
	 *            x-amz-acl header appropriately.
	 */
	public Response copy(String sourceBucket, String sourceKey, String destinationBucket, String destinationKey,
			Map headers) throws MalformedURLException, IOException {
	...
	/**
	 * Creates a copy of an existing S3 Object. In this signature, we will
	 * replace the existing metadata. The default access control policy is
	 * private; if you want to override it, please use x-amz-acl in the headers.
	 * 
	 * @param sourceBucket
	 *            The name of the bucket where the source object lives.
	 * @param sourceKey
	 ...
	 */
	public Response copy(String sourceBucket, String sourceKey, String destinationBucket, String destinationKey,
			Map metadata, Map headers) throws MalformedURLException, IOException {
	...
	/**
	 * Copy sometimes returns a successful response and starts to send
	 * whitespace characters to us. This method processes those whitespace
	 * characters and will throw an exception if the response is either unknown
	 * or an error.
	 * 
	 * @param response
	 ...
	 * 
	 * @param loggingXMLDoc
	 *            The xml representation of the requestPayment configuration as
	 *            a String
	 * @param bucket
	 *            The name of the bucket
	 * @param headers
	...
	private HttpURLConnection makeRequest(String method, String bucket, String key, Map pathArgs, Map headers,
			S3Object object) throws MalformedURLException, IOException {
		...
		if (isSecure && callingFormat != CallingFormat.getPathCallingFormat() && bucket.indexOf(".") != -1) {
			System.err.println(
					"You are making an SSL connection, however, the bucket contains periods and the wildcard certificate will not match by default.  Please consider using HTTP.");
		}
	...
	private void addAuthHeader(HttpURLConnection connection, String method, String bucket, String key, Map pathArgs) {
		...
		String canonicalString = Utils.makeCanonicalString(method, bucket, key, pathArgs,
