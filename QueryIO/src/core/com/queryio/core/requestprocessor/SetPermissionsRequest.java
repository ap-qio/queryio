...
public class SetPermissionsRequest extends RequestProcessorCore{
	...
	public void process() throws Exception{
		...
		if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("In SetPermissionsRequest, user: " + this.user);
		...
		try
		{
			...
			if(this.recursive){
				...
				if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("Set permissions request for this.path: " + this.path + " this.owner: " + this.owner + " this.group: " + this.group + " this.permissions: " + this.permissions + " new FsPermission(this.permissions): " + fsP);
				dfs.setPermission(this.path, fsP);
			}
			
			if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("Root: " + dfs.getFileStatus(new Path("/")).getPermission() + ", owner: " + dfs.getFileStatus(new Path("/")).getOwner());
