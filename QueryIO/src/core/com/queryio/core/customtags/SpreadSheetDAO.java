...
public class SpreadSheetDAO {
	...
	public static void insert(Connection connection, String sheetId, String path, String nameNodeId) throws SQLException
	{
		PreparedStatement ps = null;
		
		try{
			ps = DatabaseFunctions.getPreparedStatement(connection, QueryConstants.PREPARED_QRY_SPREADSHEETS_INSERT_SHEET);
	...
	public static ArrayList<String> getSheetId(Connection connection, String nameNodeId) throws SQLException
	{
		...
		try{
			ps = DatabaseFunctions.getPreparedStatement(connection, QueryConstants.PREPARED_QRY_SPREADSHEETS_GET_SHEET_IDS);
	...
	public static void delete(Connection connection, String sheetId) throws SQLException
	{
		...
		try{
			ps =  DatabaseFunctions.getPreparedStatement(connection, QueryConstants.PREPARED_QRY_SPREADSHEETS_DELETE_SHEET);
			ps.setString(1, sheetId);
