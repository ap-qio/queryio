...
//
// public class DFSMap {
// private static HashMap<String, FileSystem> dfsMap = new HashMap<String,
// FileSystem>();
//
...
// String[] result = QueryIOAgentManager.getConfig(host, new
// String[]{DFSConfigKeys.FS_DEFAULT_NAME_KEY}, node, "core-site.xml");
