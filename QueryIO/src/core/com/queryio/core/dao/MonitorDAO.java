...
public class MonitorDAO {
	public static ArrayList getHostControllerHistoricalAttributes(final Connection connection, int hostId)
			throws Exception {
		String query1 = QueryConstants.QRY_SELECT_ALL_FROM + QueryIOConstants.MONITORDATA_TABLE_PREFIX + hostId
				+ "_HOST_MONITORDATA LIMIT 0";
	...
	public static ArrayList getNameNodeControllerHistoricalAttributes(final Connection connection, String nodeId)
			throws Exception {
		String query1 = QueryConstants.QRY_SELECT_ALL_FROM + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId
				+ "_NAMENODE_MONITORDATA LIMIT 0";
		String query2 = QueryConstants.QRY_SELECT_ALL_FROM_NAMENODE_SYSTEM_ATTRIBUTES_WHERE_COLUMNNAME_IN;

		return getHistoricalControllerAttributes(connection, query1, query2);
	}

	public static ArrayList getDataNodeControllerHistoricalAttributes(final Connection connection, String nodeId)
			throws Exception {
		String query1 = QueryConstants.QRY_SELECT_ALL_FROM + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId
				+ "_DATANODE_MONITORDATA LIMIT 0";
		String query2 = QueryConstants.QRY_SELECT_ALL_FROM_DATANODE_SYSTEM_ATTRIBUTES_WHERE_COLUMNNAME_IN;

		return getHistoricalControllerAttributes(connection, query1, query2);
	}

	public static ArrayList getResourceManagerControllerHistoricalAttributes(final Connection connection, String nodeId)
			throws Exception {
		String query1 = QueryConstants.QRY_SELECT_ALL_FROM + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId
				+ "_RESOURCEMANAGER_MONITORDATA LIMIT 0";
		String query2 = QueryConstants.QRY_SELECT_ALL_FROM_RESOURCE_MANAGER_SYSTEM_ATTRIBUTES_WHERE_COLUMNNAME_IN;

		return getHistoricalControllerAttributes(connection, query1, query2);
	}

	public static ArrayList getNodeManagerControllerHistoricalAttributes(final Connection connection, String nodeId)
			throws Exception {
		String query1 = QueryConstants.QRY_SELECT_ALL_FROM + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId
				+ "_NODEMANAGER_MONITORDATA LIMIT 0";
		String query2 = QueryConstants.QRY_SELECT_ALL_FROM_NODE_MANAGER_SYSTEM_ATTRIBUTES_WHERE_COLUMNNAME_IN;

		return getHistoricalControllerAttributes(connection, query1, query2);
	}

	public static ArrayList getNameNodeControllerSummaryAttributes(final Connection connection, String nodeId)
			throws Exception {
		String query1 = QueryConstants.QRY_SELECT_ALL_FROM + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId
				+ "_NAMENODE_SUMMARYDATA LIMIT 0";
	...
	public static ArrayList getDataNodeControllerSummaryAttributes(final Connection connection, String nodeId)
			throws Exception {
		String query1 = QueryConstants.QRY_SELECT_ALL_FROM + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId
				+ "_DATANODE_SUMMARYDATA LIMIT 0";
		String query2 = QueryConstants.QRY_SELECT_ALL_FROM_DATANODE_LIVE_ATTRIBUTES_WHERE_COLUMNNAME_IN;

		return getSummaryControllerAttributes(connection, query1, query2);
	}

	public static ArrayList getResourceManagerControllerSummaryAttributes(final Connection connection, String nodeId)
			throws Exception {
		String query1 = QueryConstants.QRY_SELECT_ALL_FROM + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId
				+ "_RESOURCEMANAGER_SUMMARYDATA LIMIT 0";
		String query2 = QueryConstants.QRY_SELECT_ALL_FROM_RESOURCE_MANAGER_LIVE_ATTRIBUTES_WHERE_COLUMNNAME_IN;

		return getSummaryControllerAttributes(connection, query1, query2);
	}

	public static ArrayList getNodeManagerControllerSummaryAttributes(final Connection connection, String nodeId)
			throws Exception {
		String query1 = QueryConstants.QRY_SELECT_ALL_FROM + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId
				+ "_NODEMANAGER_SUMMARYDATA LIMIT 0";
		String query2 = QueryConstants.QRY_SELECT_ALL_FROM_NODE_MANAGER_LIVE_ATTRIBUTES_WHERE_COLUMNNAME_IN;

		return getSummaryControllerAttributes(connection, query1, query2);
	}

	public static ArrayList getHistoricalControllerAttributes(final Connection connection, String queryMonitorData,
			String querySystemAttributes) throws Exception {
		ResultSet rs = null;
		ResultSet rs1 = null;
		...
		try {
			...
			while (rs1.next()) {
				map.put(rs1.getString(ColumnConstants.COL_SYSTEM_ATTRIBUTES_COLUMNNAME).toUpperCase(),
						rs1.getString(ColumnConstants.COL_SYSTEM_ATTRIBUTES_OBJECTNAME)
								+ QueryIOConstants.ATTRIBUTE_OBJECT_SEPERATOR
								+ rs1.getString(ColumnConstants.COL_SYSTEM_ATTRIBUTES_ATTRIBUTENAME));
				descMap.put(rs1.getString(ColumnConstants.COL_SYSTEM_ATTRIBUTES_COLUMNNAME).toUpperCase(),
						rs1.getString(ColumnConstants.COL_SYSTEM_ATTRIBUTES_GROUPNAME) + " : "
								+ rs1.getString(ColumnConstants.COL_SYSTEM_ATTRIBUTES_DESCRIPTION));
			}
	...
	public static ArrayList getSummaryControllerAttributes(final Connection connection, String queryMonitorData,
			String querySystemAttributes) throws Exception {
		ArrayList alControllerAttributes = new ArrayList();
		ResultSet rs1 = null;
		ResultSet rs = null;
	...
	public static MonitorData getHostMonitorData(final Connection connection, int hostId, String interval)
			throws Exception {
		...
		// AppLogger.getLogger().debug("NAMENODE getNameNodeMonitorData");

		return getMonitorData(connection, "HOST_SYSTEM_ATTRIBUTES", QueryConstants.QRY_SELECT_ALL_FROM
				+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + hostId + intervalCondition.toString());
	}

	public static MonitorData getNameNodeMonitorData(final Connection connection, String nodeId, String interval)
			throws Exception {
		StringBuffer intervalCondition = new StringBuffer();
		...
		return getMonitorData(connection, "NAMENODE_SYSTEM_ATTRIBUTES", QueryConstants.QRY_SELECT_ALL_FROM
				+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId + intervalCondition.toString());
	}

	public static MonitorData getNameNodeMonitorData(final Connection connection, String nodeId,
			Timestamp startTimestamp, Timestamp endTimestamp) throws Exception {
		StringBuffer intervalCondition = new StringBuffer();
		...
		// if(AppLogger.getLogger().isDebugEnabled())
		// AppLogger.getLogger().debug("DATANODE getDataNodeMonitorData");

		return getMonitorData(connection, "NAMENODE_SYSTEM_ATTRIBUTES", QueryConstants.QRY_SELECT_ALL_FROM
				+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId + intervalCondition.toString());
	}

	public static MonitorData getHostMonitorData(final Connection connection, int hostId, Timestamp startTimestamp,
	...
	public static MonitorData getDataNodeMonitorData(final Connection connection, String nodeId, String interval)
			throws Exception {
		StringBuffer intervalCondition = new StringBuffer();
		...
		return getMonitorData(connection, "DATANODE_SYSTEM_ATTRIBUTES", QueryConstants.QRY_SELECT_ALL_FROM
				+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId + intervalCondition.toString());
	}

	public static MonitorData getResourceManagerMonitorData(final Connection connection, String nodeId, String interval)
			throws Exception {
		StringBuffer intervalCondition = new StringBuffer();
		...
		return getMonitorData(connection, "RESOURCE_MANAGER_SYSTEM_ATTRIBUTES", QueryConstants.QRY_SELECT_ALL_FROM
				+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId + intervalCondition.toString());
	}

	public static MonitorData getResourceManagerMonitorData(final Connection connection, String nodeId,
			Timestamp startTimestamp, Timestamp endTimestamp) throws Exception {
		StringBuffer intervalCondition = new StringBuffer();
	...
	public static MonitorData getNodeManagerMonitorData(final Connection connection, String nodeId, String interval)
			throws Exception {
		StringBuffer intervalCondition = new StringBuffer();
		...
		return getMonitorData(connection, "NODE_MANAGER_SYSTEM_ATTRIBUTES", QueryConstants.QRY_SELECT_ALL_FROM
				+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId + intervalCondition.toString());
	}

	public static MonitorData getNodeManagerMonitorData(final Connection connection, String nodeId,
			Timestamp startTimestamp, Timestamp endTimestamp) throws Exception {
		StringBuffer intervalCondition = new StringBuffer();
	...
	public static MonitorData getDataNodeMonitorData(final Connection connection, String nodeId,
			Timestamp startTimestamp, Timestamp endTimestamp) throws Exception {
		StringBuffer intervalCondition = new StringBuffer();
	...
	public static long[] getNameNodeSummaryIntervalData(final Connection connection, String nodeId, String interval)
			throws Exception {
		StringBuffer intervalCondition = new StringBuffer();
		...
		String query = "SELECT SUM(" + ColumnConstants.COL_NN_MONITORDATA_FILESREAD + "), SUM("
				+ ColumnConstants.COL_NN_MONITORDATA_FILESWRITE + ") FROM " + QueryIOConstants.MONITORDATA_TABLE_PREFIX
				+ nodeId + intervalCondition.toString();
		...
		try {
			...
			if (rs.next()) {
				try {
					totalFileReads = rs.getLong(1);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}

				try {
					totalFileWrites = rs.getLong(2);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}
			}
	...
	public static long[] getDataNodeSummaryIntervalData(final Connection connection, String nodeId, String interval)
			throws Exception {
		StringBuffer intervalCondition = new StringBuffer();
		...
		String query = "SELECT SUM(" + ColumnConstants.COL_DN_MONITORDATA_BYTESREAD + "), SUM("
				+ ColumnConstants.COL_DN_MONITORDATA_BYTESWRITE + "), SUM("
				+ ColumnConstants.COL_DN_MONITORDATA_BLOCKSREAD + "), SUM("
				+ ColumnConstants.COL_DN_MONITORDATA_BLOCKSWRITE + ")" + " FROM "
				+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId + intervalCondition.toString();
		...
		try {
			...
			if (rs.next()) {
				try {
					totalBytesRead = rs.getLong(1);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}

				try {
					totalBytesWritten = rs.getLong(2);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}

				try {
					totalBlocksRead = rs.getLong(3);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}

				try {
					totalBlocksWritten = rs.getLong(4);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}
			}
	...
	public static ArrayList getNameNodeSummaryData(final Connection connection, String nodeId, String interval)
			throws Exception {
		...
		try {
			...
			try {
				...
				while (rs.next()) {
					try {
						jvmHeapUsed = rs.getFloat(ColumnConstants.COL_NN_SUMMARYDATA_JVMHEAPUSED);
					} catch (Exception e) {
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}

					try {
						jvmStartedOn = rs.getLong(ColumnConstants.COL_NN_SUMMARYDATA_JVMSTARTEDON);
					} catch (Exception e) {
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
				}
	...
	public static ArrayList getNameNodeSummaryData(final Connection connection) throws Exception {
		...
		try {
			for (int var = 0; var < namenodes.size(); var++) {
				...
				try {
					totalFileReads += getNameNodeCurrentValueForColumn(connection, namenode.getId(),
							ColumnConstants.COL_NN_SUMMARYDATA_TOTALFILESREAD);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}

				try {
					totalFileWrites += getNameNodeCurrentValueForColumn(connection, namenode.getId(),
							ColumnConstants.COL_NN_SUMMARYDATA_TOTALFILESWRITE);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}

				try {
					totalFileAppends += getNameNodeCurrentValueForColumn(connection, namenode.getId(),
							ColumnConstants.COL_NN_SUMMARYDATA_TOTALFILESAPPENDED);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}

				try {
					totalFileRenames += getNameNodeCurrentValueForColumn(connection, namenode.getId(),
							ColumnConstants.COL_NN_SUMMARYDATA_TOTALFILESRENAMED);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}

				try {
					totalListFileOps += getNameNodeCurrentValueForColumn(connection, namenode.getId(),
							ColumnConstants.COL_NN_SUMMARYDATA_LISTOPS);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}

				try {
					totalDeleteFileOps += getNameNodeCurrentValueForColumn(connection, namenode.getId(),
							ColumnConstants.COL_NN_SUMMARYDATA_DELETEFILEOPS);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}
			}
			...
			for (int j = 0; j < datanodes.size(); j++) {
				...
				try {
					totalBytesRead += getDataNodeCurrentValueForColumn(connection, datanode.getId(),
							ColumnConstants.COL_DN_SUMMARYDATA_BYTESREAD);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}

				try {
					totalBytesWritten += getDataNodeCurrentValueForColumn(connection, datanode.getId(),
							ColumnConstants.COL_DN_SUMMARYDATA_BYTESWRITTEN);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}

				try {
					totalBlocksRead += getDataNodeCurrentValueForColumn(connection, datanode.getId(),
							ColumnConstants.COL_DN_SUMMARYDATA_TOTALBLOCKSREAD);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}

				try {
					totalBlocksWritten += getDataNodeCurrentValueForColumn(connection, datanode.getId(),
							ColumnConstants.COL_DN_SUMMARYDATA_TOTALBLOCKSWRITE);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}
			}
		...
		// list.add(new Parameter("Total Files and Directories",
	...
	public static ArrayList getDataNodeSummaryData(final Connection connection, String nodeId, String interval)
			throws Exception {
		NumberFormat nf = NumberFormat.getInstance();
		nf.setMaximumFractionDigits(2);
		...
		try {
			...
			try {
				...
				while (rs.next()) {
					try {
						jvmHeapUsed = rs.getFloat(ColumnConstants.COL_DN_SUMMARYDATA_JVMHEAPUSED);
					} catch (Exception e) {
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}

					try {
						jvmStartedOn = rs.getLong(ColumnConstants.COL_DN_SUMMARYDATA_JVMSTARTEDON);
					} catch (Exception e) {
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}

					try {
						fullVolumeInfoList = parseVolumeInfo(
								rs.getString(ColumnConstants.COL_DN_SUMMARYDATA_VOLUMEINFO));
		...
		list.add(new Parameter("JVM Heap Used", nf.format(jvmHeapUsed) + " MB"));
		list.add(new Parameter("JVM Started On", sdf.format(jvmStartedOn)));
		list.add(new Parameter("Total Bytes Read",
				getDataNodeCurrentValueForColumn(connection, nodeId, ColumnConstants.COL_DN_SUMMARYDATA_BYTESREAD)));
		list.add(new Parameter("Total Bytes Written",
				getDataNodeCurrentValueForColumn(connection, nodeId, ColumnConstants.COL_DN_SUMMARYDATA_BYTESWRITTEN)));
		list.add(new Parameter("Total Blocks Read", getDataNodeCurrentValueForColumn(connection, nodeId,
				ColumnConstants.COL_DN_SUMMARYDATA_TOTALBLOCKSREAD)));
		list.add(new Parameter("Total Blocks Written", getDataNodeCurrentValueForColumn(connection, nodeId,
				ColumnConstants.COL_DN_SUMMARYDATA_TOTALBLOCKSWRITE)));
	...
	public static ArrayList getDataNodeSummaryData(final Connection connection, ArrayList dataNodes) throws Exception {
		...
		try {
			for (int var = 0; var < dataNodes.size(); var++) {
					...
					while (rs.next()) {
						try {
							...
							for (int i = 0; i < fullVolumeInfoList.size(); i++) {
								...
								int volLastIndex = volumePath.indexOf(datanode.getId() + "/current") != -1
										? volumePath.indexOf("current") : volumePath.length();
								String diskName = VolumeDAO.getDisk(connection, datanode.getId(),
										volumePath.substring(0, volLastIndex));
				...
				try {
					totalBytesRead += getDataNodeTotalValueForColumn(connection, datanode.getId(),
							ColumnConstants.COL_DN_MONITORDATA_BYTESREAD);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}

				try {
					totalBytesWritten += getDataNodeTotalValueForColumn(connection, datanode.getId(),
							ColumnConstants.COL_DN_MONITORDATA_BYTESWRITE);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}

				try {
					totalBlocksRead += getDataNodeTotalValueForColumn(connection, datanode.getId(),
							ColumnConstants.COL_DN_MONITORDATA_BLOCKSREAD);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}

				try {
					totalBlocksWritten += getDataNodeTotalValueForColumn(connection, datanode.getId(),
							ColumnConstants.COL_DN_MONITORDATA_BLOCKSWRITE);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}
		...
		int dnCount = 0;
		try {
			dnCount = NodeDAO.getAllNodeCountForType(connection, QueryIOConstants.DATANODE);
		} catch (Exception e) {
			AppLogger.getLogger().fatal(e.getMessage(), e);
		}
		...
		int volCount = 0;
		try {
			volCount = VolumeDAO.getAllDataNodeVolumesCount(connection);
		} catch (Exception e) {
			AppLogger.getLogger().fatal(e.getMessage(), e);
		}
		// TODO:
		// list.add(new Parameter("JVM Heap Used", nf.format(jvmHeapUsed) + "
		// MB"));
		// list.add(new Parameter("Total Bytes Read",
		// getFormattedStorageSize(totalBytesRead)));
		// list.add(new Parameter("Total Bytes Written",
		// getFormattedStorageSize(totalBytesWritten)));
		// list.add(new Parameter("Total Blocks Read", totalBlocksRead));
		// list.add(new Parameter("Total Blocks Written", totalBlocksWritten));
	...
	public static MonitorData getMonitorData(Connection connection, String systemAttributesTableName, String query)
			throws Exception {
		...
		// if(AppLogger.getLogger().isDebugEnabled())
		// AppLogger.getLogger().debug("query getMonitorData: " + query);

		try {
			stmt = DatabaseFunctions.getStatement(connection);
			// AppLogger.getLogger().fatal(" MonitorData.getMonitorData : Query
			// : "+query);
			...
			rs1 = CoreDBManager.getQueryResultsForStatement(stmt,
					QueryConstants.QRY_SELECT_ALL_FROM + systemAttributesTableName);

			while (rs1.next()) {
				mapAttributeName.put(rs1.getString(ColumnConstants.COL_SYSTEM_ATTRIBUTES_COLUMNNAME).toUpperCase(),
						rs1.getString(ColumnConstants.COL_SYSTEM_ATTRIBUTES_ATTRIBUTENAME));
				mapDescription.put(rs1.getString(ColumnConstants.COL_SYSTEM_ATTRIBUTES_COLUMNNAME).toUpperCase(),
						rs1.getString(ColumnConstants.COL_SYSTEM_ATTRIBUTES_DESCRIPTION));
			}
			for (int i = 0; i < rsmd.getColumnCount(); i++) {
				monitorData.addAttributeData(
						new AttributeData((String) mapAttributeName.get(rsmd.getColumnName(i + 1).toUpperCase()),
								(String) mapDescription.get(rsmd.getColumnName(i + 1).toUpperCase()), values[i]));
			}
		} finally {
			try {
				DatabaseFunctions.closeResultSet(rs);
	...
	public static ArrayList getSummaryData(Connection connection, String liveAttributesTableName, String query)
			throws Exception {
		...
		try {
			...
			rs1 = CoreDBManager.getQueryResultsForStatement(stmt,
					QueryConstants.QRY_SELECT_ALL_FROM + liveAttributesTableName);

			while (rs1.next()) {
				mapAttributeName.put(rs1.getString(ColumnConstants.COL_SYSTEM_ATTRIBUTES_COLUMNNAME),
						rs1.getString(ColumnConstants.COL_SYSTEM_ATTRIBUTES_ATTRIBUTENAME));
				mapDescription.put(rs1.getString(ColumnConstants.COL_SYSTEM_ATTRIBUTES_COLUMNNAME),
						rs1.getString(ColumnConstants.COL_SYSTEM_ATTRIBUTES_DESCRIPTION));
			}
			...
			while (rs.next()) {
				for (int i = 1; i <= rsmd.getColumnCount(); i++) {
					summaryData.add(
							new Parameter(String.valueOf(mapDescription.get(rsmd.getColumnName(i))), rs.getLong(i)));
				}
			}
		...
		try {
			...
			for (int i = 0; i < namenodes.size(); i++) {
				...
				try {
					...
					AppLogger.getLogger().fatal("Storage capacity information could not be retrieved for nodeId: "
							+ ((Node) namenodes.get(i)).getId(), e);
				}
			}
		} finally {
			try {
	...
	public static ArrayList getNameNodeMemoryInfo(Connection connection, String nodeId) {
		...
		try {
			...
			try {
				...
				AppLogger.getLogger().fatal("Storage capacity information could not be retrieved for nodeId: " + nodeId,
						e);
			}
		} finally {
			try {
	...
	public static ArrayList getAllDataNodeMemoryInfo(Connection connection, ArrayList datanodes) throws Exception {
			...
			for (int j = 0; j < datanodes.size(); j++) {
				...
				try {
					...
					AppLogger.getLogger().fatal(
							"Storage capacity information could not be retrieved for nodeID: " + datanode.getId(), e);
				}
			}
		} finally {
			try {
		...
		// if(AppLogger.getLogger().isDebugEnabled())
		// AppLogger.getLogger().debug("Total Capacity: " + totalCapacity);
		// if(AppLogger.getLogger().isDebugEnabled())
		// AppLogger.getLogger().debug("Used Capacity: " + usedCapacity);
		//
		list.add(nf.format(totalCapacity / (float) (1024 * 1024 * 1024)));
		list.add(nf.format(usedCapacity / (float) (1024 * 1024 * 1024)));
	...
	public static ArrayList parseVolumeInfo(String volumeInfo) {
		...
		// if(AppLogger.getLogger().isDebugEnabled())
		// AppLogger.getLogger().debug("Volume Info:" + volumeInfo + "#");
		long freeSpace = 0;
		long usedSpace = 0;
		...
		if (volumeInfo != null && volumeInfo.length() != 0 && !volumeInfo.equals("0")) {
			...
			if (volumes.length != 0)
				volumes[0] = volumes[0].substring(2, volumes[0].length());
			...
			for (int i = 0; i < volumes.length; i++) {
				...
				tdex = temp[1].indexOf('}');
				if (tdex != -1)
					reservedSpace = Long.parseLong(temp[1].substring(0, tdex));
				else
					reservedSpace = Long.parseLong(temp[1]);
	...
	public static ArrayList getClusterSummaryData(Connection connection, String liveAttributesTableName,
			ArrayList namenodes) throws Exception {
		ArrayList list = new ArrayList();
		Statement stmt = null;
		ResultSet rs = null;
		ResultSet rs1 = null;
		...
		try {
			...
			for (int i = 0; i < namenodes.size(); i++) {
				queryNameNode = QueryConstants.QRY_SELECT_ALL_FROM + QueryIOConstants.MONITORDATA_TABLE_PREFIX
						+ ((Node) namenodes.get(i)).getId() + "_NAMENODE_SUMMARYDATA";

				rs = DatabaseFunctions.getQueryResultsForStatement(stmt, queryNameNode);

				while (rs.next()) {
					try {
						totalFileReads += rs.getLong(ColumnConstants.COL_NN_SUMMARYDATA_TOTALFILESREAD);
					} catch (Exception e) {
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}

					try {
						totalFileWrites += rs.getLong(ColumnConstants.COL_NN_SUMMARYDATA_TOTALFILESWRITE);
					} catch (Exception e) {
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
				}
			...
			for (int i = 0; i < datanodes.size(); i++) {
				queryDataNode = QueryConstants.QRY_SELECT_ALL_FROM + QueryIOConstants.MONITORDATA_TABLE_PREFIX
						+ ((Node) datanodes.get(i)).getId() + "_DATANODE_SUMMARYDATA";

				rs1 = DatabaseFunctions.getQueryResultsForStatement(stmt, queryDataNode);

				while (rs1.next()) {
					try {
						totalBytesRead += rs1.getLong(ColumnConstants.COL_DN_SUMMARYDATA_BYTESREAD);
					} catch (Exception e) {
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}

					try {
						totalBytesWritten += rs1.getLong(ColumnConstants.COL_DN_SUMMARYDATA_BYTESWRITTEN);
					} catch (Exception e) {
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}

					try {
						totalBlocksRead += rs1.getLong(ColumnConstants.COL_DN_SUMMARYDATA_TOTALBLOCKSREAD);
					} catch (Exception e) {
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}

					try {
						totalBlocksWritten += rs1.getLong(ColumnConstants.COL_DN_SUMMARYDATA_TOTALBLOCKSWRITE);
					} catch (Exception e) {
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
				}
	...
	public static String getFormattedRate(long bytes) {
		...
		if (bytes < QueryIOConstants.ONE_MB)
			return nf.format(bytes / (double) QueryIOConstants.ONE_KB) + " KB/s";

		if (bytes < QueryIOConstants.ONE_GB)
			return nf.format(bytes / (double) QueryIOConstants.ONE_MB) + " MB/s";

		if (bytes < QueryIOConstants.ONE_TB)
			return nf.format(bytes / (double) QueryIOConstants.ONE_GB) + " GB/s";
	...
	public static SummaryTable getAllNameNodesSummaryTable(Connection connection, String liveAttributesTableName,
			ArrayList namenodes, boolean isSummaryForReport) throws Exception {
		NumberFormat nf = NumberFormat.getInstance();
		nf.setMaximumFractionDigits(2);
		...
		try {
			...
			for (int i = 0; i < namenodes.size(); i++) {
				...
				query = QueryConstants.QRY_SELECT_ALL_FROM + QueryIOConstants.MONITORDATA_TABLE_PREFIX + node.getId()
						+ "_NAMENODE_SUMMARYDATA";

				rs = DatabaseFunctions.getQueryResultsForStatement(stmt, query);

				query = QueryConstants.QRY_SELECT_ALL_FROM + QueryIOConstants.MONITORDATA_TABLE_PREFIX + host.getId()
						+ "_HOST_SUMMARYDATA";
				...
				colValues.add(HAStatusDAO.isHANode(connection, node.getId())
						? (HAStatusDAO.getStandbyNodeId(connection, node.getId()) == null ? QueryIOConstants.STANDBY
								: QueryIOConstants.ACTIVE)
						: QueryIOConstants.NONHA); // HA Status

				if (rs.next() && hostDataRS.next()) {
					try {
						colValues.add(getFormattedStorageSize(
								rs.getFloat(ColumnConstants.COL_NN_SUMMARYDATA_JVMHEAPUSED) * QueryIOConstants.ONE_MB));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
					...
					try {
						colValues.add(rs.getObject(ColumnConstants.COL_NN_SUMMARYDATA_TOTALFILESREAD));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
					...
					try {
						colValues.add(rs.getObject(ColumnConstants.COL_NN_SUMMARYDATA_TOTALFILESWRITE));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
					...
					try {
						colValues.add(nf.format(hostDataRS.getFloat(ColumnConstants.COL_CPUUSAGE)) + " %");
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
					...
					try {
						if (hostDataRS.getLong(ColumnConstants.COL_RAMTOTAL) == 0) {
							...
							colValues.add(getFormattedStorageSize(((hostDataRS.getLong(ColumnConstants.COL_RAMTOTAL)
									- hostDataRS.getLong(ColumnConstants.COL_RAMFREE)) * QueryIOConstants.ONE_MB)));
						}
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					...
					try {
						colValues.add(getFormattedRate(hostDataRS.getFloat(ColumnConstants.COL_NW_RECDBYTESPERSEC)));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
					...
					try {
						colValues.add(getFormattedRate(hostDataRS.getFloat(ColumnConstants.COL_NW_SENTBYTESPERSEC)));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
					...
					try {
						colValues.add(getFormattedRate(hostDataRS.getFloat(ColumnConstants.COL_DSK_BYTESREADPERSEC)));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
					...
					try {
						colValues.add(getFormattedRate(hostDataRS.getFloat(ColumnConstants.COL_DSK_BYTESWRITEPERSEC)));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
				...
				if (!isSummaryForReport) {
					colValues.add("<a href='" + constructOutLink(node, host)
							+ "' target=\"_blank\">stdout/stderr</a><br><a href='" + constructLogLink(node, host)
							+ "' target=\"_blank\">full log file</a>");
				}
	...
	private static long[] getTotalFilesAndBlocks(final Connection connection, String nameNodeId) throws SQLException {
		...
		try {
			stmt = DatabaseFunctions.getStatement(connection);
			String query = QueryConstants.QRY_SELECT_ALL_FROM + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nameNodeId
					+ "_NAMENODE_SUMMARYDATA";
			...
			if (rs.next()) {
				try {
					filesAndDirectories[0] += rs.getLong(ColumnConstants.COL_NN_SUMMARYDATA_TOTALFILES);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}
				try {
					filesAndDirectories[1] += rs.getLong(ColumnConstants.COL_NN_SUMMARYDATA_TOTALBLOCKS);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}
			}
	...
	private static String constructOutLink(Node node, Host host) {
		return "http://" + host.getHostIP() + ":" + host.getAgentPort() + "/" + QueryIOConstants.AGENT_QUERYIO + "/log"
				+ "?node-id=" + node.getId() + "&node-type=" + node.getNodeType() + "&host-dir="
				+ host.getInstallDirPath() + "&file-type=out";
	}

	private static String constructLogLink(Node node, Host host) {
		return "http://" + host.getHostIP() + ":" + host.getAgentPort() + "/" + QueryIOConstants.AGENT_QUERYIO + "/log"
				+ "?node-id=" + node.getId() + "&node-type=" + node.getNodeType() + "&host-dir="
				+ host.getInstallDirPath() + "&file-type=log";
	}
	...
	public static SummaryTable getAllDataNodesSummaryTable(Connection connection, String liveAttributesTableName,
			ArrayList datanodes, boolean isSummaryForReport) throws Exception {
		NumberFormat nf = NumberFormat.getInstance();
		nf.setMaximumFractionDigits(2);
				...
				if (rs.next() && hostDataRS.next()) {
					try {
						...
						if (fullVolumeInfoList.size() == 1) {
							...
							volumePath = ((String) tList.get(0)).replace("\\\\", "\\"); // in
																						// case
																						// of
																						// windows,
																						// volume
							...
							try {
								colValues.add(getFormattedStorageSize(
										rs.getFloat(ColumnConstants.COL_NN_SUMMARYDATA_JVMHEAPUSED)
												* QueryIOConstants.ONE_MB));
							} catch (Exception e) {
								colValues.add("N/A");
								AppLogger.getLogger().fatal(e.getMessage(), e);
							}
							...
							volLastIndex = volumePath.indexOf(node.getId() + "/current") != -1
									? volumePath.indexOf("current") : volumePath.length();
							String diskName = VolumeDAO.getDisk(connection, node.getId(),
									volumePath.substring(0, volLastIndex));
							diskMonitoredData = DiskMonitoredDataDAO.getMonitoredData(connection, host.getId(),
									diskName);

							try {
								colValues.add(diskName);
							} catch (Exception e) {
								colValues.add("N/A");
								AppLogger.getLogger().fatal(e.getMessage(), e);
							}
							...
							try {
								colValues.add(getFormattedRate(
										diskMonitoredData != null ? diskMonitoredData.getDiskByteReadsPerSec() : 0));
							} catch (Exception e) {
								colValues.add("N/A");
								AppLogger.getLogger().fatal(e.getMessage(), e);
							}
							...
							try {
								colValues.add(getFormattedRate(
										diskMonitoredData != null ? diskMonitoredData.getDiskByteWritesPerSec() : 0));
							} catch (Exception e) {
								colValues.add("N/A");
								AppLogger.getLogger().fatal(e.getMessage(), e);
							}
							...
							if (totalCapacity == 0)
								...
								colValues.add(nf.format(usedCapacity * 100 / (float) totalCapacity) + " %");

							try {
								colValues.add(getFormattedStorageSize(
										rs.getLong(ColumnConstants.COL_DN_SUMMARYDATA_BYTESREAD)));
							} catch (Exception e) {
								colValues.add("N/A");
								AppLogger.getLogger().fatal(e.getMessage(), e);
							}
							...
							try {
								colValues.add(getFormattedStorageSize(
										rs.getLong(ColumnConstants.COL_DN_SUMMARYDATA_BYTESWRITTEN)));
							} catch (Exception e) {
								colValues.add("N/A");
								AppLogger.getLogger().fatal(e.getMessage(), e);
							}
							...
							try {
								if (hostDataRS.getLong(ColumnConstants.COL_RAMTOTAL) == 0) {
									...
									colValues.add(
											getFormattedStorageSize(((hostDataRS.getLong(ColumnConstants.COL_RAMTOTAL)
													- hostDataRS.getLong(ColumnConstants.COL_RAMFREE))
													* QueryIOConstants.ONE_MB)));
								}
							} catch (Exception e) {
								colValues.add("N/A");
							...
							try {
								colValues.add(
										getFormattedRate(hostDataRS.getFloat(ColumnConstants.COL_NW_RECDBYTESPERSEC)));
							} catch (Exception e) {
								colValues.add("N/A");
								AppLogger.getLogger().fatal(e.getMessage(), e);
							}
							...
							try {
								colValues.add(
										getFormattedRate(hostDataRS.getFloat(ColumnConstants.COL_NW_SENTBYTESPERSEC)));
							} catch (Exception e) {
								colValues.add("N/A");
								AppLogger.getLogger().fatal(e.getMessage(), e);
							}
							if (!isSummaryForReport) {
								colValues.add("<a href='" + constructOutLink(node, host)
										+ "' target=\"_blank\">stdout/stderr</a><br><a href='"
										+ constructLogLink(node, host) + "' target=\"_blank\">full log file</a>");
							}
							colValues.add(node.getStatus());
							colValues.add(node.isMonitor() ? QueryIOConstants.STATUS_STARTED
									: QueryIOConstants.STATUS_STOPPED);
							// disk status goes here
							try {

								colValues.add(diskMonitoredData != null
										? processHealthStatus(diskMonitoredData.getDiskHealthStatus()) : "N/A");
							} catch (Exception e) {
								colValues.add("N/A");
								AppLogger.getLogger().fatal(e.getMessage(), e);
							}
							...
							colValues.add(""); // Volumes in their respective
												// rows
							...
							for (int j = 0; j < fullVolumeInfoList.size(); j++) {
								...
								// MAC does not provide status of invisual
								// disks.
								if (QueryIOAgentManager.isMacOS(host)) {
									...
									colValues.add(getFormattedRate(diskMonitoredData != null
											? diskMonitoredData.getDiskByteReadsPerSec() : 0)); // Disk
									colValues.add(getFormattedRate(diskMonitoredData != null
											? diskMonitoredData.getDiskByteWritesPerSec() : 0));
						...
						AppLogger.getLogger()
								.fatal("getAllDataNodesSummaryTable failed with exception: " + e.getMessage(), e);
					}
				}
				try {
					DatabaseFunctions.closeSQLObjects(stmt, rs);
	...
	public static ArrayList getSystemAttributes(final Connection connection, String query) throws Exception {
		...
		try {
			...
			while (rs.next()) {
				monitorAttributes.add(new SystemAttribute(
						rs.getString(ColumnConstants.COL_SYSTEM_ATTRIBUTES_ATTRIBUTENAME).toUpperCase(),
	...
	public static ArrayList getLiveAttributes(final Connection connection, String query) throws Exception {
		...
		try {
			...
			while (rs.next()) {
				liveAttributes.add(
						new LiveAttribute(rs.getString(ColumnConstants.COL_LIVE_ATTRIBUTES_ATTRIBUTENAME).toUpperCase(),
	...
	public static void createTable(final Connection connection, String tableName, ArrayList columnNames,
			ArrayList columnTypes) throws Exception {
		Statement stmt = null;
	...
	public static void deleteNameNodeMonitorTable(final Connection connection, String nodeId) throws SQLException {
		...
		try {
			stmt = DatabaseFunctions.getStatement(connection);
			DatabaseFunctions.executeStatement(stmt, QueryConstants.QRY_DROP_TABLE
					+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId + "_NAMENODE_MONITORDATA");
			DatabaseFunctions.executeStatement(stmt, QueryConstants.QRY_DROP_TABLE
					+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId + "_NAMENODE_CONSOLIDATEDDATA");
		} finally {
			DatabaseFunctions.closeStatement(stmt);
		}
	}
	...
	public static void deleteDataNodeMonitorTable(final Connection connection, String nodeId) throws SQLException {
		...
		try {
			stmt = DatabaseFunctions.getStatement(connection);
			DatabaseFunctions.executeStatement(stmt, QueryConstants.QRY_DROP_TABLE
					+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId + "_DATANODE_MONITORDATA");
			DatabaseFunctions.executeStatement(stmt, QueryConstants.QRY_DROP_TABLE
					+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId + "_DATANODE_CONSOLIDATEDDATA");
		} finally {
			DatabaseFunctions.closeStatement(stmt);
		}
	}
	...
	public static void deleteHostMonitorTable(final Connection connection, int hostId) throws SQLException {
		...
		try {
			stmt = DatabaseFunctions.getStatement(connection);
			DatabaseFunctions.executeStatement(stmt, QueryConstants.QRY_DROP_TABLE
					+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + hostId + "_HOST_MONITORDATA");
			DatabaseFunctions.executeStatement(stmt, QueryConstants.QRY_DROP_TABLE
					+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + hostId + "_HOST_CONSOLIDATEDDATA");
		} finally {
			DatabaseFunctions.closeStatement(stmt);
		}
	}
	...
	public static void deleteResourceManagerMonitorTable(final Connection connection, String id) throws SQLException {
		...
		try {
			stmt = DatabaseFunctions.getStatement(connection);
			DatabaseFunctions.executeStatement(stmt, QueryConstants.QRY_DROP_TABLE
					+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + id + "_RESOURCEMANAGER_MONITORDATA");
			DatabaseFunctions.executeStatement(stmt, QueryConstants.QRY_DROP_TABLE
					+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + id + "_RESOURCEMANAGER_CONSOLIDATEDDATA");
		} finally {
			DatabaseFunctions.closeStatement(stmt);
		}
	}

	public static void deleteResourceManagerSummaryTable(final Connection connection, String nodeId)
			throws SQLException {
		Statement stmt = null;
		try {
			stmt = DatabaseFunctions.getStatement(connection);
			DatabaseFunctions.executeStatement(stmt, QueryConstants.QRY_DROP_TABLE
					+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId + "_RESOURCEMANAGER_SUMMARYDATA");
		} finally {
			DatabaseFunctions.closeStatement(stmt);
		}
	}
	...
	public static void deleteNodeManagerMonitorTable(final Connection connection, String id) throws SQLException {
		...
		try {
			stmt = DatabaseFunctions.getStatement(connection);
			DatabaseFunctions.executeStatement(stmt, QueryConstants.QRY_DROP_TABLE
					+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + id + "_NODEMANAGER_MONITORDATA");
			DatabaseFunctions.executeStatement(stmt, QueryConstants.QRY_DROP_TABLE
					+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + id + "_NODEMANAGER_CONSOLIDATEDDATA");
		} finally {
			DatabaseFunctions.closeStatement(stmt);
		}
	}
	...
	public static void deleteNodeManagerSummaryTable(final Connection connection, String nodeId) throws SQLException {
		...
		try {
			stmt = DatabaseFunctions.getStatement(connection);
			DatabaseFunctions.executeStatement(stmt, QueryConstants.QRY_DROP_TABLE
					+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId + "_NODEMANAGER_SUMMARYDATA");
		} finally {
			DatabaseFunctions.closeStatement(stmt);
		}
	}
	...
	public static void deleteNameNodeSummaryTable(final Connection connection, String nodeId) throws SQLException {
		...
		try {
			stmt = DatabaseFunctions.getStatement(connection);
			DatabaseFunctions.executeStatement(stmt, QueryConstants.QRY_DROP_TABLE
					+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId + "_NAMENODE_SUMMARYDATA");
		} finally {
			DatabaseFunctions.closeStatement(stmt);
		}
	}
	...
	public static void deleteHostSummaryTable(final Connection connection, int hostId) throws SQLException {
		...
		try {
			stmt = DatabaseFunctions.getStatement(connection);
			DatabaseFunctions.executeStatement(stmt, QueryConstants.QRY_DROP_TABLE
					+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + hostId + "_HOST_SUMMARYDATA");
		} finally {
			DatabaseFunctions.closeStatement(stmt);
		}
	}
	...
	public static void createHostMonitorTable(final Connection connection, int hostId, ArrayList columnNames,
			ArrayList columnTypes) throws Exception {
	...
	public static void createNameNodeMonitorTable(final Connection connection, String nodeId, ArrayList columnNames,
			ArrayList columnTypes) throws Exception {
	...
	public static void createDataNodeMonitorTable(final Connection connection, String nodeId, ArrayList columnNames,
			ArrayList columnTypes) throws Exception {
	...
	public static void createNodeManagerMonitorTable(final Connection connection, String nodeId, ArrayList columnNames,
			ArrayList columnTypes) throws Exception {
	...
	public static void createResourceManagerMonitorTable(final Connection connection, String nodeId,
			ArrayList columnNames, ArrayList columnTypes) throws Exception {
	...
	public static void createHostSummaryTable(final Connection connection, int hostId, ArrayList columnNames,
			ArrayList columnTypes) throws Exception {
	...
	public static void createNameNodeSummaryTable(final Connection connection, String nodeId, ArrayList columnNames,
			ArrayList columnTypes) throws Exception {
	...
	public static void createDataNodeSummaryTable(final Connection connection, String nodeId, ArrayList columnNames,
			ArrayList columnTypes) throws Exception {
	...
	public static void createResourceManagerSummaryTable(final Connection connection, String nodeId,
			ArrayList columnNames, ArrayList columnTypes) throws Exception {
	...
	public static void createNodeManagerSummaryTable(final Connection connection, String nodeId, ArrayList columnNames,
			ArrayList columnTypes) throws Exception {
	...
	public static void insertNameNodeMonitorData(final Connection connection, String nodeId, ArrayList columnValues)
			throws Exception {
		final Statement stmt = DatabaseFunctions.getStatement(connection);
		final ResultSet rs = CoreDBManager.getQueryResultsForStatement(stmt,
				"SELECT * FROM " + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId + "_NAMENODE_MONITORDATA");
	...
	public static void updateSummaryData(final Connection connection, String queryInsert, ArrayList columnNames,
			ArrayList columnValues) throws SQLException {
		if (columnNames != null && columnNames.size() > 0) {
			...
			try {
				...
				try {
					...
					AppLogger.getLogger().fatal("Prepared statement could not be closed, Exception: " + e.getMessage(),
							e);
				}
			}
		}
	...
	public static void insertMonitorData(final Connection connection, String queryInsert, ArrayList columnNames,
			ArrayList columnValues) throws SQLException {
		StringBuffer sBuf = new StringBuffer();
		sBuf.append(queryInsert);
		sBuf.append("(");
	...
	public static void insertNameNodeMonitorData(final Connection connection, String nodeId, ArrayList columnNames,
			ArrayList columnValues) throws Exception {
		String queryInsert = "INSERT INTO " + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId
				+ "_NAMENODE_MONITORDATA ";

		insertMonitorData(connection, queryInsert, columnNames, columnValues);
	}

	public static void insertDataNodeMonitorData(final Connection connection, String nodeId, ArrayList columnNames,
			ArrayList columnValues) throws Exception {
		String queryInsert = "INSERT INTO " + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId
				+ "_DATANODE_MONITORDATA ";

		insertMonitorData(connection, queryInsert, columnNames, columnValues);
	}

	public static void insertHostMonitorData(final Connection connection, int hostId, ArrayList columnNames,
			ArrayList columnValues) throws Exception {
	...
	public static void insertResourceManagerMonitorData(final Connection connection, String nodeId,
			ArrayList columnNames, ArrayList columnValues) throws Exception {
		String queryInsert = "INSERT INTO " + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId
				+ "_RESOURCEMANAGER_MONITORDATA ";

		insertMonitorData(connection, queryInsert, columnNames, columnValues);
	}

	public static void insertNodeManagerMonitorData(final Connection connection, String nodeId, ArrayList columnNames,
			ArrayList columnValues) throws Exception {
		String queryInsert = "INSERT INTO " + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId
				+ "_NODEMANAGER_MONITORDATA ";

		insertMonitorData(connection, queryInsert, columnNames, columnValues);
	}

	public static void updateNameNodeSummaryData(final Connection connection, String nodeId, ArrayList columnNames,
			ArrayList columnValues) throws Exception {
		String queryInsert = "UPDATE " + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId
				+ "_NAMENODE_SUMMARYDATA SET ";

		updateSummaryData(connection, queryInsert, columnNames, columnValues);
	}

	public static void updateDataNodeSummaryData(final Connection connection, String nodeId, ArrayList columnNames,
			ArrayList columnValues) throws Exception {
		String queryInsert = "UPDATE " + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId
				+ "_DATANODE_SUMMARYDATA SET ";

		updateSummaryData(connection, queryInsert, columnNames, columnValues);
	}

	public static void updateHostSummaryData(final Connection connection, int hostId, ArrayList columnNames,
			ArrayList columnValues) throws Exception {
	...
	public static void updateNodeManagerSummaryData(final Connection connection, String nodeId, ArrayList columnNames,
			ArrayList columnValues) throws Exception {
		String queryInsert = "UPDATE " + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId
				+ "_NODEMANAGER_SUMMARYDATA SET ";

		updateSummaryData(connection, queryInsert, columnNames, columnValues);
	}

	public static void updateResourceManagerSummaryData(final Connection connection, String nodeId,
			ArrayList columnNames, ArrayList columnValues) throws Exception {
		String queryInsert = "UPDATE " + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId
				+ "_RESOURCEMANAGER_SUMMARYDATA SET ";

		updateSummaryData(connection, queryInsert, columnNames, columnValues);
	}

	public static ArrayList getLiveControllerAttributes(final Connection connection, String queryLiveAttributes)
			throws Exception {
		...
		while (rs.next()) {
			...
			controllerAttribute.setName(rs.getString(ColumnConstants.COL_SYSTEM_ATTRIBUTES_OBJECTNAME)
					+ QueryIOConstants.ATTRIBUTE_OBJECT_SEPERATOR
					+ rs.getString(ColumnConstants.COL_SYSTEM_ATTRIBUTES_ATTRIBUTENAME));
	...
	public static long calculateStartTime(final String interval, long endTime) {
		...
		if (interval.equals(QueryIOConstants.INTERVAL_ONE_HOUR)) {
			...
			if (interval.equals(QueryIOConstants.INTERVAL_ONE_DAY))
				...
				if (AppLogger.getLogger().isDebugEnabled())
					AppLogger.getLogger().debug("Unknown interval received: " + interval);
			}
		}
	...
	public static ArrayList getNameNodeReadWrites(Connection connection, String nodeId) throws Exception {
		...
		filesRead = getNameNodeCurrentValueForColumn(connection, nodeId,
				ColumnConstants.COL_NN_SUMMARYDATA_TOTALFILESREAD);
		filesWritten = getNameNodeCurrentValueForColumn(connection, nodeId,
				ColumnConstants.COL_NN_SUMMARYDATA_TOTALFILESWRITE);
	...
	public static ArrayList getNameNodeReadWrites(Connection connection, String nodeId, String interval)
			throws Exception {
		// long[] vals = getNameNodeSummaryIntervalData(connection, nodeId,
		// interval);
		//
		// ArrayList list = new ArrayList();
		// list.add(vals[0]);
	...
	public static ArrayList getDataNodeReadWrites(Connection connection, String nodeId) {
		...
		try {
			...
			try {
				...
				AppLogger.getLogger().fatal("File Read/Write information could not be retrieved for nodeId: " + nodeId,
						e);
			}
		} finally {
			try {
	...
	public static ControllerAttribute getHistoricalControllerAttribute(Connection connection, String nodeId,
			String attributeName) throws Exception {
		ControllerAttribute ca = null;
		ArrayList list = null;

		if (nodeId.startsWith(QueryIOConstants.HOST_RULES_PREFIX)) {
			list = getHostControllerHistoricalAttributes(
					connection, HostDAO
							.getHostDetail(connection,
									nodeId.replace(QueryIOConstants.HOST_RULES_PREFIX, QueryIOConstants.EMPTY_STRING))
							.getId());
		} else {
			Node node = NodeDAO.getNode(connection, nodeId);
	...
	public static ControllerAttribute getNameNodeHistoricalControllerAttribute(Connection connection, String nodeId,
			String attributeName) throws Exception {
		ControllerAttribute ca = null;
	...
	public static ControllerAttribute getDataNodeHistoricalControllerAttribute(Connection connection, String nodeId,
			String attributeName) throws Exception {
		ControllerAttribute ca = null;
	...
	public static ControllerAttribute getNameNodeLiveControllerAttribute(Connection connection, String attributeName)
			throws Exception {
		ControllerAttribute ca = null;
	...
	public static ControllerAttribute getDataNodeLiveControllerAttribute(Connection connection, String attributeName)
			throws Exception {
		ControllerAttribute ca = null;
	...
	public static ControllerData getControllerData(Connection connection, String nodeId, long dataTimeStamp)
			throws Exception {
		...
		if (node != null) {
			...
			try {
				...
				String query = QueryConstants.QRY_SELECT_ALL_FROM + QueryIOConstants.MONITORDATA_TABLE_PREFIX
						+ node.getId();
				if (node.getNodeType().equals(QueryIOConstants.NAMENODE))
				...
				AppLogger.getLogger()
						.debug("getControllerData QUeryIO : " + query + " : " + nodeId + " : " + dataTimeStamp);
	...
	public static HashMap getDataNodeStorageReportSummary(final Connection connection, String nodeId, int hostId)
			throws Exception {
		NumberFormat nf = NumberFormat.getInstance();
		nf.setMaximumFractionDigits(2);
	...
	public static long getDataNodeAvgDiskBytesWritePerSecForOneYear(final Connection connection, int hostId)
			throws Exception {
		StringBuffer intervalCondition = new StringBuffer();
		...
		String query = "SELECT AVG(" + ColumnConstants.COL_DSK_BYTESWRITEPERSEC + ") FROM "
				+ QueryIOConstants.MONITORDATA_TABLE_PREFIX + hostId + intervalCondition.toString();
		...
		try {
			...
			if (rs.next()) {
				try {
					avgBytesWritePerSec = rs.getLong(1);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}
			}
	...
	public static TableModel getStorageForecastTableModel(final Connection connection) throws Exception {
		String[] colNames = new String[] { "Device Name", "Total Capacity", "Used Capacity", "Used % ", "Rate",
				"Eighty Percent", "Ninety Percent", "One Hundred Percent", "Free Capacity", "% Free Capacity" };
		...
		for (int i = 0; i < nodeList.size(); i++) {
			...
			if (percentUsed >= 100) {
				...
				if (avgBytesWrittenPerSec == 0)
					...
					seconds = (long) (freeCapacity * 1024 * 1024 * 1024 / avgBytesWrittenPerSec);
					oneHundredPercent = sdf
							.format(new Timestamp(System.currentTimeMillis() + seconds * 1000).getTime());
				}
			}
	...
	public static long getNameNodeTotalValueForColumn(final Connection connection, String nodeId, String columnName)
			throws Exception {
	...
	public static long getNameNodeCurrentValueForColumn(final Connection connection, String nodeId, String columnName)
			throws Exception {
		String query = "SELECT " + columnName + " FROM " + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId
				+ "_NAMENODE_SUMMARYDATA";

		return getMonitorDataTotalValueForColumn(connection, query);
	}

	public static long getDataNodeCurrentValueForColumn(final Connection connection, String nodeId, String columnName)
			throws Exception {
		String query = "SELECT " + columnName + " FROM " + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId
				+ "_DATANODE_SUMMARYDATA";
	...
	public static long getNameNodeLatestValueForColumn(final Connection connection, String nodeId, String columnName)
			throws Exception {
		String query = "SELECT SUM(" + columnName + ") FROM " + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId;
	...
	public static long getDataNodeTotalValueForColumn(final Connection connection, String nodeId, String columnName)
			throws Exception {
		String query = "SELECT SUM(" + columnName + ") FROM " + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId;
	...
	public static long getDataNodeLatestValueForColumn(final Connection connection, String nodeId, String columnName)
			throws Exception {
		String query = "SELECT SUM(" + columnName + ") FROM " + QueryIOConstants.MONITORDATA_TABLE_PREFIX + nodeId;
	...
	public static SummaryTable getAllResourceManagersSummaryTable(Connection connection, String liveAttributesTableName,
			ArrayList namenodes, boolean isSummaryForReport) throws Exception {
		NumberFormat nf = NumberFormat.getInstance();
		nf.setMaximumFractionDigits(2);
		...
		try {
			...
			for (int i = 0; i < namenodes.size(); i++) {
				...
				if (rs.next() || hostDataRS.next()) {
					try {
						colValues.add(rs.getObject(ColumnConstants.COL_RESOURCE_MANAGER_APPSSUBMITTED));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
					...
					try {
						colValues.add(rs.getObject(ColumnConstants.COL_RESOURCE_MANAGER_APPSPENDING));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
					...
					try {
						colValues.add(rs.getObject(ColumnConstants.COL_RESOURCE_MANAGER_APPSCOMPLETED));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
					...
					try {
						colValues.add(rs.getObject(ColumnConstants.COL_RESOURCE_MANAGER_CONTAINERSRUNNING));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
					...
					try {
						colValues.add(
								getFormattedStorageSize(rs.getFloat(ColumnConstants.COL_RESOURCE_MANAGER_ALLOCATEDMB)
										* QueryIOConstants.ONE_MB));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					...
					try {
						colValues.add(
								getFormattedStorageSize(rs.getFloat(ColumnConstants.COL_RESOURCE_MANAGER_AVAILABLEMB)
										* QueryIOConstants.ONE_MB));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					...
					try {
						colValues.add(getFormattedStorageSize(
								rs.getFloat(ColumnConstants.COL_RESOURCE_MANAGER_PENDINGMB) * QueryIOConstants.ONE_MB));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
					...
					try {
						colValues.add(
								getFormattedStorageSize(rs.getFloat(ColumnConstants.COL_RESOURCE_MANAGER_RESERVEDMB)
										* QueryIOConstants.ONE_MB));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					...
					try {
						colValues.add(rs.getObject(ColumnConstants.COL_RESOURCE_MANAGER_NUMACTIVENMS));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
					...
					try {
						colValues.add(rs.getObject(ColumnConstants.COL_RESOURCE_MANAGER_NUMDECOMMISSIONEDNMS));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
					...
					try {
						colValues.add(rs.getObject(ColumnConstants.COL_RESOURCE_MANAGER_NUMLOSTNMS));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
					...
					try {
						colValues.add(rs.getObject(ColumnConstants.COL_RESOURCE_MANAGER_NUMUNHEALTHYNMS));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
					...
					try {
						colValues.add(rs.getObject(ColumnConstants.COL_RESOURCE_MANAGER_NUMREBOOTEDNMS));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
	...
	public static SummaryTable getAllNodeManagersSummaryTable(Connection connection, String liveAttributesTableName,
			ArrayList namenodes, boolean isSummaryForReport) throws Exception {
		NumberFormat nf = NumberFormat.getInstance();
		nf.setMaximumFractionDigits(2);
		...
		try {
			...
			for (int i = 0; i < namenodes.size(); i++) {
				...
				if (rs.next() || hostDataRS.next()) {
					try {
						colValues.add(rs.getObject(ColumnConstants.COL_NODE_MANAGER_CONTAINERSLAUNCHED));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
					...
					try {
						colValues.add(rs.getObject(ColumnConstants.COL_NODE_MANAGER_CONTAINERSCOMPLETED));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
					...
					try {
						colValues.add(rs.getObject(ColumnConstants.COL_NODE_MANAGER_CONTAINERSFAILED));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
					...
					try {
						colValues.add(rs.getObject(ColumnConstants.COL_NODE_MANAGER_CONTAINERSKILLED));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
					...
					try {
						colValues.add(rs.getObject(ColumnConstants.COL_NODE_MANAGER_CONTAINERSRUNNING));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
					...
					try {
						colValues.add(rs.getObject(ColumnConstants.COL_NODE_MANAGER_CONTAINERSINITING));
					} catch (Exception e) {
						colValues.add("N/A");
						AppLogger.getLogger().fatal(e.getMessage(), e);
					}
	...
	public static ArrayList getAllResourceManagerAppDetails(Connection connection, ArrayList rmIDs) {
		...
		try {
			for (Object nodeID : rmIDs) {
				stmt = DatabaseFunctions.getStatement(connection);
				AppLogger.getLogger().fatal(
						QueryIOConstants.MONITORDATA_TABLE_PREFIX + (String) nodeID + "_RESOURCEMANAGER_SUMMARYDATA");

				String query = QueryConstants.QRY_GET_RM_APPS_DETAIL + QueryIOConstants.MONITORDATA_TABLE_PREFIX
						+ (String) nodeID + "_RESOURCEMANAGER_SUMMARYDATA";
				rs = DatabaseFunctions.getQueryResultsForStatement(stmt, query);

				while (rs.next()) {
					// appsSubmitted +=
					// rs.getInt(ColumnConstants.COL_RESOURCE_MANAGER_APPSSUBMITTED);
				...
				try {
					...
					AppLogger.getLogger()
							.fatal("getAllResourceManagerAppDetails() caught Exception, Reason: " + e.getMessage(), e);
				} finally {
					stmt = null;
					rs = null;
				}
			...
			AppLogger.getLogger().fatal("getAllResourceManagerAppDetails() caught Exception, Reason: " + e.getMessage(),
					e);
		} finally {
			try {
				DatabaseFunctions.closeSQLObjects(stmt, rs);
	...
	public static ArrayList getAllNodeManagerAppDetails(Connection connection, ArrayList rmIDs) {
		...
		try {
			for (Object nodeID : rmIDs) {
				stmt = DatabaseFunctions.getStatement(connection);
				AppLogger.getLogger().fatal(
						QueryIOConstants.MONITORDATA_TABLE_PREFIX + (String) nodeID + "_NODEMANAGER_SUMMARYDATA");

				String query = QueryConstants.QRY_GET_NM_CONTAINER_DETAIL + QueryIOConstants.MONITORDATA_TABLE_PREFIX
						+ (String) nodeID + "_NODEMANAGER_SUMMARYDATA";
				rs = DatabaseFunctions.getQueryResultsForStatement(stmt, query);
				...
				try {
					...
					AppLogger.getLogger()
							.fatal("getAllNodeManagerAppDetails() caught Exception, Reason: " + e.getMessage(), e);
				} finally {
					stmt = null;
					rs = null;
				}
			...
			try {
				...
				AppLogger.getLogger().fatal("getAllNodeManagerAppDetails() caught Exception, Reason: " + e.getMessage(),
						e);
			}
		}
		return appData;
	...
	public static SummaryTable getNameNodeSummaryDataBasedOnList(Connection connection, ArrayList namenodes)
			throws Exception {
		NumberFormat nf = NumberFormat.getInstance();
		nf.setMaximumFractionDigits(2);
	...
	public static ArrayList getNameNodeSummaryDataBasedOnNNList(final Connection connection, ArrayList namenodes)
			throws Exception {
		NumberFormat nf = NumberFormat.getInstance();
		nf.setMaximumFractionDigits(2);
		...
		try {
			for (int var = 0; var < namenodes.size(); var++) {
				...
				try {
					totalListFileOps += getNameNodeCurrentValueForColumn(connection, namenode.getId(),
							ColumnConstants.COL_NN_MONITORDATA_LISTOPS);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}
				...
				try {
					totalDeleteFileOps += getNameNodeCurrentValueForColumn(connection, namenode.getId(),
							ColumnConstants.COL_NN_MONITORDATA_DELETEFILEOPS);
				} catch (Exception e) {
					AppLogger.getLogger().fatal(e.getMessage(), e);
				}
			}
	...
	public static ArrayList getNameNodeReadWritesBasedOnNNList(Connection connection, ArrayList namenodes)
			throws Exception {
		long fileReads = 0;
		long fileWrites = 0;
