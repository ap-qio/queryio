...
public class VolumeDAO {
	...
	public static String getDisk(Connection connection, String nodeId, String path) throws Exception {
		...
		for (int j = 0; j < list.size(); j++) {
			...
			// volPath = vol.getPath().replace("\\", "").replace("/", "");
			// //TODO: Don't know why this was added.
	...
	public static void addVolume(Connection connection, String nodeId, String diskName, String volumePath)
			throws SQLException {
		PreparedStatement pst = null;
		try {
