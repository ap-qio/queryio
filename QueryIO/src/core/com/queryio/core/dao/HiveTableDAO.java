...
public class HiveTableDAO {
	public static void insertHiveTable(Connection connection, String tableName, String nameNodeId, String rmId,
	...
	public static boolean doesHiveTableExist(Connection connection, String tableName, String nameNodeId)
			throws Exception {
		return doesHiveTableEntryQIOSchema(connection, tableName, nameNodeId);
	}

	public static boolean doesHiveTableEntryQIOSchema(Connection connection, String tableName, String nameNodeId)
			throws Exception {
		PreparedStatement ps = null;
		ResultSet rs = null;
		boolean flag = false;
	...
	public static boolean doesHiveTableEntryHiveSchema(Connection connection, String tableName, String nameNodeId)
			throws Exception {
		PreparedStatement ps = null;
		ResultSet rs = null;
		boolean flag = false;
	...
	public static String getResourceManager(Connection connection, String tableName, String nameNodeId)
			throws Exception {
		PreparedStatement ps = null;
		ResultSet rs = null;
		String rmid = null;
	...
	public static String getFileType(Connection connection, String tableName, String nameNodeId) throws Exception {
		...
		try {
			ps = DatabaseFunctions.getPreparedStatement(connection,
					QueryConstants.PREPARED_QRY_HIVETABLES_GET_FILE_TYPE);
	...
	public static String getFileName(Connection connection, String tableName, String nameNodeId) throws Exception {
		...
		try {
			ps = DatabaseFunctions.getPreparedStatement(connection,
					QueryConstants.PREPARED_QRY_HIVETABLES_GET_FILE_NAME);
