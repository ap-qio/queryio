...
public class SnapshotDAO {
	public static void addSnapshot(final Connection connection, String id, String namenodeHost, String location)
			throws Exception {
	...
	public static boolean doesSnapshotExist(Connection connection, String id) throws Exception {
		...
		try {
			ps = DatabaseFunctions.getPreparedStatement(connection,
					QueryConstants.PREPARED_QRY_SELECT_SNAPSHOT_WHERE_ID);
			ps.setString(1, id);
