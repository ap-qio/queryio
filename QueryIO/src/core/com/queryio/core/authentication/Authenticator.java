...
//		
//		if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("Authenticating with kerberos");
//		if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("Username: " + username);
//		if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("Password: " + password);
//		
...
//			success = true;
//			
//			if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("Authentication successful");
//		} else {
//			if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("Authentication failed");
//		}
//	
//		return success;
//	}
