...
public class ResourceManagerStatus extends AbstractExportableNode {
	...
	public ResourceManagerStatus(String exportedFileName, Timestamp startTimestamp, Timestamp endTimestamp,
			String title) {
		super("ResourceManager Status Report", 0, "ResourceManager Status Report", exportedFileName,
				"ResourceManager Status Report");
