	...
	public IExportableItem[] getItems() {
		...
		IExportableItem[] items = new IExportableItem[] {
				...
				new Group(0, 0, 100, 50, "",
						new IExportableItem[] { new Chart(50, 0, 24, 30, getPieChart(QueryIOConstants.NODEMANAGER)),
								new Table(75, 0, 24, 30, getStatusSummaryTableModel(QueryIOConstants.NODEMANAGER),
										new int[] { 50 }, null),
								new Chart(0, 0, 24, 30, getPieChart(QueryIOConstants.RESOURCEMANAGER)),
								new Table(25, 0, 24, 30, getStatusSummaryTableModel(QueryIOConstants.RESOURCEMANAGER),
										new int[] { 50 }, null) }),
