...
public class DatanodeInfo extends AbstractExportableNode{
	...
	public DatanodeInfo(String exportedFileName, Timestamp startTimestamp,Timestamp endTimestamp,  Host host, Node node, String title) {
		
		super("Datanode Info Report Id: " + node.getId() + " Host: " + host.getHostIP(), 0, "Datanode Info Report Id: " + node.getId() + " Host: " + host.getHostIP(), exportedFileName, "Datanode Info Report Id: " + node.getId() + " Host: " + host.getHostIP());
	...
	public IExportableItem[] getItems() {
		ArrayList chartDataList = ChartManager.getDataNodeChartDataBetweenTime(node.getId(), startTimestamp, endTimestamp);
		...
		items[3] = new Label(0, 0, 100, 20," Start Time: "+ sdf.format(startTimestamp.getTime())+"  End Time: "+ sdf.format(endTimestamp.getTime()));
		items[4] = new Label(0, 0, 100, 20," ");
		items[5] = new Group(0, 0, 100, 50, "", new IExportableItem[]
					{
						new Chart(0, 0, 49, 45, getPieChart()),
