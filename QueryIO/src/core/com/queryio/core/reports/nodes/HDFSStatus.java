		...
		IExportableItem[] items = new IExportableItem[]
			{
				...
				new Group(0, 0, 100, 50, "", new IExportableItem[]
					{
						new Chart(50, 0, 24, 30, getPieChart(QueryIOConstants.DATANODE)),
						new Table(75, 0, 24, 30, getStatusSummaryTableModel(QueryIOConstants.DATANODE), new int[] { 50 }, null),
						new Chart(0, 0, 24, 30, getPieChart(QueryIOConstants.NAMENODE)),
						new Table(25, 0, 24, 30, getStatusSummaryTableModel(QueryIOConstants.NAMENODE), new int[] { 50 }, null)
					}),
