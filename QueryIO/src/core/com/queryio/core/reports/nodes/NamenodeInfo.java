...
public class NamenodeInfo extends AbstractExportableNode{
	...
	public NamenodeInfo(String exportedFileName, Timestamp startTimestamp, Timestamp endTimestamp, Host host, Node node, String title) {
		super("Namenode Info Report Id: " + node.getId() + " Host: " + host.getHostIP(), 0, "Namenode Info Report Id: " + node.getId() + " Host: " + host.getHostIP(), exportedFileName, "Namenode Info Report Id: " + node.getId() + " Host: " + host.getHostIP());
	...
	public IExportableItem[] getItems() {
		ArrayList chartDataList = ChartManager.getNameNodeChartDataBetweenTime(node.getId(), startTimestamp, endTimestamp);
