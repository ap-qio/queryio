...
public class SummaryManager 
{
	...
	public static ArrayList getNameNodeReadWritesIntervalBased(String nodeId, String interval)
	{
		...
		{
			AppLogger.getLogger().fatal("getNameNodeReadWritesIntervalBased() failed with exception: " + e.getMessage(), e);
		}
		finally
		{
			try
	...
	public static ArrayList getAllDataNodeMemoryInfoForRack(String rackId)
	{
		...
		{
			AppLogger.getLogger().fatal("getAllDataNodeMemoryInfoForRack() failed with exception: " + e.getMessage(), e);
		}
		finally
		{
			try
	...
	public static ArrayList getAllDataNodeMemoryInfoForHost(String hostIP)
	{
		...
		try
		{
			...
			return MonitorDAO.getAllDataNodeMemoryInfo(connection,NodeDAO.getAllDataNodesForHost(connection, host.getId()));
		}
		catch (Exception e)
		{
			AppLogger.getLogger().fatal("getAllDataNodeMemoryInfoForHost() failed with exception: " + e.getMessage(), e);
		}
		finally
		{
			try
...
//			connection = CoreDBManager.getQueryIODBConnection();
//			
//			return MonitorDAO.getClusterSummaryData(connection, TableConstants.TABLE_NAMENODE_LIVE_ATTRIBUTES, NodeDAO.getAllNameNodes(connection));
//		}
//		catch (Exception e)
//		{
//			AppLogger.getLogger().fatal("getClusterSummary() failed with exception: " + e.getMessage(), e);
//		}
//		finally
//		{
//			try
...
//	
	public static SummaryTable getAllNameNodesSummaryTable(boolean isSummaryForReport)
	{
		...
		try
		{
			...
			return MonitorDAO.getAllNameNodesSummaryTable(connection, TableConstants.TABLE_NAMENODE_LIVE_ATTRIBUTES, NodeDAO.getAllNameNodes(connection),isSummaryForReport);
		}
		catch (Exception e)
		{
	...
	public static SummaryTable getAllDataNodesSummaryTable(boolean isSummaryForReport)
	{
		...
		try
		{
			...
			return MonitorDAO.getAllDataNodesSummaryTable(connection, TableConstants.TABLE_DATANODE_LIVE_ATTRIBUTES, NodeDAO.getAllDatanodes(connection),isSummaryForReport);
		}
		catch (Exception e)
		{
	...
	public static SummaryTable getAllDataNodesSummaryTableforRack(String rackid,boolean isSummaryForReport)
	{
		...
		try
		{
			connection = CoreDBManager.getQueryIODBConnection();
			ArrayList hostsForRack = HostDAO.getAllHostforRack(connection, rackid);
			if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("hostsForRack ID :"+hostsForRack.size());
			ArrayList dataNodeForHost = new ArrayList();
			
			for (Object object : hostsForRack) {
				int hostId = ((Host)object).getId();
				if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("Host ID :"+hostId);
				ArrayList nodes = NodeDAO.getAllDataNodesForHost(connection, hostId);
				
				for(Object node : nodes){
					if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("Node ID :"+((Node)node).getId());
					dataNodeForHost.add(node);
				}
			}
			
			return MonitorDAO.getAllDataNodesSummaryTable(connection, TableConstants.TABLE_DATANODE_LIVE_ATTRIBUTES, dataNodeForHost,isSummaryForReport);
		}
		catch (Exception e)
		{
			AppLogger.getLogger().fatal("getAllDataNodesSummaryTableforRack() failed with exception: " + e.getMessage(), e);
		}
		finally
		{
			try
	...
	public static SummaryTable getAllDataNodesSummaryTableforHost(String hostIP,boolean isSummaryForReport)
	{
		...
		{
			AppLogger.getLogger().fatal("getAllDataNodesSummaryTableforHost() failed with exception: " + e.getMessage(), e);
		}
		finally
		{
			try
	...
	public static ArrayList getAllDataNodeStatusSummaryforRack(String rackid)
	{
		...
		{
			AppLogger.getLogger().fatal("getAllDataNodeStatusSummaryforRack failed with exception: " + e.getMessage(), e);
		}
		finally
		{
			try
	...
	public static ArrayList getAllDataNodeStatusSummaryforHost(String hostIP)
	{
		...
		try
		{
			if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("HostId :"+hostIP);
			connection = CoreDBManager.getQueryIODBConnection();
			Host host =  HostDAO.getHostDetail(connection, hostIP);
			return MonitorDAO.getDataNodeSummaryData(connection,NodeDAO.getAllDataNodesForHost(connection, host.getId()));
		}
		catch (Exception e)
		{
			AppLogger.getLogger().fatal("getAllDataNodeStatusSummaryforHost failed with exception: " + e.getMessage(), e);
			return null;
		}
		finally
		{
	...
	public static TableModel getStorageForecastReportTableModel()
	{
		...
		{
			AppLogger.getLogger().fatal("getStorageForecastReportTableModel failed with exception: " + e.getMessage(), e);
			return null;
		}
		finally
		{
	...
	public static SummaryTable getAllResourceManagersSummaryTableForHost(String hostIP)
	{
		...
		try
		{
			...
			return MonitorDAO.getAllResourceManagersSummaryTable(connection, TableConstants.TABLE_RESOURCE_MANAGER_LIVE_ATTRIBUTES, resourceManagersForHost, false);
		}
		catch (Exception e)
		{
			AppLogger.getLogger().fatal("getAllResourceManagersSummaryTableForHost() failed with exception: " + e.getMessage(), e);
		}
		finally
		{
			try
	...
	public static SummaryTable getAllResourceManagersSummaryTable(boolean isSummaryForReport)
	{
		...
		try
		{
			...
			return MonitorDAO.getAllResourceManagersSummaryTable(connection, TableConstants.TABLE_RESOURCE_MANAGER_LIVE_ATTRIBUTES, resourceManagersForHost, isSummaryForReport);
		}
		catch (Exception e)
		{
			AppLogger.getLogger().fatal("getAllResourceManagersSummaryTableforHost() failed with exception: " + e.getMessage(), e);
	...
	public static SummaryTable getAllNodeManagersSummaryTableForHost(String hostIP)
	{
		...
		try
		{
			...
			return MonitorDAO.getAllNodeManagersSummaryTable(connection, TableConstants.TABLE_NODE_MANAGER_LIVE_ATTRIBUES, nodeManagersForHost, false);
		}
		catch (Exception e)
		{
			AppLogger.getLogger().fatal("getAllNodeManagersSummaryTableForHost() failed with exception: " + e.getMessage(), e);
		}
		finally
		{
			try
	...
	public static SummaryTable getAllNodeManagersSummaryTable(boolean isSummaryForReport)
	{
		...
		try
		{
			...
			return MonitorDAO.getAllNodeManagersSummaryTable(connection, TableConstants.TABLE_NODE_MANAGER_LIVE_ATTRIBUES, nodeManagersForHost, isSummaryForReport);
		}
		catch (Exception e)
		{
	...
	public static ArrayList getResourceManagerAppsDetailStatusSummary(){
		...
		{
			AppLogger.getLogger().fatal("getResourceManagerAppsDetailStatusSummary() failed with exception: " + e.getMessage(), e);
		}
	...
	public static ArrayList getResourceManagerAppsDetailStatusSummaryForId(String id){
		...
		{
			AppLogger.getLogger().fatal("getResourceManagerAppsDetailStatusSummaryForId() failed with exception: " + e.getMessage(), e);
		}
	...
	public static ArrayList getNodeManagerAppsDetailStatusSummary(){
		...
		{
			AppLogger.getLogger().fatal("getNodeManagerAppsDetailStatusSummary() failed with exception: " + e.getMessage(), e);
		}
	...
	public static ArrayList getNodeManagerAppsDetailStatusSummaryForId(String id){
		...
		{
			AppLogger.getLogger().fatal("getNodeManagerAppsDetailStatusSummaryForId() failed with exception: " + e.getMessage(), e);
		}
