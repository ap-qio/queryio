/*
 * @(#)  LesserEqualsOperatorExpression.java
 *
 ...
 */
public class LesserEqualsMinusOperatorExpression extends LogicalExpression
{
	private static final long serialVersionUID = 7526000057010002391L;

	/**
	 * @see java.lang.Object#Object()
	 */
	public LesserEqualsMinusOperatorExpression()
	{
		super();
	}

	/**
	 * Constructor for LesserEqualsOperatorExpression.
	 * 
	 * @param left
	 * @param right
	 */
	public LesserEqualsMinusOperatorExpression(final Expression left, final Expression right)
	{
		super(left, right);
	}
