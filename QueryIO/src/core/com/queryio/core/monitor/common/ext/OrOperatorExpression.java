 ...
 */
public class OrOperatorExpression extends LogicalExpression {
	private static final long serialVersionUID = 7526000057010002399L;
	 ...
	 * @param right
	 */
	public OrOperatorExpression(final Expression left, final Expression right) {
		super(left, right);
	}
