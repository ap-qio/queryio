/*
 * @(#)  GreaterEqualsOperatorExpression.java
 *
 ...
 */
public class GreaterEqualsMinusOperatorExpression extends LogicalExpression {
	private static final long serialVersionUID = 7526000057010002387L;

	/**
	 * @see java.lang.Object#Object()
	 */
	public GreaterEqualsMinusOperatorExpression() {
		super();
	}

	/**
	 * Constructor for GreaterEqualsOperatorExpression.
	 * 
	 * @param left
	 * @param right
	 */
	public GreaterEqualsMinusOperatorExpression(final Expression left, final Expression right) {
		super(left, right);
	}
