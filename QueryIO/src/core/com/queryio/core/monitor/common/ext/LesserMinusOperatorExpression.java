 ...
 */
public class LesserMinusOperatorExpression extends LogicalExpression {
	private static final long serialVersionUID = 7526000057010002393L;

	/**
	 * @see java.lang.Object#Object()
	 */
	public LesserMinusOperatorExpression() {
		super();
	}

	/**
	 * Constructor for LesserOperatorExpression.
	 * 
	 * @param left
	 * @param right
	 */
	public LesserMinusOperatorExpression(final Expression left, final Expression right) {
		super(left, right);
	}
