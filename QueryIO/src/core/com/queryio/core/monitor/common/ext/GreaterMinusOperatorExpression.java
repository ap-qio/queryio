/*
 * @(#)  GreaterOperatorExpression.java
 *
 ...
 */
public class GreaterMinusOperatorExpression extends LogicalExpression
{
	private static final long serialVersionUID = 7526000057010002389L;

	/**
	 * @see java.lang.Object#Object()
	 */
	public GreaterMinusOperatorExpression()
	{
		super();
	}

	/**
	 * Constructor for GreaterOperatorExpression.
	 * 
	 * @param left
	 * @param right
	 */
	public GreaterMinusOperatorExpression(final Expression left, final Expression right)
	{
		super(left, right);
	}
