 ...
 */
public class EqualsEqualsMinusOperatorExpression extends LogicalExpression {
	private static final long serialVersionUID = 7526000057010002385L;

	/**
	 * @see java.lang.Object#Object()
	 */
	public EqualsEqualsMinusOperatorExpression() {
		super();
	}

	/**
	 * Constructor for EqualsEqualsOperatorExpression.
	 * 
	 * @param left
	 * @param right
	 */
	public EqualsEqualsMinusOperatorExpression(final Expression left, final Expression right) {
		super(left, right);
	}
