...
/**
 * This class has the constants defined for the Notifier module.
 * 
 * @author Exceed Consultancy Services
 */
final class NotifierConstants {
	...
	static final String EVTNOTIF_XMLFILENAME = "notificationconfig.xml"; //$NON-NLS-1$
