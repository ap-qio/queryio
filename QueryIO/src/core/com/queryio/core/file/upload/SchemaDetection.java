...
public class SchemaDetection extends HttpServlet {
			...
			throws ServletException, IOException
	{
        ...
        try{
        	AppLogger.getLogger().debug("File upload request recevied from host: " + req.getRemoteAddr() + ", user: " + req.getRemoteUser());
...
//						AppLogger.getLogger().debug("Reading line: " + line);
//						AppLogger.getLogger().debug("Parser line: " + records);
