...
//	public static void performFailover(Connection connection,DWRResponse dwrResponse) throws Exception{	
//		
...
//					
//	}
//	public static void disableHA(Connection connection,DWRResponse dwrResponse) throws Exception{		
//		if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("Disabling HA mode .. ");
...
//				
//				dwrResponse.setDwrResponse(false,"It is required that the namenode for this cluster must be stopped." +
//						"The namenode on host "+namenodeHost.getHostIP()+" is still running..." , 500);				
//				return ;
//			}
//			List datanodeList = NodeDAO.getAllDatanodes(connection);
//			String failureMsg = "It is required that all the datanodes for this cluster must be stopped. The datanode(s): ";
//			boolean flag = false;
...
//			if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug(dwrResponse.getResponseMessage());
//			if(!dwrResponse.isTaskSuccess()){					
//				return;
//			}
//			
//			String[] response = QueryIOAgentManager.getConfig(namenodeHost, new String[]{"dfs.namenode.shared.edits.dir"}, namenode, "hdfs-site.xml");
//
//			if(response != null && response.length != 0){
//				String[] keys = new String[]{"dfs.ha.namenodes." + HiPerConstants.DEFAULT_CLUSTER_NAME, "dfs.namenode.shared.edits.dir", "dummy.dfs.namenode.shared.edits.dir"};
//				String[] values = new String[]{namenode.getId(), "", response[0]};			
//				
//				 QueryIOAgentManager.updateConfiguration(namenodeHost, namenode, keys, values, dwrResponse);
//				if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug(dwrResponse.isTaskSuccess() + ": " + dwrResponse.getResponseMessage());
//				if(!dwrResponse.isTaskSuccess()){					
//					return;
//				}				
//			}
...
//				String[] keys = new String[]{"dfs.ha.namenodes." + HiPerConstants.DEFAULT_CLUSTER_NAME};
//				String[] values = new String[]{namenode.getId()};			
//				
//				QueryIOAgentManager.updateConfiguration(datanodeHost, datanode, keys, values,dwrResponse);
//				
//				if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug(dwrResponse.isTaskSuccess()+" "+ dwrResponse.getResponseMessage());
//				if(!dwrResponse.isTaskSuccess()){					
//					return;
...
//		if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("HA Disabled");
//		dwrResponse.setDwrResponse(true,"Cluster is now configured as a non-HA Cluster." , 200);
//		
//	}
//	
//	public static void enableHA(Connection connection,DWRResponse dwrResponse) throws Exception{		
//		if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("Enabling HA mode .. ");
//		Node namenode = NodeDAO.getNamenode(connection);
...
//			}
//			
//			String[] response = QueryIOAgentManager.getConfig(namenodeHost, new String[]{"dummy.dfs.namenode.shared.edits.dir"}, namenode, "hdfs-site.xml");
//			if(response != null && response.length != 0 && response[0].length() != 0){
//				String[] keys = new String[]{"dfs.ha.namenodes." + HiPerConstants.DEFAULT_CLUSTER_NAME, "dfs.namenode.shared.edits.dir", "dummy.dfs.namenode.shared.edits.dir"};
//				String[] values = new String[]{standbyNode == null ? namenode.getId() : namenode.getId() + "," + standbyNode.getId(), response[0], ""};				
//				
//				 QueryIOAgentManager.updateConfiguration(namenodeHost, namenode, keys, values,dwrResponse);
//				if(!dwrResponse.isTaskSuccess()){
//					if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug(dwrResponse.getResponseMessage());
...
//				Host datanodeHost = HostDAO.getHostDetail(connection, datanode.getHostId());
//				String[] keys = new String[]{"dfs.ha.namenodes." + HiPerConstants.DEFAULT_CLUSTER_NAME};
//				String[] values = new String[]{standbyNode == null ? namenode.getId() : namenode.getId() + "," + standbyNode.getId()};			
//				
//				 QueryIOAgentManager.updateConfiguration(datanodeHost, datanode, keys, values,dwrResponse);
//				if(!dwrResponse.isTaskSuccess()){
//					if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug(dwrResponse.getResponseMessage());
...
//		if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("HA Enabled");
//		dwrResponse.setDwrResponse(true, "Cluster is now configured as a HA Cluster.", 200);
//		
//	}
//	
//	private static void updateHAEnabled(Connection connection, boolean b) throws Exception{
