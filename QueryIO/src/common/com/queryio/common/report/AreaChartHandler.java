...
public class AreaChartHandler {
	...
	public static  Chart getAreaChart(String title, int dimension, int chartWidth,
        ...
        while (it.hasNext())
        {
			...
			if (topColors != null && i < topColors.size()){
				ySeriesDef.getSeriesPalette().getEntries().add(ChartPreferenceHandler.hexToRGB( (String) topColors.get(i),100));
			}
