...
public class BubbleChartHandler {
	...
	public static  Chart getBubbleChart(String title, int dimension, int chartWidth,
			int chartHeight, JSONObject xSeriesObj, JSONObject ySeriesJSON,JSONObject ySeriesValues, JSONObject ySeriesSizeJSON,
			String xSeriesTitle, String ySeriesTitle, JSONObject chartPreferences,HashMap resultSetColumns, String dbName, boolean isHive, String yGrouping)
			throws Exception {
        ...
        else if(columnType.contains(props.getTypeMap().get(MetadataConstants.INTEGER_WRAPPER_CLASS)) || columnType.contains(props.getTypeMap().get(MetadataConstants.DECIMAL_WRAPPER_CLASS)))
        {
