...
public class XAxisTimeSeries extends XAxisLongSeries {
	...
	public String getFormattedMaxValue() {
		return TimeValueFormatter.getFormattedValue(this.minValue, this.maxValue, this.maxValue, this.bShowRelativeTime,
				this.crossesMidNight);
	}

	public String getFormattedMinValue() {
		return TimeValueFormatter.getFormattedValue(this.minValue, this.minValue, this.maxValue, this.bShowRelativeTime,
				this.crossesMidNight);
	}
	...
	public String getFormattedValue(final long startTime, final long currTime, final long endTime) {
		return TimeValueFormatter.getFormattedValue(startTime, currTime, endTime, this.bShowRelativeTime,
				this.crossesMidNight);
	}
