...
public class SWINGUserInterface implements UserInterface {
	...
	public void drawString(final String string, final int x, int y, final boolean isBackgroundTransparent) {
		...
		if (isBackgroundTransparent) {
			...
			this.graphics.setBackground(
					new java.awt.Color(oldBGColor.getRed(), oldBGColor.getGreen(), oldBGColor.getBlue(), 0));
	...
	public void setLineStyle(final LineAttributes lineAttr) {
		...
		BasicStroke bsNew = new BasicStroke(lineAttr.width, cap, join, bsOrig.getMiterLimit(), bsOrig.getDashArray(),
				bsOrig.getDashPhase());
