...
public class LineAttributes {
	/*
	 * IMPORTANT: Constant defined for CAP and JOIN have same values as SWT
	 * class So that we can use these constant directly with SWT code. We can
	 * not refer SWT constant in our code for backward compatibility issues
	 * 
	 */
	/**
