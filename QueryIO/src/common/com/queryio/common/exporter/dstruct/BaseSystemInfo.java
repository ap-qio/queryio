...
public abstract class BaseSystemInfo {
	...
	protected int iViewRefreshRate; // Tables and Graph Views' refresh rate in
									// seconds, has default value 1
	 ...
	 * 
	 * @param modified
	 *            indicating whether the project has been modified or not.
	 */
