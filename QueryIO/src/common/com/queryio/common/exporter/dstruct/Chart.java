...
public class Chart extends ExportableItem
{
			...
			throws ExporterException
	{
		...
		if (scrollableChart)
		{
			...
			if (scrollable)
			{
				final UserInterface scratchUserInterface = UIGraphicsFactory.getUserInterface(this.chart.getUserInterface().getUserInterfaceType());
		...
		{
			throw new ExporterException(RM.getString("ERR_WRITING_IMAGE_DATA") + file != null ? file.getAbsolutePath() : "", exception); //$NON-NLS-1$
		}
