...
public class ScheduleManager {
	public static boolean scheduleJob(String interval,String reportTime,ArrayList selectedFormat,String notificationType, String notificationMessage,
	...
	public static boolean scheduleJobWithoutNotification(String interval,String reportTime, ArrayList selectedFormat, ArrayList reportId, String nodeId, String schedName)
	{
		SchedulerBean schedule = null;
		try{
...
//					+notificationMessage+" userList "+userList+" reportId "+reportId+" schedule Name: "+schedName+"nodeId :"+nodeId);
	...
	public static boolean scheduleQueryJob(String interval,String reportTime,ArrayList selectedFormat,String notificationType, String notificationMessage,
			ArrayList userList, String schedName, ArrayList query, String nameNode){
//		if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("Report Time : "+reportTime+" SlectedFormat :"+selectedFormat+ " notification Type : "+notificationType
//				+" notification Message "+notificationMessage+" userList "+userList+" schedule Name: "+schedName+"query :"+query);
	...
	public static boolean scheduleQueryJobWithoutNotification(String interval,String reportTime,ArrayList selectedFormat, String schedName, ArrayList query, String nameNode){
//		if(AppLogger.getLogger().isDebugEnabled()) AppLogger.getLogger().debug("Report Time : "+reportTime+" SlectedFormat :"+selectedFormat+ " notification Type : "+notificationType
//				+" notification Message "+notificationMessage+" userList "+userList+" schedule Name: "+schedName+"query :"+query);
		QuerySchedulerBean queryScheduler = null;
		try{
	...
	public static DWRResponse scheduleNamespaceDiagnosis(String interval, String scheduleTime, String namenodeId, long startIndex, long endIndex 
			,String scheduleName,boolean isNotitificationEnable,String notificationType, String notificationMessage,ArrayList userList)
	{
	...
	public static boolean scheduleMapRedJobWithoutNotification(String interval, String scheduleTime, ArrayList mapRedJobName, 
			String scheduleName)
	{
		SchedulerBean schedule = null;
		try{
	...
	public static boolean scheduleMapRedJobWithoutNotificationDataTagging(String interval, long scheduleTime, ArrayList mapRedJobName, 
			String scheduleName)
	{
		SchedulerBean schedule = null;
		try{
	...
	public static boolean checkSysReportScheduleId(String id){
		...
		try{
			...
			AppLogger.getLogger().fatal("Exception caught while checking ScheduleId already in use or not "+e.getMessage(),e);
		}
		return flag;
	}
