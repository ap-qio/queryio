 ...
 * class against HTTP endpoints protected with the {@link AuthenticationFilter}.
 * <p>
 ...
 * {@link Authenticator} implementations.
 * <p>
 * The default {@link Authenticator} is the {@link KerberosAuthenticator} class
 * which supports automatic fallback from Kerberos SPNEGO to Hadoop Simple
 * authentication.
 * <p>
...
public class AuthenticatedURL {
	...
	/**
	 * Sets the default {@link Authenticator} class to use when an
	 * {@link AuthenticatedURL} instance is created without specifying an
	 * authenticator.
	 *
	 * @param authenticator
	...
	/**
	 * Returns the default {@link Authenticator} class to use when an
	 * {@link AuthenticatedURL} instance is created without specifying an
	 * authenticator.
	 *
	 ...
	 *
	 * @param authenticator
	 *            the {@link Authenticator} instance to use, if
	 *            <code>null</code> a {@link KerberosAuthenticator} is used.
	 */
	...
	public static void extractToken(HttpURLConnection conn, Token token) throws IOException, AuthenticationException {
		...
		if (respCode == HttpURLConnection.HTTP_OK || respCode == HttpURLConnection.HTTP_CREATED
			...
			token.set(null);
			throw new AuthenticationException("Authentication failed, status: " + conn.getResponseCode() + ", message: "
