...
public class KerberosUtil {
	...
	public static Oid getOidInstance(String oidName)
		...
		if (IBM_JAVA) {
			if ("NT_GSS_KRB5_PRINCIPAL".equals(oidName)) {
				// IBM JDK GSSUtil class does not have field for krb5 principal
				// oid
	...
	public static final String getServicePrincipal(String service, String hostname) throws UnknownHostException {
		...
		// convert hostname to lowercase as kerberos does not work with
		// hostnames
	 ...
	 * @throws IOException
	 *             if cannot get the principal name
	 */
