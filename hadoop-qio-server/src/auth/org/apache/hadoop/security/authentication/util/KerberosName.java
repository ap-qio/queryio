...
public class KerberosName {
	...
	/**
	 * A pattern that matches a string with out '$' and then a single parameter
	 * with $n.
	 */
	 ...
	 * 
	 * @return the second section of the Kerberos principal name, and may be
	 *         null
	 */
	...
	private static class Rule {
		 ...
		 * the length of params. Normal text is copied directly and $n is
		 * replaced by the corresponding parameter.
		 * 
		 * @param format
		...
		/**
		 * Replace the matches of the from pattern in the base string with the
		 * value of the to string.
		 * 
		 * @param base
		 ...
		 *            are the components of the name "a/b@FOO" -> {"FOO", "a",
		 *            "b"}
	...
	/**
	 * Get the translation of the principal name into an operating system user
	 * name.
	 * 
