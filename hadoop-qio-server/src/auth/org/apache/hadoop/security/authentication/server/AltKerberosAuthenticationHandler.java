 ...
 * for Java access. This is an abstract class that should be subclassed to allow
 * a developer to implement their own custom authentication for browser access.
 * The alternateAuthenticate method will be called whenever a request comes from
 * a browser.
 */
public abstract class AltKerberosAuthenticationHandler extends KerberosAuthenticationHandler {
	 ...
	 * custom authentication implemented by the subclass in
	 * alternateAuthenticate has completed successfully (in the case of browser
	 * access).
	 *
	 * @param request
