...
public class Hdfs extends AbstractFileSystem {
	...
	public HdfsDataOutputStream createInternal(Path f, EnumSet<CreateFlag> createFlag, FsPermission absolutePermission,
		...
		final DFSOutputStream dfsos = dfs.primitiveCreate(getUriPath(f), absolutePermission, createFlag, createParent,
	...
	public long renewDelegationToken(Token<? extends AbstractDelegationTokenIdentifier> token)
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void cancelDelegationToken(Token<? extends AbstractDelegationTokenIdentifier> token)
			throws InvalidToken, IOException {
