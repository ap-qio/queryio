...
/**
 * Represents a peer that we communicate with by using a basic Socket that has
...
class BasicInetPeer implements Peer {
	...
	public void setWriteTimeout(int timeoutMs) {
		 ...
		 * 
		 * Java provides no facility to set a blocking write timeout on a
		 * Socket. You can simulate a blocking write with a timeout by using
