...
public interface PeerServer extends Closeable {
	...
	/**
	 * Listens for a connection to be made to this server and accepts it. The
	 ...
	 *                if a timeout was previously set and the timeout has been
	 *                reached.
	 */
	...
	/**
	 * Free the resources associated with this peer server. This normally
	 * includes sockets, etc.
	 *
	 * @throws IOException
	 *             If there is an error closing the PeerServer
	 */
