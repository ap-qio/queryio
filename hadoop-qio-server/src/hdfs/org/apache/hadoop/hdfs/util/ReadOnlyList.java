...
/**
 * A {@link ReadOnlyList} is a unmodifiable list, which supports read-only
 * operations.
 * 
 * @param <E>
...
public interface ReadOnlyList<E> extends Iterable<E> {
	...
	public static class Util {
		...
		/**
		 * The same as {@link Collections#binarySearch(List, Object)} except
		 * that the list is a {@link ReadOnlyList}.
		 *
		 * @return the insertion point defined in
