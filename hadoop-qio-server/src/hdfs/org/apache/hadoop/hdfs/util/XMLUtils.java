...
public class XMLUtils {
	 ...
	 * 
	 * Any code point that isn't valid in XML must be mangled. See
	 * http://en.wikipedia.org/wiki/Valid_characters_in_XML for a quick
	 * reference, or the w3 standard for the authoritative reference.
	 * 
	 * @param cp
	 *            The code point
	 ...
	 * 
	 * There are three kinds of code points in XML: - Those that can be
	 * represented normally, - Those that have to be escaped (for example, &
	 * must be represented as &amp;) - Those that cannot be represented at all
	 * in XML.
	 *
	 ...
	 * represented as '\ABCD;', where ABCD is the hexadecimal value of the code
	 * point.
	 *
	 * @param str
	 *            The input string.
	...
	/**
	 * Demangle a string from an XML document. See
	 * {@link #mangleXmlString(String, boolean)} for a description of the
	 * mangling format.
	 *
	 * @param str
