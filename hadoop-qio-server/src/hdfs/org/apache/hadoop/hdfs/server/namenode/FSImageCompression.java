...
class FSImageCompression {
	...
	/**
	 * Codec to use to save or load image, or null if the image is not
	 * compressed
	 */
	...
	/**
	 * Create a compression instance based on the user's configuration in the
	 * given Configuration object.
	 * 
	 * @throws IOException
	 *             if the specified codec is not available.
	 */
	static FSImageCompression createCompression(Configuration conf) throws IOException {
		boolean compressImage = conf.getBoolean(DFSConfigKeys.DFS_IMAGE_COMPRESS_KEY,
		...
		String codecClassName = conf.get(DFSConfigKeys.DFS_IMAGE_COMPRESSION_CODEC_KEY,
	...
	/**
	 * Create a compression instance based on a header read from an input
	 * stream.
	 * 
	 * @throws IOException
	 *             if the specified codec is not available or the underlying IO
	 *             fails.
	 */
	 ...
	 * @throws IOException
	 *             If the decompressor cannot be instantiated or an IO error
	 *             occurs.
	 */
	 ...
	 * compression codec, and return the same stream wrapped with that codec. If
	 * no codec is specified, simply adds buffering to the stream, so that the
	 * returned stream is always buffered.
	 * 
	 * @param os
	 *            The stream to write header to and wrap. This stream should be
	 *            unbuffered.
	 * @return A stream wrapped with the specified compressor, or buffering if
