...
public interface JournalProtocol {
	 ...
	 * backup node via {@code EditLogBackupOutputStream} in order to synchronize
	 * meta-data changes with the backup namespace image.
	 * 
	 * @param journalInfo
	 *            journal information
	 * @param epoch
	 ...
	 * @param firstTxnId
	 *            the first transaction of this batch
	 * @param numTxns
	 *            number of transactions
	 * @param records
	 *            byte array containing serialized journal records
	 * @throws FencedException
	 *             if the resource has been fenced
	 */
	public void journal(JournalInfo journalInfo, long epoch, long firstTxnId, int numTxns, byte[] records)
			throws IOException;

	/**
	 * Notify the BackupNode that the NameNode has rolled its edit logs and is
	 * now writing a new log segment.
	 * 
	 * @param journalInfo
	 *            journal information
	 * @param epoch
	...
	/**
	 * Request to fence any other journal writers. Older writers with at
	 * previous epoch will be fenced and can no longer perform journal
	 * operations.
	 * 
	 * @param journalInfo
	 *            journal information
	 ...
	 *            marks beginning a new journal writer
	 * @param fencerInfo
	 *            info about fencer for debugging purposes
	 * @throws FencedException
	 *             if the resource has been fenced
	 */
