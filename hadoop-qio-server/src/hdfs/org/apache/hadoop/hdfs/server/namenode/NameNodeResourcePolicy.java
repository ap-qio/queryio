...
final class NameNodeResourcePolicy {
	...
	/**
	 * Return true if and only if there are sufficient NN resources to continue
	 * logging edits.
	 * 
	 * @param resources
	 *            the collection of resources to check.
	 * @param minimumRedundantResources
	 *            the minimum number of redundant resources required to continue
	 *            operation.
	 * @return true if and only if there are sufficient NN resources to continue
	 *         logging edits.
	 */
	static boolean areResourcesAvailable(Collection<? extends CheckableNameNodeResource> resources,
