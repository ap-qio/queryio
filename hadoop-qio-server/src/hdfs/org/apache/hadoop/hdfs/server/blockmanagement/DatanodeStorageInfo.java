...
public class DatanodeStorageInfo {
	...
	/**
	 * Set to false on any NN failover, and reset to true whenever a block
	 * report is received.
	 */
	...
	/**
	 * @return the first {@link DatanodeStorageInfo} corresponding to the given
	 *         datanode
	 */
