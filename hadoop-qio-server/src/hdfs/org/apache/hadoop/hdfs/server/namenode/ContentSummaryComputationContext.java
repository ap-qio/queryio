...
public class ContentSummaryComputationContext {
	 ...
	 * @param fsn
	 *            The FSNamesystem instance
	 * @param limitPerRun
	 *            allowed number of operations in one locking period. 0 or a
	 *            negative number means no limit (i.e. no yielding)
	 */
	...
	/**
	 * Relinquish locks held during computation for a short while and reacquire
	 * them. This will give other threads a chance to acquire the contended
	 * locks and run.
	 *
	...
	public boolean yield() {
		...
		// sanity check.
		if (!hadDirReadLock || !hadFsnReadLock || hadDirWriteLock || hadFsnWriteLock || dir.getReadHoldCount() != 1
