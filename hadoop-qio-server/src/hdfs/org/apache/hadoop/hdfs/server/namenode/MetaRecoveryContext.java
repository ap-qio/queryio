...
public final class MetaRecoveryContext {
	 ...
	 * @param default
	 *            First choice (will be taken if autoChooseDefault is true)
	 * @param choices
	 *            Other choies
	 *
	...
	public static void editLogLoaderPrompt(String prompt, MetaRecoveryContext recovery, String contStr)
