...
/**
 * This interface is used for retrieving the load related statistics of the
 * cluster.
 */
...
public interface FSClusterStats {
	 ...
	 *
	 * @return a count of the total number of block transfers and block writes
	 *         that are currently occuring on the cluster.
	 */
	public int getTotalLoad();

	/**
	 * Indicate whether or not the cluster is now avoiding to use stale
