...
class ReplicaMap {
	...
	/**
	 * Get a collection of the replicas for given block pool This method is
	 * <b>not synchronized</b>. It needs to be synchronized externally using the
	 * mutex, both for getting the replicas values from the map and iterating
	 * over it. Mutex can be accessed using {@link #getMutext()} method.
	 * 
	 * @param bpid
	 *            block pool id
