...
/**
 * Balancing policy. Since a datanode may contain multiple block pools,
...
abstract class BalancingPolicy {
	...
	/**
	 * @return the utilization of a particular storage type of a datanode; or
	 *         return null if the datanode does not have such storage type.
	 */
