...
public class MappableBlock implements Closeable {
	 ...
	 * @param blockIn
	 *            The block input stream. Should be positioned at the start. The
	 *            caller must close this.
	 * @param metaIn
	 *            The meta file input stream. Should be positioned at the start.
	 *            The caller must close this.
	 * @param blockFileName
	 *            The block file name, for logging purposes.
	 *
	 * @return The Mappable block.
	 */
	public static MappableBlock load(long length, FileInputStream blockIn, FileInputStream metaIn, String blockFileName)
			throws IOException {
	...
	private static void verifyChecksum(long length, FileInputStream metaIn, FileChannel blockChannel,
		...
		BlockMetadataHeader header = BlockMetadataHeader
				.readHeader(new DataInputStream(new BufferedInputStream(metaIn, BlockMetadataHeader.getHeaderSize())));
