...
public final class Util {
	...
	/**
	 * Interprets the passed string as a URI. In case of error it assumes the
	 * specified string is a file.
	 *
	 * @param s
	...
	/**
	 * Converts the passed File to a URI. This method trims the trailing slash
	 * if one is appended because the underlying file is in fact a directory
	 * that exists.
	 * 
	 * @param f
	 *            the file to convert
