...
public class BlockMetadataHeader {
	...
	public static DataChecksum readDataChecksum(final DataInputStream metaIn, final Object name) throws IOException {
		...
		if (header.getVersion() != VERSION) {
			LOG.warn("Unexpected meta-file version for " + name + ": version in file is " + header.getVersion()
	...
	/**
	 * Read the header at the beginning of the given block meta file. The
	 * current file position will be altered by this method. If an error occurs,
	 * the file is <em>not</em> closed.
	 */
