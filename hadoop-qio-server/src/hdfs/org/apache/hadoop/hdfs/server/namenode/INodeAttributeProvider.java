...
public abstract class INodeAttributeProvider {
	...
	/**
	 * The AccessControlEnforcer allows implementations to override the default
	 * File System permission checking logic enforced on a file system object
	 */
	public interface AccessControlEnforcer {
		 ...
		 * 
		 * @param fsOwner
		 *            Filesystem owner (The Namenode user)
		 * @param supergroup
		 *            super user geoup
		 * @param callerUgi
		 *            UserGroupInformation of the caller
		 * @param inodeAttrs
		 *            Array of INode attributes for each path element in the the
		 *            path
		 * @param inodes
		 *            Array of INodes for each path element in the path
		 * @param pathByNameArr
		 *            Array of byte arrays of the LocalName
		 * @param snapshotId
		 ...
		 * @param subAccess
		 *            If path is a directory, It is the access required of the
		 *            path and all the sub-directories. If path is not a
		 *            directory, there should ideally be no effect.
		 * @param ignoreEmptyDir
		 *            Ignore permission checking for empty directory?
		 * @throws AccessControlException
		 */
		public abstract void checkPermission(String fsOwner, String supergroup, UserGroupInformation callerUgi,
	 ...
	 * Enforcer that can provide an alternate implementation of the default
	 * permission checking logic.
	 * 
	 * @param defaultEnforcer
