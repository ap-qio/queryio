 ...
 * This command can't be combined with other commands in the same response. This
 * is because after the datanode processes RegisterCommand, it will skip the
 * rest of the DatanodeCommands in the same HeartbeatResponse.
 */
