...
/**
 * Indicates a particular phase of the namenode startup sequence. The phases are
 * listed here in their execution order.
 */
...
public enum Phase {
	...
	/**
	 * The namenode has entered safemode, awaiting block reports from data
	 * nodes.
	 */
