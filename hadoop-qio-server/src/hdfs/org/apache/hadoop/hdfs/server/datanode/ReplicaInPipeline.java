...
/**
 * This class defines a replica in a pipeline, which includes a persistent
 * replica being written to by a dfs client or a temporary replica being
 * replicated by a source datanode or being copied for the balancing purpose.
 * 
...
public class ReplicaInPipeline extends ReplicaInfo implements ReplicaInPipelineInterface {
	 ...
	 * @param bytesToReserve
	 *            disk space to reserve for this replica, based on the estimated
