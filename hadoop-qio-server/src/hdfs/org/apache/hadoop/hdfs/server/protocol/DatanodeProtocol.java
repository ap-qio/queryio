...
public interface DatanodeProtocol {
	 ...
	 *         with updated registration information
	 */
	@Idempotent
	 ...
	 * DatanodeCommand tells the DataNode to invalidate local block(s), or to
	 ...
	 *            info about volume failures
	 * @throws IOException
	 *             on error
	 */
	@Idempotent
	public HeartbeatResponse sendHeartbeat(DatanodeRegistration registration, StorageReport[] reports,
			long dnCacheCapacity, long dnCacheUsed, int xmitsInProgress, int xceiverCount, int failedVolumes,
	 ...
	 * @param reports
	 *            report of blocks per storage Each finalized block is
	 *            represented as 3 longs. Each under- construction replica is
	 *            represented as 4 longs. This is done instead of Block[] to
	 *            reduce memory used by block reports.
	 * @param reports
	 *            report of blocks per storage
	 * @param context
	 *            Context information for this block report.
	 *
	 ...
	 * deleted when there is any excessive blocks is provided. For example,
	 * whenever client code writes a new Block here, or another DataNode copies
	 * a Block to this DataNode, it will call blockReceived().
	 */
	@Idempotent
