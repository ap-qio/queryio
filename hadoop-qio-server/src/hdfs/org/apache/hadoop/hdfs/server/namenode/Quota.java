...
public enum Quota {
	...
	public static class Counts extends EnumCounters<Quota> {
		/**
		 * @return a new counter with the given namespace and storagespace
		 *         usages.
		 */
	...
	/**
	 * Is quota violated? The quota is violated if quota is set and usage >
	 * quota.
	 */
	...
	/**
	 * Is quota violated? The quota is violated if quota is set, delta > 0 and
	 * usage + delta > quota.
	 */
