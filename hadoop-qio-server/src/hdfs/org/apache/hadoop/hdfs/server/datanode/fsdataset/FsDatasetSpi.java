...
/**
 * This is a service provider interface for the underlying storage that stores
 * replicas for a data node. The default implementation stores replicas on local
 * drives.
 */
...
public interface FsDatasetSpi<V extends FsVolumeSpi> extends FSDatasetMBean {
	...
	public static abstract class Factory<D extends FsDatasetSpi<?>> {
		...
		public static Factory<?> getFactory(Configuration conf) {
			...
			final Class<? extends Factory> clazz = conf.getClass(DFSConfigKeys.DFS_DATANODE_FSDATASET_FACTORY_KEY,
	 ...
	 * @throws IOException
	 */
	public void adjustCrcChannelPosition(ExtendedBlock b, ReplicaOutputStreams outs, int checksumSize)
			throws IOException;
	 ...
	 * 
	 * @return actual state of the replica on this data-node or null if
	 *         data-node does not have the replica.
	 */
	 ...
	 */
	public String updateReplicaUnderRecovery(ExtendedBlock oldBlock, long recoveryId, long newBlockId, long newLength)
			throws IOException;
	 ...
	 */
	public void submitBackgroundSyncFileRangeRequest(final ExtendedBlock block, final FileDescriptor fd,
	 ...
	 */
	public ReplicaInfo moveBlockAcrossStorage(final ExtendedBlock block, StorageType targetStorageType)
			throws IOException;
