 ...
 * {@link NamenodeProtocol#startCheckpoint(NamenodeRegistration)} request.<br>
 * Contains:
 * <ul>
...
public class CheckpointCommand extends NamenodeCommand {
	...
	/**
	 * Checkpoint signature is used to ensure that nodes are talking about the
	 * same checkpoint.
	 */
	...
	/**
	 * Indicates whether the new checkpoint image needs to be transfered back to
	 * the name-node after the checkpoint is done.
	 * 
