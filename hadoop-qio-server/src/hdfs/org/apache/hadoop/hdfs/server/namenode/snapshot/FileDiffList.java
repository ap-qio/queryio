...
public class FileDiffList extends AbstractINodeDiffList<INodeFile, INodeFileAttributes, FileDiff> {
	...
	public void saveSelf2Snapshot(int latestSnapshotId, INodeFile iNodeFile, INodeFileAttributes snapshotCopy,
			boolean withBlocks) {
	...
	/**
	 * Copy blocks from the removed snapshot into the previous snapshot up to
	 * the file length of the latter. Collect unused blocks of the removed
	 * snapshot.
	 */
	void combineAndCollectSnapshotBlocks(BlockStoragePolicySuite bsps, INodeFile file, FileDiff removed,
