...
/**
 * In the Standby Node, we can receive messages about blocks before they are
 * actually available in the namespace, or while they have an outdated state in
 * the namespace. In those cases, we queue those block-related messages in this
 * structure.
 */
class PendingDataNodeMessages {
	 ...
	 * 
	 * @param dn
	 *            the datanode whose messages we should remove.
	 */
	...
	/**
	 * @return any messages that were previously queued for the given block, or
	 *         null if no messages were queued.
	 */
