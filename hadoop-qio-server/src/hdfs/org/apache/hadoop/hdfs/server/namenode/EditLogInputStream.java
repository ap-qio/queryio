...
public abstract class EditLogInputStream implements Closeable {
	 ...
	 * 
	 * @throws IOException
	 *             if an error occurred while closing
	 */
	@Override
	...
	protected FSEditLogOp nextValidOp() {
		// This is a trivial implementation which just assumes that any errors
		// mean
		// that there is nothing more of value in the log. Subclasses that
		// support
	...
	/**
	 * Skip edit log operations up to a given transaction ID, or until the end
	 * of the edit log is reached.
	 *
	 ...
	 * @return Returns true if we found a transaction ID greater than or equal
	 *         to 'txid' in the log.
	 */
	...
	/**
	 * Get the "position" of in the stream. This is useful for debugging and
	 * operational purposes.
	 *
	 * Different stream types can have a different meaning for what the position
	 * is. For file streams it means the byte offset from the start of the file.
	 *
