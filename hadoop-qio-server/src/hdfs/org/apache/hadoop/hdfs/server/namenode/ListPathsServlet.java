...
public class ListPathsServlet extends DfsServlet {
	...
	/**
	 * Write a node to output. Node information includes path, modification,
	 * permission, owner and group. For files, it also includes size,
	 ...
	 * }
	 *
	 * Where <i>option</i> (default) in: recursive (&quot;no&quot;) filter
	 * (&quot;.*&quot;) exclude (&quot;\..*\.crc&quot;)
	 *
	 ...
	 *     <file path="..." modified="yyyy-MM-dd'T'hh:mm:ssZ" accesstime=
