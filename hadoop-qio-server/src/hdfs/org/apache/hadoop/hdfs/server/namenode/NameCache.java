...
/**
 * Caches frequently used names to facilitate reuse. (example: byte[]
 * representation of the file name in {@link INode}).
 * 
 * This class is used by initially adding all the file names. Cache tracks the
 * number of times a name is used in a transient map. It promotes a name used
 * more than {@code useThreshold} to the cache.
 * 
...
class NameCache<K> {
	 ...
	 * 
	 * @param useThreshold
	 *            names occurring more than this is promoted to the cache
	 */
	...
	/**
	 * Add a given name to the cache or track use count. exist. If the name
	 * already exists, then the internal value is returned.
	 * 
	 * @param name
