...
/**
 * DatanodeRegistration class contains all information the name-node needs to
 * identify and verify a data-node when it contacts the name-node. This
 * information is sent by data-node with each communication request.
 */
...
public class DatanodeRegistration extends DatanodeID implements NodeRegistration {
	...
	public String toString() {
		return getClass().getSimpleName() + "(" + super.toString() + ", datanodeUuid=" + getDatanodeUuid()
				+ ", infoPort=" + getInfoPort() + ", infoSecurePort=" + getInfoSecurePort() + ", ipcPort="
