 ...
 * block report RPC. The context includes a unique 64-bit ID which identifies
 * the block report as a whole. It also includes the total number of RPCs which
 * this block report is split into, and the index into that total for the
 * current RPC.
 */
