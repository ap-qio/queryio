...
public class LeaseManager {
	...
	/**
	 * This method iterates through all the leases and counts the number of
	 * blocks which are not COMPLETE. The FSNamesystem read lock MUST be held
		...
		while (leaseToCheck != null) {
			...
			for (String p : leasePaths) {
				try {
					...
					boolean completed = fsnamesystem.internalReleaseLease(leaseToCheck, p, iip,
	...
	/**
	 * Trigger the currently-running Lease monitor to re-check its leases
	 * immediately. This is for use by unit tests.
	 */
	@VisibleForTesting
