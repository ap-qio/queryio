...
/**
 * This class represents a replica that is waiting to be recovered. After a
 * datanode restart, any replica in "rbw" directory is loaded as a replica
 * waiting to be recovered. A replica waiting to be recovered does not provision
 * read nor participates in any pipeline recovery. It will become outdated if
 * its client continues to write or be recovered as a result of lease recovery.
 */
