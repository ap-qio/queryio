...
public class BlockCommand extends DatanodeCommand {
	 ...
	 * explicit ACK from the datanode. When a block is put into the list of
	 * blocks to be deleted, it's size is set to this constant. We assume that
	 * no block would actually have this size. Otherwise, we would miss ACKs for
	 * blocks with such size. Positive number is used for compatibility reasons.
	 */
