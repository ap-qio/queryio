...
class SnapshotDiffInfo {
	...
	public SnapshotDiffReport generateReport() {
		...
		return new SnapshotDiffReport(snapshotRoot.getFullPathName(), Snapshot.getSnapshotName(from),
				Snapshot.getSnapshotName(to), diffReportList);
	}

	/**
	 * Interpret the ChildrenDiff and generate a list of
	 * {@link DiffReportEntry}.
	 * 
	 * @param dirDiff
	 *            The ChildrenDiff.
	 * @param parentPath
	 ...
	 * @param fromEarlier
	 *            True indicates {@code diff=later-earlier}, False indicates
	 *            {@code diff=earlier-later}
	 * @param renameMap
	 *            A map containing information about rename operations.
	 * @return A list of {@link DiffReportEntry} as the diff report.
	 */
	private List<DiffReportEntry> generateReport(ChildrenDiff dirDiff, byte[][] parentPath, boolean fromEarlier,
