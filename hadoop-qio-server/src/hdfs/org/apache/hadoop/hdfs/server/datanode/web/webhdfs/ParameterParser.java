...
class ParameterParser {
	 ...
	 * <code>QueryStringDecoder#decodeComponent</code> except that it does not
	 * decode the '+' character as space. WebHDFS takes this scheme to maintain
	 * the backward-compatibility for pre-2.7 releases.
	 */
