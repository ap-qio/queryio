...
public class XAttrStorage {
	...
	/**
	 * Reads the existing extended attributes of an inode. If the inode does not
	 * have an <code>XAttr</code>, then this method returns an empty list.
	 * <p/>
	...
	public static void updateINodeXAttrs(INode inode, List<XAttr> xAttrs, int snapshotId)
		...
		for (XAttr xAttr : xAttrs) {
			...
			XAttr internedXAttr = new XAttr.Builder().setName(internedName).setNameSpace(xAttr.getNameSpace())
					.setValue(xAttr.getValue()).build();
