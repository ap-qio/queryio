...
/**
 * Interface responsible for inspecting a set of storage directories and
 * devising a plan to load the namespace from them.
 */
...
abstract class FSImageStorageInspector {
	...
	/**
	 * @return false if any of the storage directories have an unfinalized
	 *         upgrade
	 */
	 ...
	 * 
	 * @throws IOException
	 *             if not enough files are available (eg no image found in any
	 *             directory)
	 */
	...
	/**
	 * @return true if the directories are in such a state that the image should
	 *         be re-saved following the load
	 */
