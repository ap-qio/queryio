...
/**
 * EditLogOutputStream implementation that writes to a quorum of remote
 * journals.
 */
class QuorumOutputStream extends EditLogOutputStream {
	...
	public QuorumOutputStream(AsyncLoggerSet loggers, long txId, int outputBufferCapacity, int writeTimeoutMs)
			throws IOException {
		super();
	...
	protected void flushAndSync(boolean durable) throws IOException {
		...
		if (numReadyBytes > 0) {
			...
			// future
			// RPCs will thus let the loggers know of the most recent
			// transaction, even
