...
class AsyncLoggerSet {
	...
	/**
	 * Set the highest successfully committed txid seen by the writer. This
	 * should be called after a successful write to a quorum, and is used for
	 * extra sanity checks against the protocol. See HDFS-3863.
	 */
	 ...
	 *         successful call to {@link #createNewUniqueEpoch(NamespaceInfo)}.
	 */
	long getEpoch() {
	...
	/**
	 * Append an HTML-formatted status readout on the current state of the
	 * underlying loggers.
	 * 
	 * @param sb
