...
public interface QJournalProtocol {
	 ...
	 * @param layoutVersion
	 *            the LayoutVersion of the new log
	 */
	 ...
	 * expected to be in-progress and starting at the given startTxId.
	 *
	 * @param startTxId
	 ...
	 * @param inProgressOk
	 *            whether or not to check the in-progress edit log segment
