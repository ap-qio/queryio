...
interface AsyncLogger {
	 ...
	 * 
	 * @param segmentTxId
	 *            the first txid in the current segment
	 * @param firstTxnId
	 *            the first txid of the edits.
	 * @param numTxns
	 ...
	 * 
	 * @param startTxId
	 *            the first txid that was written to the segment
	 * @param endTxId
	 *            the last txid that was written to the segment
	 */
	 ...
	 * 
	 * @param minTxIdToKeep
	 *            the min txid which must be retained
	 */
	...
	/**
	 * Accept a recovery proposal. See the HDFS-3077 design document for
	 * details.
	 */
	 ...
	 * set. This txid may be higher than the last committed txid for
	 * <em>this</em> logger. See HDFS-3863 for details.
	 */
