...
/**
 * This class implements an offline edits viewer, tool that can be used to view
 * edit logs.
 */
...
public class OfflineEditsViewer extends Configured implements Tool {
	 ...
	 * @param processor
	 *            If visitor is null, the processor to use
	 * @param visitor
	 *            If non-null, the visitor to use.
	 * 
	 * @return 0 on success; error code otherwise
	 */
	public int go(String inputFileName, String outputFileName, String processor, Flags flags,
		...
		try {
			if (visitor == null) {
				visitor = OfflineEditsVisitorFactory.getEditsVisitor(outputFileName, processor,
						flags.getPrintToScreen());
			}
