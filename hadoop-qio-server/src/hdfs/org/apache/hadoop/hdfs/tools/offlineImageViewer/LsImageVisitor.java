 ...
 *
 * Note: A significant difference between the output of the lsr command and this
 * image visitor is that this class cannot sort the file entries; they are
 * listed in the order they are stored within the fsimage file. Therefore, the
 * output of this class cannot be directly compared to the output of the lsr
 * command.
 */
class LsImageVisitor extends TextWriterImageVisitor {
	...
	private final static String lsStr = " %" + widthRepl + "s %" + widthUser + "s %" + widthGroup + "s %" + widthSize
			+ "d %" + widthMod + "s %s";
