...
public class NameDistributionVisitor extends TextWriterImageVisitor {
	...
	void finish() throws IOException {
		...
		// Columns: Frequency of file occurrence, savings in heap, total files
		// using
		// the name and number of file names
		final long stats[][] = { { 100000, 0, 0, 0 }, { 10000, 0, 0, 0 }, { 1000, 0, 0, 0 }, { 100, 0, 0, 0 },
				{ 10, 0, 0, 0 }, { 5, 0, 0, 0 }, { 4, 0, 0, 0 }, { 3, 0, 0, 0 }, { 2, 0, 0, 0 } };
