...
public class AdminHelper {
	...
	static TableListing getOptionDescriptionListing() {
		return new TableListing.Builder().addField("").addField("", true).wrapWidth(MAX_LINE_WIDTH).hideHeaders()
				.build();
	}
	...
	static class HelpCommand implements Command {
		...
		public String getLongUsage() {
			...
			listing.addRow("<command-name>", "The command for which to get "
					+ "detailed help. If no command is specified, print detailed help for " + "all commands");
