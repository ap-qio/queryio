...
/****************************************************************
 * DFSPacket is used by DataStreamer and DFSOutputStream. DFSOutputStream
 * generates packets and then ask DatStreamer to send them to datanodes.
 ****************************************************************/
...
class DFSPacket {
	...
	private byte[] buf;
	private final boolean lastPacketInBlock; // is this the last packet in
												// block?
	 ...
	 * checksumPos dataStart dataPos checksumStart
	 *
	 ...
	 *
	 * @param buf
	 *            the buffer storing data and checksums
	 * @param chunksPerPkt
	 ...
	 */
	DFSPacket(byte[] buf, int chunksPerPkt, long offsetInBlock, long seqno, int checksumSize,
	 ...
	 *
	 * @param inarray
	 *            input array of checksums
	 * @param off
	 *            the offset of checksums to write
	 * @param len
	 *            the length of checksums to write
	 * @throws ClosedChannelException
	 */
	...
	public String toString() {
		return "packet seqno: " + this.seqno + " offsetInBlock: " + this.offsetInBlock + " lastPacketInBlock: "
				+ this.lastPacketInBlock + " lastByteOffsetInBlock: " + this.getLastByteOffsetBlock();
	}
