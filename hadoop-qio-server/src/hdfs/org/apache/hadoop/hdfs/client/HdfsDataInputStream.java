...
public class HdfsDataInputStream extends FSDataInputStream {
	...
	/**
	 * Get a reference to the wrapped output stream. We always want to return
	 * the actual underlying InputStream, even when we're using a CryptoStream.
	...
	/**
	 * Get statistics about the reads which this DFSInputStream has done. Note
	 * that because HdfsDataInputStream is buffered, these stats may be higher
	 * than you would expect just by adding up the number of bytes read through
	 * HdfsDataInputStream.
	 */
