 ...
 * directly to users of {@link FsPermission} serialization. This is done for
 * backwards compatibility in case any existing clients assume the value of
 * FsPermission is in a particular range.
 */
...
public class FsPermissionExtension extends FsPermission {
	 ...
	 *
	 * @param perm
	 *            FsPermission containing permission bits
	 */
	...
	/**
	 * Creates a new FsPermissionExtension by calling the base class
	 * constructor.
	 *
	 * @param perm
	 *            short containing permission bits
	 */
	...
	public boolean equals(Object o) {
		// This intentionally delegates to the base class. This is only
		// overridden
