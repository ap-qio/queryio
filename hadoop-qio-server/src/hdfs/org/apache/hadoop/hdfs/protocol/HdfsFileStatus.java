...
public class HdfsFileStatus {
	...
	private final byte[] path; // local name of the inode that's encoded in java
								// UTF8
	...
	public HdfsFileStatus(long length, boolean isdir, int block_replication, long blocksize, long modification_time,
		...
		this.permission = (permission == null)
				? ((isdir || symlink != null) ? FsPermission.getDefault() : FsPermission.getFileDefault()) : permission;
