...
public class SnapshotDiffReport {
	...
	/**
	 * Types of the difference, which include CREATE, MODIFY, DELETE, and
	 * RENAME. Each type has a label for representation: +/M/-/R represent
	 * CREATE, MODIFY, DELETE, and RENAME respectively.
	 */
	...
	/**
	 * Representing the full path and diff type of a file/directory where
	...
	public static class DiffReportEntry {
		...
		/**
		 * The relative path (related to the snapshot root) of 1) the
		 * file/directory where changes have happened, or 2) the source file/dir
		 * of a rename op.
		 */
