 ...
 * <ol>
 * <li>The layout of how namenode or datanode stores information on disk
 * changes.</li>
 * <li>A new operation code is added to the editlog.</li>
 * <li>Modification such as format of a record, content of a record in editlog
 * or fsimage.</li>
 * </ol>
 * <br>
 * <b>How to update layout version:<br>
 * </b> When a change requires new layout version, please add an entry into
 * {@link Feature} with a short enum name, new layout version and description of
 * the change. Please see {@link Feature} for further details. <br>
 */
@InterfaceAudience.Private
public class LayoutVersion {
	/**
	 * Version in which HDFS-2991 was fixed. This bug caused OP_ADD to sometimes
	 * be skipped for append() calls. If we see such a case when loading the
	 * edits, but the version is known to have that bug, we workaround the
	 * issue. Otherwise we should consider it a corruption and bail.
	 */
	...
	/**
	 * Enums for features that change the layout version before rolling upgrade
	 * is supported. <br>
	 * <br>
	...
	public static enum Feature implements LayoutFeature {
		NAMESPACE_QUOTA(-16, "Support for namespace quotas"), FILE_ACCESS_TIME(-17,
				"Support for access time on files"), DISKSPACE_QUOTA(-18, "Support for disk space quotas"), STICKY_BIT(
						-19, "Support for sticky bits"), APPEND_RBW_DIR(-20,
																...
																"Support for delegation tokens for security"), FSIMAGE_COMPRESSION(
																		...
																		"Support for fsimage compression"), FSIMAGE_CHECKSUM(
																				...
																				"Support checksum for fsimage"), REMOVE_REL13_DISK_LAYOUT_SUPPORT(
																						-27,
																						"Remove support for 0.13 disk layout"), EDITS_CHESKUM(
																								-28,
		...
		// Hadoop 2.4.0
		PROTOBUF_FORMAT(-52, "Use protobuf to serialize FSImage"), EXTENDED_ACL(-53, "Extended ACL"), RESERVED_REL2_4_0(
				-54, -51, "Reserved for release 2.4.0", true, PROTOBUF_FORMAT, EXTENDED_ACL);
