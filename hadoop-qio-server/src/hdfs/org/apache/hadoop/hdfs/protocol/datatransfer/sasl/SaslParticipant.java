...
class SaslParticipant {
	 ...
	 *             for any error
	 */
	public static SaslParticipant createServerSaslParticipant(Map<String, String> saslProps,
	 ...
	 *             for any error
	 */
	public static SaslParticipant createClientSaslParticipant(String userName, Map<String, String> saslProps,
			CallbackHandler callbackHandler) throws SaslException {
		return new SaslParticipant(Sasl.createSaslClient(new String[] { MECHANISM }, userName, PROTOCOL, SERVER_NAME,
	 ...
	 * @throws SaslException
	 *             if the bytes cannot be successfully wrapped
	 */
	 ...
	 * communication encrypted, depending on the negotiated quality of
	 * protection.
	 *
	 * @param out
