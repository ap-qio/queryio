...
/**
 * Subclass of {@link AuthenticationFilter} that obtains Hadoop-Auth
 * configuration for webhdfs.
 */
public class AuthFilter extends AuthenticationFilter {
	private static final String CONF_PREFIX = "dfs.web.authentication.";

	/**
	 * Returns the filter configuration properties, including the ones prefixed
	 * with {@link #CONF_PREFIX}. The prefix is removed from the returned
	 * property names.
	 *
	 * @param prefix
	 *            parameter not used.
	 * @param config
	 *            parameter contains the initialization values.
