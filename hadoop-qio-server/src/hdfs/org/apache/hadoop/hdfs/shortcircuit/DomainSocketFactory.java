...
public class DomainSocketFactory {
	...
	public static class PathInfo {
		...
		public String toString() {
			return new StringBuilder().append("PathInfo{path=").append(path).append(", state=").append(state)
					.append("}").toString();
		}
	}
		...
		if (feature == null) {
			...
			if (conf.getDomainSocketPath().isEmpty()) {
				throw new HadoopIllegalArgumentException(
						feature + " is enabled but " + DFSConfigKeys.DFS_DOMAIN_SOCKET_PATH_KEY + " is not set.");
