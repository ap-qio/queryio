...
public class ConfigUtil {
	 ...
	 *            - the target URI link
	 */
	public static void addLink(Configuration conf, final String mountTableName, final String src, final URI target) {
		conf.set(getConfigViewFsPrefix(mountTableName) + "." + Constants.CONFIG_VIEWFS_LINK + "." + src,
				target.toString());
	}
	...
	public static void addLink(final Configuration conf, final String src, final URI target) {
		addLink(conf, Constants.CONFIG_VIEWFS_DEFAULT_MOUNT_TABLE, src, target);
	}
	 ...
	 *            - add to this conf
	 * @param homedir
	 *            - the home dir path starting with slash
	 */
	public static void setHomeDirConf(final Configuration conf, final String homedir) {
		setHomeDirConf(conf, Constants.CONFIG_VIEWFS_DEFAULT_MOUNT_TABLE, homedir);
	}
