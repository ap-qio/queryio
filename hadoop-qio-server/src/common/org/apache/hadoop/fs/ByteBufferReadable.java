...
public interface ByteBufferReadable {
	 ...
	 * <p/>
	 * After a successful call, buf.position() will be advanced by the number of
	 * bytes read and buf.limit() should be unchanged.
	 * <p/>
	 ...
	 * <p/>
	 * Implementations should treat 0-length requests as legitimate, and must
	 * not signal an error upon their receipt.
	 *
	 * @param buf
	 *            the ByteBuffer to receive the results of the read operation.
	 * @return the number of bytes read, possibly zero, or -1 if reach
	 *         end-of-stream
	 * @throws IOException
