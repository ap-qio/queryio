 ...
 * <br>
 * <code> EnumSet.of(CreateFlag.CREATE, CreateFlag.APPEND) <code>
 * <p>
 * 
 * Use the CreateFlag as follows:
 * <ol>
 * <li>CREATE - to create a file if it does not exist, else throw
 * FileAlreadyExists.</li>
 * <li>APPEND - to append to a file if it exists, else throw
 * FileNotFoundException.</li>
 * <li>OVERWRITE - to truncate a file if it exists, else throw
 * FileNotFoundException.</li>
 * <li>CREATE|APPEND - to create a file if it does not exist, else append to an
 * existing file.</li>
 * <li>CREATE|OVERWRITE - to create a file if it does not exist, else overwrite
 * an existing file.</li>
 * <li>SYNC_BLOCK - to force closed blocks to the disk device. In addition
 * {@link Syncable#hsync()} should be called after each write, if true
 * synchronous behavior is required.</li>
...
public enum CreateFlag {
	...
	/**
	 * Truncate/overwrite a file. Same as POSIX O_TRUNC. See javadoc for
	 * description.
	 */
	...
	/**
	 * Force closed blocks to disk. Similar to POSIX O_SYNC. See javadoc for
	 * description.
	 */
	SYNC_BLOCK((short) 0x08),

	/**
	 * Create the block on transient storage (RAM) if available. If transient
	 * storage is unavailable then the block will be created on disk.
	 *
	...
	public static void validate(Object path, boolean pathExists, EnumSet<CreateFlag> flag) throws IOException {
		...
		if (pathExists) {
			...
			throw new FileNotFoundException(
					"Non existing file: " + path.toString() + ". Create option is not specified in " + flag);
		}
	}
