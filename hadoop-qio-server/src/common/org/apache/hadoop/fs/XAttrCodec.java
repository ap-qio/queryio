...
/**
 * The value of <code>XAttr</code> is byte[], this class is to covert byte[] to
 * some kind of string representation or convert back. String representation is
 * convenient for display and input. For example display in screen as shell
...
public enum XAttrCodec {
	 ...
	 * If the given string begins with 0x or 0X, it expresses a hexadecimal
	 * number. If the given string begins with 0s or 0S, base64 encoding is
	 * expected. If the given string is enclosed in double quotes, the inner
	 * string is treated as text. Otherwise the given string is treated as text.
	 * 
	 * @param value
	...
	/**
	 * Encode byte[] value to string representation with encoding. Values
	 * encoded as text strings are enclosed in double quotes (\"), while strings
