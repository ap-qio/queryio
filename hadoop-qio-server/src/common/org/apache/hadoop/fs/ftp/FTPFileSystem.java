...
/**
 * <p>
 * A {@link FileSystem} backed by an FTP client provided by
...
public class FTPFileSystem extends FileSystem {
	 ...
	 * 
	 * @throws IOException
	 *             on IO problems other than FileNotFoundException
	 */
	...
	private boolean rename(FTPClient client, Path src, Path dst) throws IOException {
		...
		if (!parentSrc.equals(parentDst)) {
			throw new IOException(
					"Cannot rename source: " + absoluteSrc + " to " + absoluteDst + " -" + E_SAME_DIRECTORY_ONLY);
		}
