...
/**
 * FileEncryptionInfo encapsulates all the encryption-related information for an
 * encrypted file.
 */
...
public class FileEncryptionInfo {
	 ...
	 * @param edek
	 *            encrypted data encryption key (EDEK) of the file
	 * @param iv
	 *            initialization vector (IV) used to encrypt the file
	 * @param keyName
	 *            name of the key used for the encryption zone
	 * @param ezKeyVersionName
	 *            name of the KeyVersion used to encrypt the encrypted data
	 *            encryption key.
	 */
	public FileEncryptionInfo(final CipherSuite suite, final CryptoProtocolVersion version, final byte[] edek,
		...
		checkArgument(iv.length == suite.getAlgorithmBlockSize(), "Unexpected IV length");
	...
	/**
	 * @return {@link org.apache.hadoop.crypto.CipherSuite} used to encrypt the
	 *         file.
	 */
	...
	/**
	 * @return {@link org.apache.hadoop.crypto.CryptoProtocolVersion} to use to
	 *         access the file.
	 */
	...
	/**
	 * @return initialization vector (IV) for the cipher used to encrypt the
	 *         file
	 */
	public byte[] getIV() {
		return iv;
