...
public class CommandFormat {
	...
	/**
	 * Parse parameters starting from the given position Consider using the
	 * variant that directly takes a List
	 * 
	 * @param args
	...
	/**
	 * Parse parameters from the given list of args. The list is destructively
	 * modified to remove the options.
	 * 
	 * @param args
	 *            as a list of input arguments
	 */
