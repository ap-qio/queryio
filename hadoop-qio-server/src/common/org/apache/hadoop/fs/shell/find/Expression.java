...
public interface Expression {
	 ...
	 *
	 * @param item
	 *            {@link PathData} item to be processed
	 * @param depth
	 *            distance of the item from the command line argument
	...
	/**
	 * Returns brief usage instructions for this expression. Multiple items
	 * should be returned if there are multiple ways to use this expression.
	 *
	...
	/**
	 * Indicates whether this expression performs an action, i.e. provides
	...
	/**
	 * Adds children to this expression. Children are popped from the head of
	 * the deque.
	 *
	 * @param expressions
	 ...
	 * the deque and added to the front of the child list, ie last child added
	 * is the first evaluated.
	 * 
	 * @param args
	 *            deque of arguments from which to take expression arguments
	 */
