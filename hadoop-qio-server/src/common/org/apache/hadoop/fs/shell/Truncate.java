...
public class Truncate extends FsCommand {
	...
	public static final String DESCRIPTION = "Truncate all files that match the specified file pattern to the "
	...
	protected void processPath(PathData item) throws IOException {
		...
		if (item.fs.truncate(item.path, newLength)) {
			...
			out.println("Truncating " + item + " to length: " + newLength + ". "
					+ "Wait for block recovery to complete before further updating this " + "file.");
		}
	}
