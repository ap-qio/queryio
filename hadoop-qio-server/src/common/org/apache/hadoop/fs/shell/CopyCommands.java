...
class CopyCommands {
	...
	public static class Put extends CommandWithDestination {
		...
		protected List<PathData> expandArgument(String arg) throws IOException {
			...
			try {
				...
				if (Path.WINDOWS) {
					// Unlike URI, PathData knows how to parse Windows
					// drive-letter paths.
	...
	/**
	 * Append the contents of one or more local files to a remote file.
	 */
	public static class AppendToFile extends CommandWithDestination {
		...
		public static final String DESCRIPTION = "Appends the contents of all the given local files to the "
				...
				+ "not exist. If <localSrc> is -, then the input is read " + "from stdin.";
