...
class XAttrCommands extends FsCommand {
	...
	public static class GetfattrCommand extends FsCommand {
		...
		public static final String DESCRIPTION = "Displays the extended attribute names and values (if any) for a "
		...
		private final static Function<String, XAttrCodec> enValueOfFunc = Enums.valueOfFunction(XAttrCodec.class);
	...
	public static class SetfattrCommand extends FsCommand {
		...
		public static final String DESCRIPTION = "Sets an extended attribute name and value for a file or directory.\n"
				...
				+ "number. If the argument begins with 0s or 0S, then it is taken as a " + "base64 encoding.\n"
