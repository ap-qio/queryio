...
public class FilterFileSystem extends FileSystem {
	...
	public Path makeQualified(Path path) {
		...
		if (swapScheme != null) {
			try {
				// NOTE: should deal with authority, but too much other stuff is
				// broken
	...
	protected FSDataOutputStream primitiveCreate(Path f, FsPermission absolutePermission, EnumSet<CreateFlag> flag,
			...
			throws IOException {
		return fs.primitiveCreate(f, absolutePermission, flag, bufferSize, replication, blockSize, progress,
				checksumOpt);
	}
