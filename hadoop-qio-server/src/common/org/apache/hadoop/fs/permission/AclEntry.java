...
/**
 * Defines a single entry in an ACL. An ACL entry has a type (user, group, mask,
 * or other), an optional name (referring to a specific user or group), a set of
 * permissions (any combination of read, write and execute), and a scope (access
 * or default). AclEntry instances are immutable. Use a {@link Builder} to
...
public class AclEntry {
	...
	public boolean equals(Object o) {
		...
		return Objects.equal(type, other.type) && Objects.equal(name, other.name)
				&& Objects.equal(permission, other.permission) && Objects.equal(scope, other.scope);
	}
	...
	public static class Builder {
		...
		/**
		 * Sets the scope of the ACL entry. If this method is not called, then
		 * the builder assumes {@link AclEntryScope#ACCESS}.
		 *
		 * @param scope
	 ...
	 *            But for removeAcl operation it will be false. i.e. AclSpec
	 *            should not contain permissions.<br>
	 ...
	 *            Example: "user:foo:rw-"
	 * @param includePermission
	 *            for setAcl operations this will be true. i.e. Acl should
	 *            include permissions.<br>
	 *            But for removeAcl operation it will be false. i.e. Acl should
