...
/**
 * Parse umask value provided as a string, either in octal or symbolic format
 * and return it as a short value. Umask values are slightly different from
 * standard modes as they cannot specify sticky bit or X.
 *
 */
@InterfaceAudience.Private
@InterfaceStability.Unstable
class UmaskParser extends PermissionParser {
	private static Pattern chmodOctalPattern = Pattern.compile("^\\s*[+]?()([0-7]{3})\\s*$"); // no
																								// leading
																								// 1
																								// for
																								// sticky
	 ...
	 * results in clearing the corresponding bit in the mask, '-' results in
	 * bits for indicated permission to be set in the mask.
	 * 
