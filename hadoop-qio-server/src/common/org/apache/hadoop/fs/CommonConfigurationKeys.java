 ...
 *
 * It inherits all the publicly documented configuration keys and adds
 * unsupported keys.
 *
 */
...
public class CommonConfigurationKeys extends CommonConfigurationKeysPublic {
	 ...
	 * combined with a namespace and port. For instance: IPC_CALLQUEUE_NAMESPACE
	 * + ".8020." + IPC_CALLQUEUE_IMPL_KEY
	 */
	...
	/**
	 * This is for specifying the implementation for the mappings from hostnames
	 * to the racks they belong to
	 */
	...
	/** Default value for IO_COMPRESSION_CODEC_SNAPPY_BUFFERSIZE_KEY */
	public static final int IO_COMPRESSION_CODEC_LZ4_BUFFERSIZE_DEFAULT = 256 * 1024;
	...
	/**
	 * Static user web-filter properties. See {@link StaticUserWebFilter}.
	 */
	...
	public static final long HADOOP_SECURITY_UID_NAME_CACHE_TIMEOUT_DEFAULT = 4 * 60 * 60; // 4
																							// hours
