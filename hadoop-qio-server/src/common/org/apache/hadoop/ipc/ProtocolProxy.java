...
/**
 * a class wraps around a server's proxy, containing a list of its supported
 * methods.
 * 
...
public class ProtocolProxy<T> {
	...
	private void fetchServerMethods(Method method) throws IOException {
		...
		ProtocolSignature serverInfo = ((VersionedProtocol) proxy).getProtocolSignature(RPC.getProtocolName(protocol),
