...
/**
 * Return a response in the handler method for the user to see. Useful since you
 * may want to display status to a user even though an error has not occurred.
 */
...
public class RefreshResponse {
	...
	/**
	 * Optionally set the sender of this RefreshResponse. This helps clarify
	 * things when multiple handlers respond.
	 * 
	 * @param name
