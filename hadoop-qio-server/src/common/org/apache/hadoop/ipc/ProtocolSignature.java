...
public class ProtocolSignature implements Writable {
	...
	/**
	 * Calculate a method's hash code considering its method name, returning
	...
	/**
	 * Get the hash code of an array of methods Methods are sorted before
	 * hashcode is calculated. So the returned value is irrelevant of the method
	 * order in the array.
	 * 
	 * @param methods
	 *            an array of methods
	...
	/**
	 * Get the hash code of an array of hashcodes Hashcodes are sorted before
	 * hashcode is calculated. So the returned value is irrelevant of the
	 * hashcode order in the array.
	 * 
	 * @param methods
	 *            an array of methods
	 * @return the hash code
	...
	public static ProtocolSignature getProtocolSignature(int clientMethodsHashCode, long serverVersion,
		...
		if (clientMethodsHashCode == sig.fingerprint) {
			return new ProtocolSignature(serverVersion, null); // null indicates
																// a match
		}
	...
	public static ProtocolSignature getProtocolSignature(VersionedProtocol server, String protocol, long clientVersion,
