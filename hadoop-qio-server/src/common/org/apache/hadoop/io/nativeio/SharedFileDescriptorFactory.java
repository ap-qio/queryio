...
public class SharedFileDescriptorFactory {
	 ...
	 *
	 * @param prefix
	 *            The prefix to prepend to all the file names created by this
	 *            factory.
	 * @param paths
	 *            An array of paths to use. We will try each path in succession,
	 *            and return a factory using the first usable path.
	 * @return The factory.
	 * @throws IOException
	 *             If a factory could not be created for any reason.
	 */
	 ...
	 *
	 * @param prefix
	 *            Prefix to add to all file names we use.
	 * @param path
	 *            Path to use.
	 */
	 ...
	 *
	 * @param info
	 *            Information to include in the path of the generated
	 *            descriptor.
	 * @param length
	 *            The starting file length.
	 *
	 * @return The file descriptor, wrapped in a FileInputStream.
	 * @throws IOException
	 *             If there was an I/O or configuration error creating the
	 *             descriptor.
	 */
