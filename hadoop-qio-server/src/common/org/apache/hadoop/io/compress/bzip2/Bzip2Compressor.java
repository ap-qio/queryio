...
/**
 * A {@link Compressor} based on the popular bzip2 compression algorithm.
 * http://www.bzip2.org/
 * 
 */
public class Bzip2Compressor implements Compressor {
	...
	/**
	 * Creates a new compressor with a default values for the compression block
	 * size and work factor. Compressed data will be generated in bzip2 format.
	 */
	...
	/**
	 * Creates a new compressor using the specified block size. Compressed data
	 * will be generated in bzip2 format.
	 * 
	 * @param blockSize
	 *            The block size to be used for compression. This is an integer
	 *            from 1 through 9, which is multiplied by 100,000 to obtain the
	 *            actual block size in bytes.
	 * @param workFactor
	 *            This parameter is a threshold that determines when a fallback
	 *            algorithm is used for pathological data. It ranges from 0 to
	 *            250.
	 ...
	 * in the given Configuration. It will reset the compressor's block size and
	 * and work factor.
	 * 
	 * @param conf
	...
	public synchronized boolean needsInput() {
		...
		// Uncompressed data available in either the direct buffer or user
		// buffer?
