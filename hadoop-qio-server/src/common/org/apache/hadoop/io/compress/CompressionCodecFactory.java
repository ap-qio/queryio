...
public class CompressionCodecFactory {
	...
	/**
	 * Get the list of codecs discovered via a Java ServiceLoader, or listed in
	 * the configuration. Codecs specified in configuration come later in the
	 * returned list, and are considered to override those from the
	 * ServiceLoader.
	 * 
	 * @param conf
	 ...
	 * register them. Defaults to gzip and deflate.
	 */
	 ...
	 * <p/>
	 * The code alias is the short class name (without the package name). If the
	 * short class name ends with 'Codec', then there are two aliases for the
	 * codec, the complete short class name and the short class name without the
	 * 'Codec' ending. For example for the 'GzipCodec' codec class name the
