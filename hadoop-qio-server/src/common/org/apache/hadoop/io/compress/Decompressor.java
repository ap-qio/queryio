...
public interface Decompressor {
	...
	/**
	 * Returns <code>true</code> if the end of the decompressed data output
	 * stream has been reached. Indicates a concatenated data stream when
	 * finished() returns <code>true</code> and {@link #getRemaining()} returns
	 * a positive value. finished() will be reset with the {@link #reset()}
	 * method.
	 * 
