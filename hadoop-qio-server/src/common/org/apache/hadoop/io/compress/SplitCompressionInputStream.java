...
/**
 * An InputStream covering a range of compressed data. The start and end offsets
 * requested by a client may be modified by the codec to fit block boundaries or
 * other algorithm-dependent requirements.
 */
...
public abstract class SplitCompressionInputStream extends CompressionInputStream {
	...
	/**
	 * After calling createInputStream, the values of start or end might change.
	 * So this method can be used to get the new value of end.
	 * 
