 ...
 * distinguishes between the size of the sequence and the current capacity. The
...
public class BytesWritable extends BinaryComparable implements WritableComparable<BinaryComparable> {
	...
	/**
	 * Create a BytesWritable using the byte array as the initial value and
	 * length as the length. Use this constructor if the array is larger than
	 * the value it represents.
	 * 
	 * @param bytes
	 *            This array becomes the backing storage for the object.
	 * @param length
	 *            The number of bytes to use from array.
	 */
