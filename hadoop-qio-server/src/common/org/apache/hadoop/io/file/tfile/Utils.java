...
public final class Utils {
	 ...
	 * <li>if n in [-8*2^24, 8*2^24): encode in four bytes: byte[0]=n/2^24 -
	 * 112; byte[1] = (n>>16)&0xff; byte[2] = (n>>8)&0xff; byte[3]=n&0xff.
	 * Otherwise:
	...
	/**
	 * A generic Version class. We suggest applications built on top of TFile
	 * use this class to maintain version information in their meta blocks.
	 * 
	 ...
	 * version number when the new storage format is not backward compatible,
	 * and increment the minor version otherwise.
	 */
	public static final class Version implements Comparable<Version> {
		...
		/**
		 * Write the objec to a DataOutput. The serialized format of the Version
		 * is major version followed by minor version, both as big-endian short
		 * integers.
		 * 
		 * @param out
		 ...
		 * @return true if both versions have the same major version number;
		 *         false otherwise.
		 */
	...
	/**
	 * Lower bound binary search. Find the index to the first element in the
	 * list that compares greater than or equal to key.
	 * 
	 * @param <T>
	...
	/**
	 * Upper bound binary search. Find the index to the first element in the
	 * list that compares greater than the input key.
	 * 
	 * @param <T>
	 *            Type of the input key.
	 * @param list
