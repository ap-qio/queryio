...
public class WritableComparator implements RawComparator, Configurable {
	...
	private static final ConcurrentHashMap<Class, WritableComparator> comparators = new ConcurrentHashMap<Class, WritableComparator>(); // registry
	...
	/**
	 * Force initialization of the static members. As of Java 5, referencing a
	 * class doesn't force it to initialize. Since this class requires that the
	 * classes be initialized to declare their comparators, we force that
	...
	protected WritableComparator(Class<? extends WritableComparable> keyClass, Configuration conf,
	 ...
	 * {@link WritableComparable}s (using
	 * {@link Writable#readFields(DataInput)}, then calls
