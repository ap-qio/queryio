...
public interface RetryPolicy {
	...
	public static class RetryAction {
		...
		public String toString() {
			return getClass().getSimpleName() + "(action=" + action + ", delayMillis=" + delayMillis + ", reason="
					+ reason + ")";
		}
	 ...
	 * @param failovers
	 *            The number of times the method has failed over to a different
	 *            backend implementation
	 * @param isIdempotentOrAtMostOnce
	 *            <code>true</code> if the method is {@link Idempotent} or
	 *            {@link AtMostOnce} and so can reasonably be retried on
	 *            failover when we don't know if the previous attempt reached
	 *            the server or not
