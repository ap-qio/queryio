...
public class NodeBase implements Node {
	 ...
	 * @param path
	 *            path to normalize.
	 * @return the normalised path If <i>path</i>is null or empty {@link #ROOT}
	 *         is returned
	 * @throws IllegalArgumentException
	 *             if the first character of a non empty path is not
	 *             {@link #PATH_SEPARATOR}
	 */
	public static String normalize(String path) {
		...
		if (path.charAt(0) != PATH_SEPARATOR) {
			throw new IllegalArgumentException(
					"Network Location path does not start with " + PATH_SEPARATOR_STR + ": " + path);
		}
