...
public class DNS {
	...
	/**
	 * @return NetworkInterface for the given subinterface name (eg eth0:0) or
	 *         null if no interface with the given name can be found
	 */
	 ...
	 * @return set containing addresses for each subinterface of nif, see below
	 *         for the rationale for using an ordered set
	 */
	...
	/**
	 * Like {@link DNS#getIPs(String, boolean), but returns all IPs associated
	 * with the given interface and its subinterfaces.
	 */
	 ...
	 *            Whether to return IPs associated with subinterfaces of the
	 *            given interface
	 * @return A string vector of all the IPs associated with the provided
	 *         interface. The local host IP is returned if the interface name
	 *         "default" is specified or there is an I/O error looking for the
	 *         given interface.
	 ...
	 * @return The IP address in text form, the local host IP is returned if the
	 *         interface name "default" is specified
	 * @throws UnknownHostException
	 *             If the given interface is invalid
	 */
	...
	/**
	 * Determine the local hostname; retrieving it from cache if it is known If
	 * we cannot determine our host name, return "localhost"
	 * 
	...
	/**
	 * Get the IPAddress of the local host as a string. This will be a loop back
	 * value if the local host address cannot be determined. If the loopback
	 * address of "localhost" does not resolve, then the system's network is in
	 * such a state that nothing is going to work. A message is logged at the
	 * error level and a null pointer returned, a pointer which will trigger
	 * failures later on the application
	 * 
	 ...
	 * 
	 * @param strInterface
	 *            The name of the network interface to query (e.g. eth0). Must
	 *            not be null.
