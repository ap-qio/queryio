 ...
 * {@link DNSToSwitchMappingWithDependency} interface using a script configured
 * via the {@link CommonConfigurationKeys#NET_DEPENDENCY_SCRIPT_FILE_NAME_KEY}
 * option.
 * <p/>
...
public class ScriptBasedMappingWithDependency extends ScriptBasedMapping implements DNSToSwitchMappingWithDependency {
	 ...
	 */
	static final String DEPENDENCY_SCRIPT_FILENAME_KEY = CommonConfigurationKeys.NET_DEPENDENCY_SCRIPT_FILE_NAME_KEY;
	 ...
	 * 
	 * @param name
	 *            - host name for which we are getting dependency
	 ...
	 */
	private static final class RawScriptBasedMappingWithDependency extends ScriptBasedMapping.RawScriptBasedMapping
