 ...
 * abstraction to separate key storage from users of encryption. It is intended
 * to support getting or storing keys in a variety of ways, including third
 * party bindings.
 * <P/>
...
public abstract class KeyProvider {
	...
	public static class Metadata {
		...
		protected Metadata(String cipher, int bitLength, String description, Map<String, String> attributes,
		...
		protected Metadata(byte[] bytes) throws IOException {
			...
			JsonReader reader = new JsonReader(new InputStreamReader(new ByteArrayInputStream(bytes), Charsets.UTF_8));
			try {
				reader.beginObject();
	...
	/**
	 * Indicates whether this provider represents a store that is intended for
	 * transient use - such as the UserProvider is. These providers are
	 * generally used to provide access to keying material rather than for long
	 * term storage.
	 * 
	...
	/**
	 * Get the current version of the key, which should be used for encrypting
	 * new data.
	 * 
	 * @param name
	 ...
	 *            the base name of the key
	 * @param material
	 *            the key material for the first version of the key.
	 * @param options
	...
	/**
	 * Can be used by implementing classes to close any resources that require
	 * closing
	 */
