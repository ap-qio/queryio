...
/**
 * A KeyProvider extension with the ability to add a renewer's Delegation Tokens
...
public class KeyProviderDelegationTokenExtension
	 ...
	 * @return a <code>KeyProviderDelegationTokenExtension</code> instance using
	 *         the given <code>KeyProvider</code>.
	 */
	public static KeyProviderDelegationTokenExtension createKeyProviderDelegationTokenExtension(
			KeyProvider keyProvider) {

		DelegationTokenExtension delTokExtension = (keyProvider instanceof DelegationTokenExtension)
				? (DelegationTokenExtension) keyProvider : DEFAULT_EXTENSION;
