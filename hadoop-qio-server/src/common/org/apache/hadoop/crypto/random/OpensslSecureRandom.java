 ...
 * number generator will be used and it's much faster than
 * {@link java.security.SecureRandom}. If RDRAND is unavailable, default OpenSSL
 * secure random generator will be used. It's still faster and can generate
 * strong random bytes.
 * <p/>
 * 
...
public class OpensslSecureRandom extends Random {
	 ...
	 *
	 * @param numBits
	 *            number of random bits to be generated, where 0 <=
