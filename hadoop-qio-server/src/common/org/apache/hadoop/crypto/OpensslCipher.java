...
/**
 * OpenSSL cipher using JNI. Currently only AES-CTR is supported. It's flexible
 * to add other crypto algorithms/modes.
 */
...
public final class OpensslCipher {
	 ...
	 *             empty, in an invalid format, or if Openssl doesn't implement
	...
	private static Transform tokenizeTransformation(String transformation) throws NoSuchAlgorithmException {
		 ...
		 * 
		 * index 0: algorithm (e.g., AES) index 1: mode (e.g., CTR) index 2:
		 * padding (e.g., NoPadding)
		 */
	 ...
	 * 
	 * @param mode
	 *            {@link #ENCRYPT_MODE} or {@link #DECRYPT_MODE}
	 * @param key
	 *            crypto key
	 * @param iv
	 *            crypto iv
