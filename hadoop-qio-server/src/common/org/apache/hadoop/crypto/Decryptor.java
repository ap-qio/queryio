...
public interface Decryptor {
	 ...
	 * in the stream. Generally, the decryptor maintains any necessary context
	 * for calculating the IV and counter so that no reinit is necessary during
	 * the decryption. Reinit before each operation is inefficient.
	 * 
	 ...
	 * The object may hold the decryption context internally.
	 * <p/>
