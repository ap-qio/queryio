...
/**
 * Class responsible for pumping the streams of the subprocess out to log4j.
 * stderr is pumped to WARN level and stdout is pumped to INFO level
 */
class StreamPumper {
	enum StreamType {
		STDOUT, STDERR;
	...
	StreamPumper(final Log log, final String logPrefix, final InputStream stream, final StreamType type) {
		this.log = log;
