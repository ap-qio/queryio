...
public class MetricsServlet extends HttpServlet {
	 ...
	 * [ (tag->tagValue), (metric->metricValue) ]. The values are either String
	 * or Number. The final value is implemented as a list of TagsMetricsPair.
	 */
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if ("json".equals(format)) {
			...
			try {
				// Uses Jetty's built-in JSON support to convert the map into
				// JSON.
