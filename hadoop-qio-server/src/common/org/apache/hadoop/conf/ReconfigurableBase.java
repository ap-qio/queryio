 ...
 * properties and getReconfigurableProperties to get all properties that can be
 * changed at run time.
 */
public abstract class ReconfigurableBase extends Configured implements Reconfigurable {
	 ...
	 * particular change. Otherwise, it indicates that the change has been
	...
	@VisibleForTesting
	public Collection<PropertyChange> getChangedProperties(Configuration newConf, Configuration oldConf) {
	 ...
	 * {@inheritDoc}
	 *
	 * This method makes the change to this objects {@link Configuration} and
	 * calls reconfigurePropertyImpl to update internal data structures. This
	 * method cannot be overridden, subclasses should instead override
	 * reconfigureProperty.
	 */
	@Override
	 ...
	 * {@inheritDoc}
	 *
	 * Subclasses may wish to override this with a more efficient
	 * implementation.
	 */
	@Override
	 ...
	 *
	 * Subclasses must override this. This method applies the change to all
	 * internal data structures derived from the configuration property that is
	 * being changed. If this object owns other Reconfigurable objects
	 * reconfigureProperty should be called recursively to make sure that to
	 * make sure that the configuration of these objects is updated.
	 */
