...
public class DiskChecker {
	 ...
	 * @throws IOException
	 */
	public static void mkdirsWithExistsAndPermissionCheck(LocalFileSystem localFS, Path dir, FsPermission expected)
			throws IOException {
	 ...
	 *            File to check
	 * @throws DiskErrorException
	 *             if dir is not a directory, not readable, not writable, or not
	 *             executable
	 */
	 ...
	 *            File to check
	 * @throws DiskErrorException
	 *             if dir is not readable, not writable, or not executable
	 */
