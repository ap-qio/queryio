...
public class ApplicationClassLoader extends URLClassLoader {
	...
	public ApplicationClassLoader(URL[] urls, ClassLoader parent, List<String> systemClasses) {
		...
		// if the caller-specified system classes are null or empty, use the
		// default
		this.systemClasses = (systemClasses == null || systemClasses.isEmpty())
				? Arrays.asList(StringUtils.getTrimmedStrings(SYSTEM_CLASSES_DEFAULT)) : systemClasses;
	 ...
	 * @param systemClasses
	 *            a list of system class configurations.
