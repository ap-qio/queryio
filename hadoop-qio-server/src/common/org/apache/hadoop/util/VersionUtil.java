...
/**
 * A wrapper class to maven's ComparableVersion class, to comply with maven's
 * version name string convention
 */
...
public abstract class VersionUtil {
	 ...
	 *         integer if version2 precedes version1, and 0 if and only if the
