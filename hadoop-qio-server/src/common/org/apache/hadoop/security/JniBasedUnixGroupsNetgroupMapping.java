...
/**
 * A JNI-based implementation of {@link GroupMappingServiceProvider} that
 * invokes libC calls to get the group memberships of a given user.
 */
...
public class JniBasedUnixGroupsNetgroupMapping extends JniBasedUnixGroupsMapping {
	 ...
	 *
	 * @param groups
	 *            list of group names to add to cache
	 */
	@Override
	...
	/**
	 * Calls JNI function to get users for a netgroup, since C functions are not
	 * reentrant we need to make this synchronized (see documentation for
	 * setnetgrent, getnetgrent and endnetgrent)
	 *
	 * @param netgroup
	 *            return users for this netgroup
