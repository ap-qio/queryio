...
public class SaslInputStream extends InputStream implements ReadableByteChannel {
	 ...
	 * 
	 * return (ofinish-ostart) (we have this many bytes for you), 0 (no data
	 * now, but could have more later), or -1 (absolutely no more data)
	 */
	 ...
	 * first argument is <code>null,</code> up to <code>len</code> bytes are
	 * read and discarded.
	 * 
	 * @param b
	 *            the buffer into which the data is read.
