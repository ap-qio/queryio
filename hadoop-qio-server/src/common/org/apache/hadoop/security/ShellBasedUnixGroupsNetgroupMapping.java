...
public class ShellBasedUnixGroupsNetgroupMapping extends ShellBasedUnixGroupsMapping {
	 ...
	 *
	 * @param user
	 *            get groups and netgroups for this user
	...
	/**
	 * Calls shell to get users for a netgroup by calling getent netgroup, this
	 * is a low level function that just returns string that
	 *
	 * @param netgroup
	 *            get users for this netgroup
	...
	protected String execShellGetUserForNetgroup(final String netgroup) throws IOException {
		String result = "";
		try {
			// shell command does not expect '@' at the begining of the group
			// name
