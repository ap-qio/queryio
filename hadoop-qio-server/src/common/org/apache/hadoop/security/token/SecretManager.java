...
public abstract class SecretManager<T extends TokenIdentifier> {
	...
	/**
	 * Create the password for the given identifier. identifier may be modified
	 * inside this method.
	 * 
	 * @param identifier
	 ...
	 * date or registry to make sure the token hasn't expired or been revoked.
	 * Returns the relevant password.
	 * 
	 * @param identifier
	 ...
	 * method can throw a {@link RetriableException} or a
	 * {@link StandbyException} to indicate that client can retry/failover the
	 * same operation because of temporary issue on the server side.
	 * 
	 * @param identifier
	 *            the identifier to validate
	 * @return the password to use
	 ...
	 *             the server is in standby state, the client can try other
	 *             servers
	 * @throws RetriableException
	 *             the token was invalid, and the server thinks this may be a
	 *             temporary issue and suggests the client to retry
	 * @throws IOException
	 ...
	 * 
	 * @throws StandbyException
	 *             if the secret manager is not available to read tokens
	 */
	...
	/**
	 * Compute HMAC of the identifier using the secret key and return the output
	 * as password
	 * 
	 * @param identifier
