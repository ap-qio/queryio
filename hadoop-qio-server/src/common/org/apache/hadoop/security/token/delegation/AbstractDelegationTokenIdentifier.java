...
public abstract class AbstractDelegationTokenIdentifier extends TokenIdentifier {
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof AbstractDelegationTokenIdentifier) {
			...
			return this.sequenceNumber == that.sequenceNumber && this.issueDate == that.issueDate
					&& this.maxDate == that.maxDate && this.masterKeyId == that.masterKeyId
					&& isEqual(this.owner, that.owner) && isEqual(this.renewer, that.renewer)
	...
	public String toString() {
		...
		buffer.append("owner=" + owner + ", renewer=" + renewer + ", realUser=" + realUser + ", issueDate=" + issueDate
				+ ", maxDate=" + maxDate + ", sequenceNumber=" + sequenceNumber + ", masterKeyId=" + masterKeyId);
