...
public class Token<T extends TokenIdentifier> implements Writable {
	...
	/**
	 * Indicates whether the token is a clone. Used by HA failover proxy to
	 * indicate a token should not be visible to the user via
	 * UGI.getCredentials()
	 */
	@InterfaceAudience.Private
	...
	/**
	 * Generate a string with the url-quoted base64 encoded serialized form of
	 * the Writable.
	 * 
	 * @param obj
	 ...
	 * @param newValue
	 *            the string with the url-safe base64 encoded bytes
	 * @throws IOException
	 */
	...
	public boolean equals(Object right) {
		if (this == right) {
			...
			return Arrays.equals(identifier, r.identifier) && Arrays.equals(password, r.password) && kind.equals(r.kind)
