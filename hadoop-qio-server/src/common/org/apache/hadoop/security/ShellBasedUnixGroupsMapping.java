...
public class ShellBasedUnixGroupsMapping implements GroupMappingServiceProvider {
	 ...
	 * 'groups' NOTE. For non-existing user it will return EMPTY list
	 * 
	 * @param user
	 *            user name
	 * @return the groups list that the <code>user</code> belongs to. The
	 *         primary group is returned first.
	 * @throws IOException
