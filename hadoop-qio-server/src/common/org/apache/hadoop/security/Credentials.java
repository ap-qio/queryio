...
/**
 * A class that provides the facilities of reading and writing secret keys and
 * Tokens.
 */
...
public class Credentials implements Writable {
	 ...
	 * Tokens therein in the passed UGI
	 * 
	 * @param filename
	 * @param conf
	 * @throws IOException
	...
	private static final byte[] TOKEN_STORAGE_MAGIC = "HDTS".getBytes(Charsets.UTF_8);
