...
public class AccessControlList implements Writable {
	 ...
	 * comes first and is separated by a space followed by the group list. For
	 * e.g. "user1,user2 group1,group2"
	 * 
	 * @param aclString
	...
	/**
	 * Build ACL from the given two Strings. The Strings contain comma separated
	 * values.
	 *
	 * @param aclString
	 *            build ACL from array of Strings
	 */
	 ...
	 *
	 * @param aclString
	 *            check this ACL string for wildcard
	 ...
	 * 
	 * @param ugi
	 *            UserGroupInformation to check if contained in the ACL
	...
	/**
	 * Returns the access control list as a String that can be used for building
	 * a new instance by sending it to the constructor of
