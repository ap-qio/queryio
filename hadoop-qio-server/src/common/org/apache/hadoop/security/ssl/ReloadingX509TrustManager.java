...
/**
 * A {@link TrustManager} implementation that reloads its configuration when the
 * truststore file on disk changes.
 */
...
public final class ReloadingX509TrustManager implements X509TrustManager, Runnable {
	...
	/**
	 * Creates a reloadable trustmanager. The trustmanager reloads itself if the
	 * underlying trustore file has changed.
	 *
	 * @param type
	 *            type of truststore file, typically 'jks'.
	 * @param location
	 *            local path to the truststore file.
	 * @param password
	 *            password of the truststore file.
	 * @param reloadInterval
	 *            interval to check if the truststore file has changed, in
	 *            milliseconds.
	 * @throws IOException
	 *             thrown if the truststore could not be initialized due to an
	 *             IO error.
	 * @throws GeneralSecurityException
	 *             thrown if the truststore could not be initialized due to a
	 *             security error.
	 */
