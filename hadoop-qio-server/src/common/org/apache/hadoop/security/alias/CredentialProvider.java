 ...
 * abstraction to separate credential storage from users of them. It is intended
 * to support getting or storing passwords in a variety of ways, including third
 * party bindings.
 */
...
public abstract class CredentialProvider {
	 ...
	 * generally used to provide job access to passwords rather than for long
	 * term storage.
	 * 
	 ...
	 * @throws IOException
	 */
	public abstract CredentialEntry createCredentialEntry(String name, char[] credential) throws IOException;
