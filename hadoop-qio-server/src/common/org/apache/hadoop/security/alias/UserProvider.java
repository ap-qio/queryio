...
/**
 * A CredentialProvider for UGIs. It uses the credentials object associated with
 * the current user to find credentials. This provider is created using a URI of
 * "user:///".
 */
...
public class UserProvider extends CredentialProvider {
	...
	public CredentialEntry getCredentialEntry(String alias) {
		...
		return new CredentialEntry(alias, new String(bytes, Charsets.UTF_8).toCharArray());
	}
