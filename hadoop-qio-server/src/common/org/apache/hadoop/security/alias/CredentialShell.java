...
public class CredentialShell extends Configured implements Tool {
	final static private String USAGE_PREFIX = "Usage: hadoop credential " + "[generic options]\n";
	...
	private class ListCommand extends Command {
		...
		public void execute() throws IOException {
			...
			try {
				...
				out.println(
						"Cannot list aliases for CredentialProvider: " + provider.toString() + ": " + e.getMessage());
				throw e;
			}
		}
	...
	private class DeleteCommand extends Command {
		...
		public boolean validate() {
			...
			if (interactive) {
				try {
					cont = ToolRunner.confirmPrompt("You are about to DELETE the credential " + alias
							+ " from CredentialProvider " + provider.toString() + ". Continue? ");
					if (!cont) {
		...
		public void execute() throws IOException {
			...
			out.println("Deleting credential: " + alias + " from CredentialProvider: " + provider.toString());
			if (cont) {
				try {
