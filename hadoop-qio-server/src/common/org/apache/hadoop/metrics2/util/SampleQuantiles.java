 ...
 * 
 * See: Cormode, Korn, Muthukrishnan, and Srivastava "Effective Computation of
 * Biased Quantiles over Data Streams" in ICDE 2005
 * 
 * Greenwald and Khanna, "Space-efficient online computation of quantile
...
public class SampleQuantiles {
	 ...
	 * the buffer linearly. When the buffer fills, it is flushed into the
	 * samples array in its entirety.
	 */
	 ...
	 * 
	 * @return snapshot of the tracked quantiles. If no items are added to the
	 *         estimator, returns null.
	 */
	...
	private static class SampleItem {
		 ...
		 * 
		 * The sum of the g of all previous items yields this item's lower
		 * bound.
		 */
		public int g;

		/**
		 * Difference between the item's greatest possible rank and lowest
		 * possible rank.
		 */
