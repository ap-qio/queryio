 ...
 * has been derived from org.apache.hadoop.metrics.ganglia.GangliaContext. As
 * per the documentation, sink implementations doesn't have to worry about
 * thread safety. Hence the code wasn't written for thread safety and should be
 * modified in case the above assumption changes in the future.
 */
public abstract class AbstractGangliaSink implements MetricsSink {
	...
	/*
	 * Output of "gmetric --help" showing allowable values -t, --type=STRING
	 * Either string|int8|uint8|int16|uint16|int32|uint32|float|double -u,
	 * --units=STRING Unit of measure for the value e.g. Kilobytes, Celcius
	 * (default='') -s, --slope=STRING Either zero|positive|negative|both
	 * (default='both') -x, --tmax=INT The maximum time in seconds between
	 ...
	 * (non-Javadoc)
	 *
	 * @see org.apache.hadoop.metrics2.MetricsPlugin#init(org.apache.commons.
