...
class MBeanInfoBuilder implements MetricsVisitor {
	...
	MBeanAttributeInfo newAttrInfo(String name, String desc, String type) {
		return new MBeanAttributeInfo(getAttrName(name), type, desc, true, false, false); // read-only,
																							// non-is
	}
	...
	MBeanInfo get() {
		...
		return new MBeanInfo(name, description, attrs.toArray(attrsArray), null, null, null); // no
																								// ops/ctors/notifications
	}
}
