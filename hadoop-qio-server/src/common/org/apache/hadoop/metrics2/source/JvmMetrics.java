...
/**
 * JVM and logging related metrics. Mostly used by various servers as a part of
...
public class JvmMetrics implements MetricsSource {
	...
	private void getMemoryUsage(MetricsRecordBuilder rb) {
		...
		rb.addGauge(MemNonHeapUsedM, memNonHeap.getUsed() / M)
				...
				.addGauge(MemNonHeapMaxM, memNonHeap.getMax() / M).addGauge(MemHeapUsedM, memHeap.getUsed() / M)
				.addGauge(MemHeapCommittedM, memHeap.getCommitted() / M).addGauge(MemHeapMaxM, memHeap.getMax() / M)
	...
	private void getThreadUsage(MetricsRecordBuilder rb) {
		...
		rb.addGauge(ThreadsNew, threadsNew).addGauge(ThreadsRunnable, threadsRunnable)
				...
				.addGauge(ThreadsTimedWaiting, threadsTimedWaiting).addGauge(ThreadsTerminated, threadsTerminated);
	}
