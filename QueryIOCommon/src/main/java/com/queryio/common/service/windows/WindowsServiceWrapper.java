...
public class WindowsServiceWrapper {
	...
	public static void main(String[] args) throws Throwable {
		...
		System.out.println("WindowsServiceWrapper called with arguments: " + Arrays.toString(args));
	...
	private static void start(String[] args) throws Throwable {
		try {
			...
			System.err.println("Error in WindowsServiceWrapper " + e.getLocalizedMessage());
