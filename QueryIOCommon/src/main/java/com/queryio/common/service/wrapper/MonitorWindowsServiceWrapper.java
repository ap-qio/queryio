...
public class MonitorWindowsServiceWrapper {
	...
	public AttributeNode[] fetchAttributes(final String[] objectNames) {
		...
		fetchedAttributes = PdhNativeAPI.fetchAttributes(this.controllerId, this.monitorHostName, true, objectNames);
		return fetchedAttributes;
	}

	public NetworkInfo[] getNetworkInfo() {
		NetworkInfo[] networkInfos;
		networkInfos = PdhNativeAPI.getNetworkInfo(this.controllerId, this.monitorHostName, true);
		return networkInfos;
	}

	public ProcessInfo[] getProcessInfo() {
		ProcessInfo[] processes;
		processes = PdhNativeAPI.getProcessInfo(this.controllerId, this.monitorHostName, true);
		return processes;
