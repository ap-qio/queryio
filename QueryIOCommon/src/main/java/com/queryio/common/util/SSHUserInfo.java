...
/**
 * This class is used to configure SSH. By default SSH prompts when a new SSH
 * key is received. This configuration disables all prompts do that the login
 * can be carried out with the provided username and password.
 * 
