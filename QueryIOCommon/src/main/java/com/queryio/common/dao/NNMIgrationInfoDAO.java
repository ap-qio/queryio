...
public class NNMIgrationInfoDAO {
	public static void addMigrationInfo(final Connection connection, String migrationId, String nameNodeId, int hostId,
			String destPath, String dbName) throws Exception {
	...
	public static void updateMigrationInfo(final Connection connection, String migrationId, Timestamp endTime,
	...
	public static void deleteMigrationInfoFromList(final Connection connection, String migrationIds) throws Exception {
		...
		try {
			...
			deleteQuery = "DELETE FROM " + TableConstants.TABLE_NN_DB_MIGRATION_STATUS + " WHERE "
					+ ColumnConstants.COL_NN_DB_MIGRATION_STATUS_MIGRATIONID + " IN (" + migrationIds + ")";
	...
	public static ArrayList<NNDBMigrationInfo> getMigrationInfoList(final Connection connection) throws Exception {
		...
		try {
			...
			rs = DatabaseFunctions.getQueryResultsForStatement(stmt,
					"SELECT * FROM " + TableConstants.TABLE_NN_DB_MIGRATION_STATUS);
	...
	public static ArrayList<NNDBMigrationInfo> getMigrationInfoSelectedList(final Connection connection,
			String migrationIds) throws Exception {
		ArrayList<NNDBMigrationInfo> list = new ArrayList<NNDBMigrationInfo>();
		...
		try {
			stmt = DatabaseFunctions.getStatement(connection);
			selectQuery = "SELECT * FROM " + TableConstants.TABLE_NN_DB_MIGRATION_STATUS + " WHERE "
					+ ColumnConstants.COL_NN_DB_MIGRATION_STATUS_MIGRATIONID + " IN (" + migrationIds + ")";
