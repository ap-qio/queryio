...
public class UpgradeHadoop2_0_3To2_0_4 {
	...
	public static void updateHadoopPath(String path) throws Exception
	{
		...
		{
			if(file.getPath().contains("core-site.xml") || file.getPath().contains("hdfs-site.xml") || file.getPath().contains("hadoop-env.sh") || file.getPath().contains("ssl-client.xml") || file.getPath().contains("ssl-server.xml") || file.getPath().contains("yarn-env.sh") || file.getPath().contains("yarn-site.xml") || file.getPath().contains("mapred-env.sh"))
			{
