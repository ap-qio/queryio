...
public class DFSMap {
	...
	public static HdfsConfiguration getKerberosConfiguration() {
		...
		// DFS_NAMENODE_USER_NAME_KEY needs to be set in hadoop.properties - [
	...
	public static HdfsConfiguration getConfiguration() {
		...
		conf.set(DFSConfigKeys.FS_DEFAULT_NAME_KEY,
				HadoopConstants.getHadoopConf().get(DFSConfigKeys.FS_DEFAULT_NAME_KEY));
		conf.set(DFSConfigKeys.DFS_REPLICATION_KEY,
				HadoopConstants.getHadoopConf().get(DFSConfigKeys.DFS_REPLICATION_KEY));
