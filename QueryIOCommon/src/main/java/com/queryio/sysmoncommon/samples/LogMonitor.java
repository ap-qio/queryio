...
public class LogMonitor
{
	...
	public static void main(final String[] args)
	{
		...
		final String hostName = "acidruin.corp.apple.com";
		final String userName = getValue(args, 2, "c1505435");
		final String pwd = getValue(args, 3, "appPerfect#123");
		int port = 22;
		...
		try
		{
			...
			monitor.setSuperUserName("gsxwebld");
			monitor.setSuperUserPassword("grep2011");
