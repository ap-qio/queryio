	...
	public static void main(final String[] args) {
		...
		try {
			...
			for (int i = 0; i < 20; i++) {
				...
				System.out.println(monitor.getTotalCPUUsage() + "\t" + monitor.getUserCPUUsage() + "\t"
						+ monitor.getSystemCPUUsage() + "\t" + monitor.getWaitCPUUsage());

				System.out.println("************ Load Avg ************");
				System.out.println("1 Min\t5 Min\t15 Min");
				System.out.println(monitor.get1MinLoadAverage() + "\t" + monitor.get5MinLoadAverage() + "\t"
						+ monitor.get15MinLoadAverage());

				System.out.println("************ Physical Memory ************");
				System.out.println("Available\tTotal");
				System.out.println(monitor.getPhysicalMemoryInfo().getAvailable() + "\t"
						+ monitor.getPhysicalMemoryInfo().getTotal());

				System.out.println("************ Virtual Memory ************");
				System.out.println("Available\tTotal");
				System.out.println(monitor.getVirtualMemoryInfo().getAvailable() + "\t"
						+ monitor.getVirtualMemoryInfo().getTotal());
