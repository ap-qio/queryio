...
public class FirewallMacOSXMonitor {
	...
	public static void main(final String[] args) {
		...
		final String hostName = getValue(args, 1, "xyz");// "17.209.17.60");
		final String userName = getValue(args, 2, "xyz");
		final String pwd = getValue(args, 3, "xyz");
		...
		try {
			...
			monitor.setFirewallUserName("xyz");
			monitor.setFirewallPassword("xyz");
			monitor.setSuperUserName("xyz");
			monitor.setSuperUserPassword("xyz");
			...
			for (int i = 0; i < 2; i++) {
				...
				for (int i1 = 0; i1 < processes.length; i1++) {
					System.out.println(processes[i1].getProcessID() + " name: " + processes[i1].getName() + " Memory "
