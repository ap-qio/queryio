...
public class MacOSX_10_9_Parser extends GenericMacOSXDataParser {
	...
	public void parseTopMemCommand(final String output) throws ResultParsingException {
		 ...
		 * 2015/04/13 17:17:48 Load Avg: 1.00, 1.22, 1.24 CPU usage: 4.25% user,
		 * 23.40% sys, 72.34% idle SharedLibs: 14M resident, 16M data, 0B
		 * linkedit. MemRegions: 120242 total, 3423M resident, 82M private, 485M
		 * shared. PhysMem: 7711M used (1129M wired), 480M unused. VM: 693G
		 * vsize, 1068M framework vsize, 680833(0) swapins, 842308(0) swapouts.
		 * Networks: packets: 0/0B in, 0/0B out. Disks: 0/0B read, 0/0B written.
		 * 
		 * PID COMMAND %CPU TIME #TH #WQ #PORTS #MREGS MEM PURG CMPRS PGRP PPID
		 * STATE BOOSTS %CPU_ME %CPU_OTHRS UID FAULTS COW MSGSENT MSGRECV SYSBSD
		 * SYSMACH CSW PAGEINS IDLEW POWER USER #MREGS RPRVT VPRVT VSIZE KPRVT
		 * KSHRD 257 top 0.0 39:57.69 6 4 64 N/A 44M 9284K 146M 257 1 sleeping
		 * *0[1] 0.00000 0.00000 0 18259836 87428 10303511 5071614 38273196
		 * 11351059 16518508 1715118 162466 0.0 root N/A N/A N/A N/A N/A N/A
		 * 
		 */
		String temp = null;
		String sLine = null;
							...
							// after disconnect
		{
			try {
				...
				while (st.hasMoreTokens()) {
					 ...
					 * 2444M used, 1654M free. NEW : PhysMem: 8167M used (1181M
					 * wired), 23M unused.
					 * 
					 */
					 ...
					 * 0(0) pageouts. VM: 293G vsize, 1065M framework vsize,
					 ...
					 * out. NEW : Networks: packets: 24/8265B in, 31/4855B out.
					 * 
					 */
					...
					/*
					 * 
					 * PID COMMAND %CPU TIME #TH #WQ #PORTS #MREGS MEM PURG
					 * CMPRS PGRP PPID STATE BOOSTS %CPU_ME %CPU_OTHRS UID
					 * FAULTS COW MSGSENT MSGRECV SYSBSD SYSMACH CSW PAGEINS
					 * IDLEW POWER USER #MREGS RPRVT VPRVT VSIZE KPRVT KSHRD 257
					 * mds_stores 0.0 39:57.69 6 4 64 N/A 44M 9284K 146M 257 1
					 * sleeping *0[1] 0.00000 0.00000 0 18259836 87428 10303511
					 * 5071614 38273196 11351059 16518508 1715118 162466 0.0
