...
public class MacOSX_10_9_Parser extends GenericMacOSXDataParser
{
	...
	public void parseTopMemCommand(final String output) throws ResultParsingException
	{
		 ...
		 * 	Processes: 264 total, 3 running, 10 stuck, 251 sleeping, 1226 threads 
		    ...
		    PID  COMMAND    %CPU TIME     #TH  #WQ #PORTS #MREGS MEM  PURG   CMPRS PGRP PPID STATE    BOOSTS %CPU_ME %CPU_OTHRS UID FAULTS    COW    MSGSENT   MSGRECV  SYSBSD    SYSMACH   CSW       PAGEINS  IDLEW   POWER USER #MREGS RPRVT VPRVT VSIZE KPRVT KSHRD
		    257  top		0.0  39:57.69 6    4   64     N/A    44M  9284K  146M  257  1    sleeping *0[1]  0.00000 0.00000    0   18259836  87428  10303511  5071614  38273196  11351059  16518508  1715118  162466  0.0   root N/A    N/A   N/A   N/A   N/A   N/A  
		...
		if (output != null) // output will be null if this method gets called after disconnect
		{
			try
			{
				...
				while (st.hasMoreTokens())
				{
					 ...
					 * 
					 * PID  COMMAND    %CPU TIME     #TH  #WQ #PORTS #MREGS MEM  PURG   CMPRS PGRP PPID STATE    BOOSTS %CPU_ME %CPU_OTHRS UID FAULTS    COW    MSGSENT   MSGRECV  SYSBSD    SYSMACH   CSW       PAGEINS  IDLEW   POWER USER #MREGS RPRVT VPRVT VSIZE KPRVT KSHRD
					   257  mds_stores 0.0  39:57.69 6    4   64     N/A    44M  9284K  146M  257  1    sleeping *0[1]  0.00000 0.00000    0   18259836  87428  10303511  5071614  38273196  11351059  16518508  1715118  162466  0.0   root N/A    N/A   N/A   N/A   N/A   N/A  
					 */
