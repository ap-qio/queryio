...
public class MacOSX_10_10_Parser extends GenericMacOSXDataParser {
	...
	public void parseTopMemCommand(final String output) throws ResultParsingException {
		 ...
		 * KSHRD 257 top 0.0 39:57.69 6 4 64 44M 9284K 146M 257 1 sleeping *0[1]
		 * 0.00000 0.00000 0 18259836 87428 10303511 5071614 38273196 11351059
		 * 16518508 1715118 162466 0.0 root N/A N/A N/A N/A N/A N/A
		 * 
		 */
		String temp = null;
		String sLine = null;
							...
							// after disconnect
		{
			try {
				...
				while (st.hasMoreTokens()) {
					 ...
					 * USER #MREGS RPRVT VPRVT VSIZE KPRVT KSHRD 257 top 0.0
					 * 39:57.69 6 4 64 44M 9284K 146M 257 1 sleeping *0[1]
					 * 0.00000 0.00000 0 18259836 87428 10303511 5071614
					 * 38273196 11351059 16518508 1715118 162466 0.0 root N/A
					 * N/A N/A N/A N/A N/A
					 */
