...
public class MacOSX_10_6_Parser extends GenericMacOSXDataParser
{
	...
	public void parseTopMemCommand(final String output) throws ResultParsingException
	{
		 ...
		 * 	Processes: 57 total, 3 running, 54 sleeping, 340 threads 
			...
			SharedLibs: 8260K resident, 2824K data, 0B linkedit.
			MemRegions: 9172 total, 845M resident, 19M private, 224M shared.
			PhysMem: 850M wired, 1149M active, 444M inactive, 2444M used, 1654M free.
			...
			10686  top              3.8  00:00.17 1/1  0   24     33     660K   244K   1228K  18M    2378M  10686 10601 running  0   2513+    53     88207+    44088+    1058+     44361+   86+       0       root  
		 */
		String temp = null;
		String sLine = null;
		float value = 0.0f;
