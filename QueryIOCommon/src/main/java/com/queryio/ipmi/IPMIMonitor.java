...
//		try
//		{
//			checkIPMISupportProcess = Runtime.getRuntime().exec(ipmiSupportConfirmation);
//			reader = new BufferedReader(new InputStreamReader(checkIPMISupportProcess.getInputStream()));
//			String line = null;
//			
...
//		catch(IOException e)
//		{
//			AppLogger.getLogger().fatal("dmidecode command could not be executed :" + e.getMessage() + e);
//		}
//		finally
//		{
//			if(reader != null)
...
//	}
	...
	private static BufferedReader executeIPMICommand(String command)
	{
		...
		{
//			AppLogger.getLogger().fatal("Could not execute command '" + command + "' :" + e.getMessage() + e);
		}
		return null;
	}
