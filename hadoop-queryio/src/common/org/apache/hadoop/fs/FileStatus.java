...
public class FileStatus implements Writable, Comparable {
   ...
   */
	public FileStatus(long length, boolean isdir, int block_replication,
			...
			Block[] blocks) {
		this(length, isdir, block_replication, blocksize, modification_time,
				access_time, permission, owner, group, null, path, blocks);
	}

	
//	(JZIJJJLorg/apache/hadoop/fs/permission/FsPermission;Ljava/lang/String;Ljava/lang/String;Lorg/apache/hadoop/fs/Path;Lorg/apache/hadoop/fs/Path;[Lorg/apache/hadoop/hdfs/protocol/Block;)
	/*
	 * @QUERYIO@
	 */
	public FileStatus(long length, boolean isdir, int block_replication,
			...
			Path path, /*@QUERYIO@*/Block[] blocks) {
		this.length = length;
		this.isdir = isdir;
		this.block_replication = (short) block_replication;
		this.blocksize = blocksize;
