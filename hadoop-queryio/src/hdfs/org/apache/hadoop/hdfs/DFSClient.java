...
//		}
  ...
  public boolean setReplication(String src, short replication)
	      throws IOException {
			...
			TraceScope scope = getPathTraceScope("setReplication", src);
			try {
				result =  namenode.setReplication(src, replication);
			} catch (RemoteException re) {
				throw re.unwrapRemoteException(AccessControlException.class,
						FileNotFoundException.class, SafeModeException.class,
						DSQuotaExceededException.class,
			...
			try {
				connection = UserDefinedTagResourceFactory
						.getConnectionWithPoolInit(conf, true);
				if (connection != null) {
					UserDefinedTagDAO.updateReplicationInDefaultTable(connection,
							src, replication);
					UserDefinedTagDAO.updateReplicationInAllMetadataTables(
							connection, src, replication);
				}
			} catch (Exception e) {
  ...
  public boolean rename(String src, String dst) throws IOException {
    ...
    try {
    	result = namenode.rename(src, dst);
    } catch(RemoteException re) {
      throw re.unwrapRemoteException(AccessControlException.class,
                                     NSQuotaExceededException.class,
                                     DSQuotaExceededException.class,
	...
	try {
		...
		if (connection != null) {
			UserDefinedTagDAO
					.renameFileInDefaultTable(connection, src, dst);
			UserDefinedTagDAO.renameFileInAllMetadataTables(connection,
					src, dst);
		}
	} catch (Exception e) {
		LOG.fatal(e.getMessage(), e);
  ...
  public boolean delete(String src) throws IOException {
    checkOpen();
    boolean result = delete(src, true);
	/* @QueryIO@ */
	Connection connection = null;
	try {
		connection = UserDefinedTagResourceFactory
				.getConnectionWithPoolInit(conf, true);
		if (connection != null) {
			UserDefinedTagDAO.deleteFromDefaultTable(connection, src);
			UserDefinedTagDAO.deleteFileFromAllMetadataTables(connection,
					src);
		}
	} catch (Exception e) {
		LOG.fatal(e.getMessage(), e);
  ...
  public boolean delete(String src, boolean recursive) throws IOException {
	...
	try {
		/* @QueryIO@ */
		result = namenode.delete(src, recursive);
	} catch (RemoteException re) {
		throw re.unwrapRemoteException(AccessControlException.class,
				FileNotFoundException.class, SafeModeException.class,
				UnresolvedPathException.class,
  ...
  public void setPermission(String src, FsPermission permission)
	...
	try {
		connection = UserDefinedTagResourceFactory
				.getConnectionWithPoolInit(conf, true);
		if (connection != null) {
			UserDefinedTagDAO.updatePermissionInDefaultTable(connection,
					src, permission.toString());
			UserDefinedTagDAO.updatePermissionInAllMetadataTables(
					connection, src, permission.toString());
		}
	} catch (Exception e) {
		LOG.fatal(e.getMessage(), e);
	} finally {
  ...
  public void setOwner(String src, String username, String groupname)
	...
	try {
		connection = UserDefinedTagResourceFactory
				.getConnectionWithPoolInit(conf, true);
		if (connection != null) {
			UserDefinedTagDAO.updateOwnerInDefaultTable(connection, src,
					username, groupname);
			UserDefinedTagDAO.updateOwnerInAllMetadataTables(connection,
					src, username, groupname);
		}
	} catch (Exception e) {
		LOG.fatal(e.getMessage(), e);
	} finally {
	...
	/*
	   *  @QUERYIO@
	   */
	  public void setOwnerModified(String src, String username,
    ...
    /* @QUERYIO@ */
   	...
   	try {
   		connection = UserDefinedTagResourceFactory
   				.getConnectionWithPoolInit(conf, true);
   		if (connection != null) {
   			UserDefinedTagDAO.updateTimesInDefaultTable(connection, src,
   					mtime, atime);
   			UserDefinedTagDAO.updateTimesInAllMetadataTables(connection,
   					src, mtime, atime);
   		}
   	} catch (Exception e) {
   		LOG.fatal(e.getMessage(), e);
