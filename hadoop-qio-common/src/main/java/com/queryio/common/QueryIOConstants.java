...
public interface QueryIOConstants {
	...
	String HADOOP_2_7_3_DIR_NAME = "Hadoop-2.7.3";
	String HADOOP_DIR_NAME = "Hadoop-2.8.0";
	...
	public static final long PURGEINTERVALFORCONSOLIDATEDDATATABLE = 31104000000L; // =
																					// 360
																					// days
	...
	// String HIVE_QUERYIO_MAPREDUCE_INPUT_FILEINPUTFORMAT_INPUT_DIR_RECURSIVE =
	// "mapreduce.input.fileinputformat.input.dir.recursive";
	// String HIVE_QUERYIO_QUERYIO_HIVE_FILTER_QUERY =
	...
	// DB Connection config for input path filter in hive and custom MR jobs
	// (XML)
