...
public class ServiceUtilities {
	...
	public static URLClassLoader createClassLoader(final String home, final List excludedResources,
			List extraResources) {
	 ...
	 * @param process
	 */
	public static StreamPumper[] readDataFromProcess(final Process process, final OutputStream out,
