...
public class QIODFSInputStream extends InputStream {
	...
	public QIODFSInputStream(DFSInputStream dfsIn, String compressionType, String encryptionType, DistributedFileSystem fs) throws Exception {
		...
		in = new EncryptionHandler(Cipher.DECRYPT_MODE,
				encryptionTypeValue, fs.getConf().get(QueryIOConstants.QUERYIO_DFS_DATA_ENCRYPTION_KEY))
				.getCompressedCipherInputStream(dfsIn,
