...
public class TableMetadata {
	...
	public TableMetadata(String tableName, List<ColumnMetadata> columnData) {
		...
		map.put(DEFAULT_TAG_MODIFICATIONTIME,
				new ColumnMetadata(DEFAULT_TAG_MODIFICATIONTIME, DEFAULT_TAG_MODIFICATIONTIME_SQLDATATYPE));
		map.put(DEFAULT_TAG_PERMISSION,
				new ColumnMetadata(DEFAULT_TAG_PERMISSION, DEFAULT_TAG_PERMISSION_SQLDATATYPE, 23));
		map.put(DEFAULT_TAG_BLOCKSIZE, new ColumnMetadata(DEFAULT_TAG_BLOCKSIZE, DEFAULT_TAG_BLOCKSIZE_SQLDATATYPE));
		map.put(DEFAULT_TAG_REPLICATION,
				new ColumnMetadata(DEFAULT_TAG_REPLICATION, DEFAULT_TAG_REPLICATION_SQLDATATYPE));
		map.put(DEFAULT_TAG_COMPRESSION_TYPE,
				new ColumnMetadata(DEFAULT_TAG_COMPRESSION_TYPE, DEFAULT_TAG_COMPRESSION_TYPE_SQLDATATYPE, 64));
		map.put(DEFAULT_TAG_ENCRYPTION_TYPE,
				new ColumnMetadata(DEFAULT_TAG_ENCRYPTION_TYPE, DEFAULT_TAG_ENCRYPTION_TYPE_SQLDATATYPE, 64));
